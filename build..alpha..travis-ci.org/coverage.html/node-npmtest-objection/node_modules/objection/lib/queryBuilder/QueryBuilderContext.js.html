...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/QueryBuilderContext.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/QueryBuilderContext.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/</a> &#187; QueryBuilderContext.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function QueryBuilderContext(userContext) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, QueryBuilderContext);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = (0, _possibleConstructorReturn3.default)(this, _QueryBuilderContextB.call(this, userContext));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.runBefore = [];</span>
<span class="cstat-no" title="statement not covered" >    _this.runAfter = [];</span>
<span class="cstat-no" title="statement not covered" >    _this.onBuild = [];</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  QueryBuilderContext.prototype.clone = <span class="fstat-no" title="function not covered" >function clone() {</span>
<span class="cstat-no" title="statement not covered" >    var ctx = _QueryBuilderContextB.prototype.clone.call(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    ctx.runBefore = this.runBefore.slice();</span>
<span class="cstat-no" title="statement not covered" >    ctx.runAfter = this.runAfter.slice();</span>
<span class="cstat-no" title="statement not covered" >    ctx.onBuild = this.onBuild.slice();</span>
&nbsp;
