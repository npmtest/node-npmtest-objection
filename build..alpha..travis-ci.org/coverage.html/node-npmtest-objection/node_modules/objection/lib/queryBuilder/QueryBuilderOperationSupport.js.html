...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/QueryBuilderOperationSupport.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/QueryBuilderOperationSupport.js</span></h1>
    <h2>
        
        Statements: <span class="metric">28.38% <small>(42 / 148)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">27.89% <small>(41 / 147)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/</a> &#187; QueryBuilderOperationSupport.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function QueryBuilderOperationSupport(knex, QueryBuilderContext) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, QueryBuilderOperationSupport);</span>
&nbsp;
    /**
     * @type {knex}
     * @protected
     */
<span class="cstat-no" title="statement not covered" >    this._knex = knex;</span>
    /**
...
<span class="cstat-no" title="statement not covered" >    this._operations = [];</span>
     ...
     * @protected
     */
<span class="cstat-no" title="statement not covered" >    this._context = new (QueryBuilderContext || _QueryBuilderContextBase2.default)(this._createUserContextBase());</span>
  }
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.extend = <span class="fstat-no" title="function not covered" >function extend(subclassConstructor) {</span>
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.context = <span class="fstat-no" title="function not covered" >function context(ctx) {</span>
<span class="cstat-no" title="statement not covered" >    if (arguments.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >      return this._context.userContext;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      var ctxBase = this._createUserContextBase();</span>
<span class="cstat-no" title="statement not covered" >      this._context.userContext = (0, _assign2.default)(ctxBase, ctx);</span>
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.mergeContext = <span class="fstat-no" title="function not covered" >function mergeContext(ctx) {</span>
<span class="cstat-no" title="statement not covered" >    var oldCtx = this._context.userContext;</span>
<span class="cstat-no" title="statement not covered" >    this._context.userContext = (0, _assign2.default)(oldCtx, ctx);</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.internalContext = <span class="fstat-no" title="function not covered" >function internalContext(ctx) {</span>
<span class="cstat-no" title="statement not covered" >    if (arguments.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >      return this._context;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this._context = ctx;</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
  };
&nbsp;
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.internalOptions = <span class="fstat-no" title="function not covered" >function internalOptions(opt) {</span>
<span class="cstat-no" title="statement not covered" >    if (arguments.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >      return this._context.options;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      (0, _assign2.default)(this._context.options, opt);</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
  };
&nbsp;
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.knex = <span class="fstat-no" title="function not covered" >function knex(_knex) {</span>
<span class="cstat-no" title="statement not covered" >    if (arguments.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >      var knex = this._context.knex || this._knex;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!knex) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('no database connection available for a query for table ' + this.modelClass().tableName + '. ' + 'You need to bind the model class or the query to a knex instance.');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return knex;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this._knex = _knex;</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
  };
&nbsp;
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.clear = <span class="fstat-no" title="function not covered" >function clear(operationSelector) {</span>
<span class="cstat-no" title="statement not covered" >    var operations = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.forEachOperation(operationSelector, <span class="fstat-no" title="function not covered" >function (op) {</span></span>
<span class="cstat-no" title="statement not covered" >      operations.push(op);</span>
    }, false);
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._operations = operations;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.copyFrom = <span class="fstat-no" title="function not covered" >function copyFrom(queryBuilder, operationSelector) {</span>
<span class="cstat-no" title="statement not covered" >    var _this = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    queryBuilder.forEachOperation(operationSelector, <span class="fstat-no" title="function not covered" >function (op) {</span></span>
<span class="cstat-no" title="statement not covered" >      _this._operations.push(op);</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.has = <span class="fstat-no" title="function not covered" >function has(operationSelector) {</span>
<span class="cstat-no" title="statement not covered" >    var found = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.forEachOperation(operationSelector, <span class="fstat-no" title="function not covered" >function () {</span></span>
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.indexOfOperation = <span class="fstat-no" title="function not covered" >function indexOfOperation(operationSelector) {</span>
<span class="cstat-no" title="statement not covered" >    var idx = -1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.forEachOperation(operationSelector, <span class="fstat-no" title="function not covered" >function (op, i) {</span></span>
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.forEachOperation = <span class="fstat-no" title="function not covered" >function forEachOperation(operationSelector, callback) {</span>
<span class="cstat-no" title="statement not covered" >    var match = arguments.length &gt; 2 &amp;&amp; arguments[2] !== undefined ? arguments[2] : true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (operationSelector instanceof RegExp) {</span>
<span class="cstat-no" title="statement not covered" >      this._forEachOperationRegex(operationSelector, callback, match);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this._forEachOperationInstanceOf(operationSelector, callback, match);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.callQueryBuilderOperation = <span class="fstat-no" title="function not covered" >function callQueryBuilderOperation(operation, args, pushFront) {</span>
<span class="cstat-no" title="statement not covered" >    if (operation.call(this, args || [])) {</span>
<span class="cstat-no" title="statement not covered" >      if (pushFront) {</span>
<span class="cstat-no" title="statement not covered" >        this._operations.unshift(operation);</span>
      } else {
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.callKnexQueryBuilderOperation = <span class="fstat-no" title="function not covered" >function callKnexQueryBuilderOperation(methodName, args, pushFront) {</span>
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(new _KnexOperation2.default(methodName), args, pushFront);</span>
  };
&nbsp;
  /**
   * @returns {QueryBuilderOperationSupport}
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.clone = <span class="fstat-no" title="function not covered" >function clone() {</span>
<span class="cstat-no" title="statement not covered" >    return this.baseCloneInto(new this.constructor(this.knex()));</span>
  };
&nbsp;
  /**
   * @protected
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.baseCloneInto = <span class="fstat-no" title="function not covered" >function baseCloneInto(builder) {</span>
<span class="cstat-no" title="statement not covered" >    builder._knex = this._knex;</span>
<span class="cstat-no" title="statement not covered" >    builder._operations = this._operations.slice();</span>
<span class="cstat-no" title="statement not covered" >    builder._context = this._context.clone();</span>
&nbsp;
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.build = <span class="fstat-no" title="function not covered" >function build() {</span>
<span class="cstat-no" title="statement not covered" >    return this.buildInto(this.knex().queryBuilder());</span>
  };
&nbsp;
  /**
   * @protected
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.buildInto = <span class="fstat-no" title="function not covered" >function buildInto(knexBuilder) {</span>
<span class="cstat-no" title="statement not covered" >    var tmp = new Array(10);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var i = 0;</span>
<span class="cstat-no" title="statement not covered" >    while (i &lt; this._operations.length) {</span>
<span class="cstat-no" title="statement not covered" >      var op = this._operations[i];</span>
<span class="cstat-no" title="statement not covered" >      var ln = this._operations.length;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      op.onBeforeBuild(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var numNew = this._operations.length - ln;</span>
&nbsp;
      // onBeforeBuild may call methods that add more operations. If
      // this was the case, move the operations to be executed next.
<span class="cstat-no" title="statement not covered" >      if (numNew &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >        while (tmp.length &lt; numNew) {</span>
<span class="cstat-no" title="statement not covered" >          tmp.push(null);</span>
        }
&nbsp;
        // Copy the new operations to tmp.
<span class="cstat-no" title="statement not covered" >        for (var j = 0; j &lt; numNew; ++j) {</span>
<span class="cstat-no" title="statement not covered" >          tmp[j] = this._operations[ln + j];</span>
        }
&nbsp;
        // Make room for the new operations after the current operation.
<span class="cstat-no" title="statement not covered" >        for (var _j = ln + numNew - 1; _j &gt; i + numNew; --_j) {</span>
<span class="cstat-no" title="statement not covered" >          this._operations[_j] = this._operations[_j - numNew];</span>
        }
&nbsp;
        // Move the new operations after the current operation.
<span class="cstat-no" title="statement not covered" >        for (var _j2 = 0; _j2 &lt; numNew; ++_j2) {</span>
<span class="cstat-no" title="statement not covered" >          this._operations[i + _j2 + 1] = tmp[_j2];</span>
        }
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    for (var _i = 0, l = this._operations.length; _i &lt; l; ++_i) {</span>
<span class="cstat-no" title="statement not covered" >      this._operations[_i].onBuild(knexBuilder, this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this._operations.length !== l) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('onBuild should only call query building methods on the knex builder');</span>
      }
    }
&nbsp;
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.toString = <span class="fstat-no" title="function not covered" >function toString() {</span>
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.toSql = <span class="fstat-no" title="function not covered" >function toSql() {</span>
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype.skipUndefined = <span class="fstat-no" title="function not covered" >function skipUndefined() {</span>
<span class="cstat-no" title="statement not covered" >    this._context.options.skipUndefined = true;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype._createUserContextBase = <span class="fstat-no" title="function not covered" >function _createUserContextBase() {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var ctxProto = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    Object.defineProperty(ctxProto, 'transaction', {</span>
      enumerable: false,
      get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >        return _this2.knex();</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return (0, _create2.default)(ctxProto);</span>
  };
&nbsp;
  /**
   * @private
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype._forEachOperationRegex = <span class="fstat-no" title="function not covered" >function _forEachOperationRegex(operationSelector, callback, match) {</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = this._operations.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var op = this._operations[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (operationSelector.test(op.name) === match) {</span>
<span class="cstat-no" title="statement not covered" >        if (callback(op, i) === false) {</span>
...
&nbsp;
&nbsp;
  QueryBuilderOperationSupport.prototype._forEachOperationInstanceOf = <span class="fstat-no" title="function not covered" >function _forEachOperationInstanceOf(operationSelector, callback, match) {</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = this._operations.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var op = this._operations[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (op instanceof operationSelector === match) {</span>
<span class="cstat-no" title="statement not covered" >        if (callback(op, i) === false) {</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
      }
