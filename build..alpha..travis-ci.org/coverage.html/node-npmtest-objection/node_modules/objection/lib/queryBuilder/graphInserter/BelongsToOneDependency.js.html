...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/BelongsToOneDependency.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/BelongsToOneDependency.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/</a> &#187; BelongsToOneDependency.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function BelongsToOneDependency(node, relation) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, BelongsToOneDependency);</span>
&nbsp;
    /**
     * @type {Relation}
     */
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.relation = relation;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  BelongsToOneDependency.prototype.resolve = <span class="fstat-no" title="function not covered" >function resolve(model) {</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; this.relation.relatedProp.length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      this.node.model[this.relation.ownerProp[i]] = model[this.relation.relatedProp[i]];</span>
    }
  };
&nbsp;
