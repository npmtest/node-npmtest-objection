...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/DependencyNode.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/DependencyNode.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/</a> &#187; DependencyNode.js</div>
</div>
<div class="body">
...
&nbsp;
var DependencyNode = <span class="fstat-no" title="function not covered" >function DependencyNode(model, modelClass) {</span>
<span class="cstat-no" title="statement not covered" >  (0, _classCallCheck3.default)(this, DependencyNode);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.id = model[modelClass.uidProp];</span>
&nbsp;
  /**
   * @type {Model}
   */
...
&nbsp;
   ...
   */
<span class="cstat-no" title="statement not covered" >  this.needs = [];</span>
&nbsp;
  /**
   * @type {Array.&lt;Dependency&gt;}
   */
<span class="cstat-no" title="statement not covered" >  this.isNeededBy = [];</span>
&nbsp;
  /**
   * @type {Array.&lt;ManyToManyConnection&gt;}
   */
<span class="cstat-no" title="statement not covered" >  this.manyToManyConnections = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.numHandledNeeds = 0;</span>
<span class="cstat-no" title="statement not covered" >  this.handled = false;</span>
<span class="cstat-no" title="statement not covered" >  this.visited = false;</span>
<span class="cstat-no" title="statement not covered" >  this.recursion = false;</span>
};
&nbsp;
