...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/HasManyDependency.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/HasManyDependency.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/</a> &#187; HasManyDependency.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function HasManyDependency(node, relation) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, HasManyDependency);</span>
&nbsp;
    /**
     * @type {Relation}
     */
...
&nbsp;
  HasManyDependency.prototype.resolve = <span class="fstat-no" title="function not covered" >function resolve(model) {</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; this.relation.relatedProp.length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      this.node.model[this.relation.relatedProp[i]] = model[this.relation.ownerProp[i]];</span>
    }
  };
&nbsp;
