...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/TableInsertion.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/TableInsertion.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/</a> &#187; TableInsertion.js</div>
</div>
<div class="body">
...
&nbsp;
var TableInsertion = <span class="fstat-no" title="function not covered" >function TableInsertion(modelClass, isJoinTableInsertion) {</span>
<span class="cstat-no" title="statement not covered" >  (0, _classCallCheck3.default)(this, TableInsertion);</span>
&nbsp;
  /**
...
&nbsp;
   ...
   * @type {boolean}
   */
<span class="cstat-no" title="statement not covered" >  this.isJoinTableInsertion = isJoinTableInsertion;</span>
&nbsp;
  /**
   * @type {Array.&lt;Model&gt;}
   */
...
&nbsp;
   ...
   * @type {Array.&lt;Boolean&gt;}
   */
<span class="cstat-no" title="statement not covered" >  this.isInputModel = [];</span>
};
&nbsp;
