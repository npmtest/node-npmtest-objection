...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/DelegateOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/DelegateOperation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">59.68% <small>(37 / 62)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">59.02% <small>(36 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; DelegateOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function DelegateOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, DelegateOperation);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = (0, _possibleConstructorReturn3.default)(this, _QueryBuilderOperatio.call(this, name, opt));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.delegate = opt.delegate;</span>
<span class="cstat-no" title="statement not covered" >    _this.isWriteOperation = _this.delegate.isWriteOperation;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  DelegateOperation.prototype.is = <span class="fstat-no" title="function not covered" >function is(OperationClass) {</span>
<span class="cstat-no" title="statement not covered" >    return _QueryBuilderOperatio.prototype.is.call(this, OperationClass) || this.delegate.is(OperationClass);</span>
  };
&nbsp;
  DelegateOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    return this.delegate.call(builder, args);</span>
  };
&nbsp;
  DelegateOperation.prototype.onBefore = <span class="fstat-no" title="function not covered" >function onBefore(builder, result) {</span>
<span class="cstat-no" title="statement not covered" >    return this.delegate.onBefore(builder, result);</span>
  };
&nbsp;
  DelegateOperation.prototype.hasOnBefore = <span class="fstat-no" title="function not covered" >function hasOnBefore() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onBefore !== DelegateOperation.prototype.onBefore || this.delegate.hasOnBefore();</span>
  };
&nbsp;
  DelegateOperation.prototype.onBeforeInternal = <span class="fstat-no" title="function not covered" >function onBeforeInternal(builder, result) {</span>
<span class="cstat-no" title="statement not covered" >    return this.delegate.onBeforeInternal(builder, result);</span>
  };
&nbsp;
  DelegateOperation.prototype.hasOnBeforeInternal = <span class="fstat-no" title="function not covered" >function hasOnBeforeInternal() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onBeforeInternal !== DelegateOperation.prototype.onBeforeInternal || this.delegate.hasOnBeforeInternal();</span>
  };
&nbsp;
  DelegateOperation.prototype.onBeforeBuild = <span class="fstat-no" title="function not covered" >function onBeforeBuild(builder) {</span>
<span class="cstat-no" title="statement not covered" >    return this.delegate.onBeforeBuild(builder);</span>
  };
&nbsp;
  DelegateOperation.prototype.hasOnBeforeBuild = <span class="fstat-no" title="function not covered" >function hasOnBeforeBuild() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onBeforeBuild !== DelegateOperation.prototype.onBeforeBuild || this.delegate.hasOnBeforeBuild();</span>
  };
&nbsp;
  DelegateOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(knexBuilder, builder) {</span>
<span class="cstat-no" title="statement not covered" >    return this.delegate.onBuild(knexBuilder, builder);</span>
  };
&nbsp;
  DelegateOperation.prototype.hasOnBuild = <span class="fstat-no" title="function not covered" >function hasOnBuild() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onBuild !== DelegateOperation.prototype.onBuild || this.delegate.hasOnBuild();</span>
  };
&nbsp;
  DelegateOperation.prototype.onRawResult = <span class="fstat-no" title="function not covered" >function onRawResult(builder, result) {</span>
<span class="cstat-no" title="statement not covered" >    return this.delegate.onRawResult(builder, result);</span>
  };
&nbsp;
  DelegateOperation.prototype.hasOnRawResult = <span class="fstat-no" title="function not covered" >function hasOnRawResult() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onRawResult !== DelegateOperation.prototype.onRawResult || this.delegate.hasOnRawResult();</span>
  };
&nbsp;
  DelegateOperation.prototype.onAfterQuery = <span class="fstat-no" title="function not covered" >function onAfterQuery(builder, result) {</span>
<span class="cstat-no" title="statement not covered" >    return this.delegate.onAfterQuery(builder, result);</span>
  };
&nbsp;
  DelegateOperation.prototype.hasOnAfterQuery = <span class="fstat-no" title="function not covered" >function hasOnAfterQuery() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onAfterQuery !== DelegateOperation.prototype.onAfterQuery || this.delegate.hasOnAfterQuery();</span>
  };
&nbsp;
  DelegateOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal(builder, result) {</span>
<span class="cstat-no" title="statement not covered" >    return this.delegate.onAfterInternal(builder, result);</span>
  };
&nbsp;
  DelegateOperation.prototype.hasOnAfterInternal = <span class="fstat-no" title="function not covered" >function hasOnAfterInternal() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onAfterInternal !== DelegateOperation.prototype.onAfterInternal || this.delegate.hasOnAfterInternal();</span>
  };
&nbsp;
  DelegateOperation.prototype.onAfter = <span class="fstat-no" title="function not covered" >function onAfter(builder, result) {</span>
<span class="cstat-no" title="statement not covered" >    return this.delegate.onAfter(builder, result);</span>
  };
&nbsp;
  DelegateOperation.prototype.hasOnAfter = <span class="fstat-no" title="function not covered" >function hasOnAfter() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onAfter !== DelegateOperation.prototype.onAfter || this.delegate.hasOnAfter();</span>
  };
&nbsp;
  DelegateOperation.prototype.queryExecutor = <span class="fstat-no" title="function not covered" >function queryExecutor(builder) {</span>
<span class="cstat-no" title="statement not covered" >    return this.delegate.queryExecutor(builder);</span>
  };
&nbsp;
  DelegateOperation.prototype.hasQueryExecutor = <span class="fstat-no" title="function not covered" >function hasQueryExecutor() {</span>
<span class="cstat-no" title="statement not covered" >    return this.queryExecutor !== DelegateOperation.prototype.queryExecutor || this.delegate.hasQueryExecutor();</span>
  };
&nbsp;
