...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/FindOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/FindOperation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">39.77% <small>(35 / 88)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">39.08% <small>(34 / 87)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; FindOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function FindOperation() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, FindOperation);</span>
...
&nbsp;
  FindOperation.prototype.clone = <span class="fstat-no" title="function not covered" >function clone(props) {</span>
<span class="cstat-no" title="statement not covered" >    props = props || {};</span>
<span class="cstat-no" title="statement not covered" >    var opt = (0, _assign2.default)({}, this.opt, props.opt);</span>
<span class="cstat-no" title="statement not covered" >    return new this.constructor(this.name, opt);</span>
  };
&nbsp;
  FindOperation.prototype.onAfter = <span class="fstat-no" title="function not covered" >function onAfter(builder, results) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.opt.dontCallAfterGet) {</span>
<span class="cstat-no" title="statement not covered" >      return results;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return callAfterGet(builder.context(), results, !!this.opt.callAfterGetDeeply);</span>
    }
  };
&nbsp;
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function callAfterGet(ctx, results, deep) {</span>
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(results)) {</span>
<span class="cstat-no" title="statement not covered" >    if (results.length === 1) {</span>
<span class="cstat-no" title="statement not covered" >      return callAfterGetForOne(ctx, results[0], results, deep);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return callAfterGetArray(ctx, results, deep);</span>
    }
  } else {
<span class="cstat-no" title="statement not covered" >    return callAfterGetForOne(ctx, results, results, deep);</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function callAfterGetArray(ctx, results, deep) {</span>
<span class="cstat-no" title="statement not covered" >  if (results.length === 0 || (0, _typeof3.default)(results[0]) !== 'object') {</span>
<span class="cstat-no" title="statement not covered" >    return results;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var mapped = new Array(results.length);</span>
<span class="cstat-no" title="statement not covered" >  var containsPromise = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = results.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    mapped[i] = callAfterGetForOne(ctx, results[i], results[i], deep);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if ((0, _promiseUtils.isPromise)(mapped[i])) {</span>
<span class="cstat-no" title="statement not covered" >      containsPromise = true;</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (containsPromise) {</span>
<span class="cstat-no" title="statement not covered" >    return _bluebird2.default.all(mapped);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    return mapped;</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function callAfterGetForOne(ctx, model, result, deep) {</span>
...
<span class="cstat-no" title="statement not covered" >    var containsPromise = callAfterGetForRelations(ctx, model, results);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (containsPromise) {</span>
<span class="cstat-no" title="statement not covered" >      return _bluebird2.default.all(results).then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        return doCallAfterGet(ctx, model, result);</span>
      });
    } else {
<span class="cstat-no" title="statement not covered" >      return doCallAfterGet(ctx, model, result);</span>
    }
...
&nbsp;
<span class="fstat-no" title="function not covered" >function callAfterGetForRelations(ctx, model, results) {</span>
<span class="cstat-no" title="statement not covered" >  var relations = model.constructor.getRelationArray();</span>
<span class="cstat-no" title="statement not covered" >  var containsPromise = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = relations.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var relName = relations[i].name;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (model[relName]) {</span>
<span class="cstat-no" title="statement not covered" >      var maybePromise = callAfterGet(ctx, model[relName], true);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if ((0, _promiseUtils.isPromise)(maybePromise)) {</span>
<span class="cstat-no" title="statement not covered" >        containsPromise = true;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      results.push(maybePromise);</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return containsPromise;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function doCallAfterGet(ctx, model, result) {</span>
<span class="cstat-no" title="statement not covered" >  if (model.$afterGet !== _Model2.default.prototype.$afterGet) {</span>
<span class="cstat-no" title="statement not covered" >    var maybePromise = model.$afterGet(ctx);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (maybePromise instanceof _bluebird2.default) {</span>
<span class="cstat-no" title="statement not covered" >      return maybePromise.return(result);</span>
    } else <span class="cstat-no" title="statement not covered" >if ((0, _promiseUtils.isPromise)(maybePromise)) {</span>
<span class="cstat-no" title="statement not covered" >      return maybePromise.then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        return result;</span>
      });
    } else {
<span class="cstat-no" title="statement not covered" >      return result;</span>
