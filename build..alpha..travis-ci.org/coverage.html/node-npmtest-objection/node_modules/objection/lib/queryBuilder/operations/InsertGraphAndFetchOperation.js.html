...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/InsertGraphAndFetchOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/InsertGraphAndFetchOperation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">62.5% <small>(25 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">61.54% <small>(24 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; InsertGraphAndFetchOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function InsertGraphAndFetchOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, InsertGraphAndFetchOperation);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!_this.delegate.is(_InsertGraphOperation2.default)) {</span>
...
&nbsp;
  InsertGraphAndFetchOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal(builder) {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var eager = _RelationExpression2.default.fromGraph(this.models);</span>
<span class="cstat-no" title="statement not covered" >    var modelClass = this.models[0].constructor;</span>
<span class="cstat-no" title="statement not covered" >    var ids = new Array(this.models.length);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = this.models.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      ids[i] = this.models[i].$id();</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return modelClass.query().childQueryOf(builder).whereIn(modelClass.getFullIdColumn(), ids).eager(eager).then(<span class="fstat-no" title="function not covered" >function (models) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _this2.isArray ? models : models[0] || null;</span>
    });
  };
&nbsp;
