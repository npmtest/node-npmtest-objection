...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/InsertGraphOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/InsertGraphOperation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">61.11% <small>(33 / 54)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; InsertGraphOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function InsertGraphOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, InsertGraphOperation);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = (0, _possibleConstructorReturn3.default)(this, _DelegateOperation.call(this, name, opt));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!_this.delegate.is(_InsertOperation2.default)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid delegate');</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    _this.delegate.modelOptions.skipValidation = true;</span>
&nbsp;
    // We need to split the query props deeply.
<span class="cstat-no" title="statement not covered" >    _this.delegate.splitQueryPropsDeep = true;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  InsertGraphOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    var retVal = _DelegateOperation.prototype.call.call(this, builder, args);</span>
&nbsp;
...
&nbsp;
  InsertGraphOperation.prototype.onBefore = <span class="fstat-no" title="function not covered" >function onBefore() {</span>
    // Do nothing.
  };
&nbsp;
  InsertGraphOperation.prototype.onBeforeInternal = <span class="fstat-no" title="function not covered" >function onBeforeInternal() {</span>
...
&nbsp;
  InsertGraphOperation.prototype.onBeforeBuild = <span class="fstat-no" title="function not covered" >function onBeforeBuild() {</span>
    // Do nothing.
  };
&nbsp;
  InsertGraphOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild() {</span>}
  // Do nothing.
&nbsp;
&nbsp;
  ...
  ;
&nbsp;
  InsertGraphOperation.prototype.onAfterQuery = <span class="fstat-no" title="function not covered" >function onAfterQuery(builder) {</span>
...
&nbsp;
    ...
    // query properties.
<span class="cstat-no" title="statement not covered" >    builder = builder.clone().internalOptions({</span>
      queryProps: this.queryProps
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    var ModelClass = builder.modelClass();</span>
<span class="cstat-no" title="statement not covered" >    var insertFunc = (0, _inserter2.default)(builder);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var graphInserter = new _GraphInserter2.default({</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return graphInserter.execute(insertFunc).then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      return _DelegateOperation.prototype.onAfterQuery.call(_this2, builder, _this2.models);</span>
    });
  };
&nbsp;
  InsertGraphOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal() {</span>
    // We override this with empty implementation so that the $afterInsert() hooks
    // are not called twice for the root models.
<span class="cstat-no" title="statement not covered" >    return this.isArray ? this.models : this.models[0] || null;</span>
  };
&nbsp;
  (0, _createClass3.default)(InsertGraphOperation, [{
    key: 'models',
    get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >      return this.delegate.models;</span>
    }
  }, {
    key: 'isArray',
    get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >      return this.delegate.isArray;</span>
    }
  }, {
    key: 'queryProps',
    get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >      return this.delegate.queryProps;</span>
    }
  }]);
