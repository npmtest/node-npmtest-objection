...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/InsertOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/InsertOperation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">39.19% <small>(29 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; InsertOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function InsertOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, InsertOperation);</span>
&nbsp;
    /**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.models = null;</span>
&nbsp;
    /**
     ...
     * @type {boolean}
     */
<span class="cstat-no" title="statement not covered" >    _this.isArray = false;</span>
&nbsp;
    /**
     ...
     * @type {ModelOptions}
     */
<span class="cstat-no" title="statement not covered" >    _this.modelOptions = (0, _assign2.default)({}, _this.opt.modelOptions || {});</span>
&nbsp;
    /**
     ...
     * @type {boolean}
     */
<span class="cstat-no" title="statement not covered" >    _this.splitQueryPropsDeep = false;</span>
&nbsp;
    /**
     ...
     * @type {Map}
     */
<span class="cstat-no" title="statement not covered" >    _this.queryProps = null;</span>
&nbsp;
    /**
     * @type {boolean}
     */
<span class="cstat-no" title="statement not covered" >    _this.isWriteOperation = true;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  InsertOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
    // The objects to insert.
<span class="cstat-no" title="statement not covered" >    var json = args[0];</span>
<span class="cstat-no" title="statement not covered" >    var modelClass = builder.modelClass();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.isArray = Array.isArray(json);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!this.isArray) {</span>
<span class="cstat-no" title="statement not covered" >      json = [json];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (json.every(<span class="fstat-no" title="function not covered" >function (it) {</span></span>
<span class="cstat-no" title="statement not covered" >      return it instanceof modelClass;</span>
    })) {
      // No need to convert, already model instances.
<span class="cstat-no" title="statement not covered" >      this.models = json;</span>
    } else {
      // Convert into model instances and separate query properties like
      // query builders, knex raw calls etc.
<span class="cstat-no" title="statement not covered" >      var split = (0, _modelFactory.fromJson)({</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.models = split.model;</span>
<span class="cstat-no" title="statement not covered" >      this.queryProps = split.queryProps;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return true;</span>
  };
&nbsp;
  InsertOperation.prototype.onBeforeInternal = <span class="fstat-no" title="function not covered" >function onBeforeInternal(builder, result) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.models.length &gt; 1 &amp;&amp; !(0, _knexUtils.isPostgres)(builder.knex())) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('batch insert only works with Postgresql');</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return (0, _promiseUtils.mapAfterAllReturn)(this.models, <span class="fstat-no" title="function not covered" >function (model) {</span></span>
<span class="cstat-no" title="statement not covered" >        return model.$beforeInsert(builder.context());</span>
      }, result);
    }
  };
&nbsp;
  InsertOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(knexBuilder, builder) {</span>
<span class="cstat-no" title="statement not covered" >    if (!builder.has(/returning/)) {</span>
      // If the user hasn't specified a `returning` clause, we make sure
      // that at least the identifier is returned.
<span class="cstat-no" title="statement not covered" >      knexBuilder.returning(builder.modelClass().idColumn);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var json = new Array(this.models.length);</span>
    // Builder options can contain a queryProps map. Use it
    // if there isn't a local one.
<span class="cstat-no" title="statement not covered" >    var queryProps = this.queryProps || builder.internalOptions().queryProps;</span>
&nbsp;
    // Convert the models into database json and merge the query
    // properties back.
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = this.models.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      json[i] = (0, _modelFactory.toDatabaseJson)({</span>
        model: this.models[i],
        queryProps: queryProps
      });
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    knexBuilder.insert(json);</span>
  };
&nbsp;
  InsertOperation.prototype.onAfterQuery = <span class="fstat-no" title="function not covered" >function onAfterQuery(builder, ret) {</span>
<span class="cstat-no" title="statement not covered" >    if (!Array.isArray(ret) || !ret.length || ret === this.models) {</span>
      // Early exit if there is nothing to do.
<span class="cstat-no" title="statement not covered" >      return this.models;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (ret[0] &amp;&amp; (0, _typeof3.default)(ret[0]) === 'object') {</span>
...
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = this.models.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        this.models[i].$set(ret[i]);</span>
      }
    } else {
      // If the return value is not an array of objects, we assume it is an array of identifiers.
<span class="cstat-no" title="statement not covered" >      for (var _i = 0, _l = this.models.length; _i &lt; _l; ++_i) {</span>
<span class="cstat-no" title="statement not covered" >        var model = this.models[_i];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (!model.$id()) {</span>
<span class="cstat-no" title="statement not covered" >          model.$id(ret[_i]);</span>
        }
      }
    }
&nbsp;
...
&nbsp;
  InsertOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal(builder, models) {</span>
<span class="cstat-no" title="statement not covered" >    var result = this.isArray ? models : models[0] || null;</span>
<span class="cstat-no" title="statement not covered" >    return (0, _promiseUtils.mapAfterAllReturn)(models, <span class="fstat-no" title="function not covered" >function (model) {</span></span>
<span class="cstat-no" title="statement not covered" >      return model.$afterInsert(builder.context());</span>
    }, result);
  };
&nbsp;
