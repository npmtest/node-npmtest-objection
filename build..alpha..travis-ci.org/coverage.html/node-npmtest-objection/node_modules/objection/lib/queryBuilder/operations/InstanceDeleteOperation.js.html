...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/InstanceDeleteOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/InstanceDeleteOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; InstanceDeleteOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function InstanceDeleteOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, InstanceDeleteOperation);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = (0, _possibleConstructorReturn3.default)(this, _DeleteOperation.call(this, name, opt));</span>
&nbsp;
...
&nbsp;
  InstanceDeleteOperation.prototype.onBeforeInternal = <span class="fstat-no" title="function not covered" >function onBeforeInternal(builder, result) {</span>
<span class="cstat-no" title="statement not covered" >    var maybePromise = this.instance.$beforeDelete(builder.context());</span>
<span class="cstat-no" title="statement not covered" >    return (0, _promiseUtils.afterReturn)(maybePromise, result);</span>
  };
&nbsp;
  InstanceDeleteOperation.prototype.onBeforeBuild = <span class="fstat-no" title="function not covered" >function onBeforeBuild(builder) {</span>
<span class="cstat-no" title="statement not covered" >    _DeleteOperation.prototype.onBeforeBuild.call(this, builder);</span>
...
&nbsp;
  InstanceDeleteOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal(builder, result) {</span>
<span class="cstat-no" title="statement not covered" >    var maybePromise = this.instance.$afterDelete(builder.context());</span>
<span class="cstat-no" title="statement not covered" >    return (0, _promiseUtils.afterReturn)(maybePromise, result);</span>
  };
&nbsp;
