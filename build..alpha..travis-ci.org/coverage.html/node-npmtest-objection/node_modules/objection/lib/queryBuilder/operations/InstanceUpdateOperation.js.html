...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/InstanceUpdateOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/InstanceUpdateOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; InstanceUpdateOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function InstanceUpdateOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, InstanceUpdateOperation);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = (0, _possibleConstructorReturn3.default)(this, _UpdateOperation.call(this, name, opt));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.instance = opt.instance;</span>
<span class="cstat-no" title="statement not covered" >    _this.modelOptions.old = opt.instance;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  InstanceUpdateOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    var retVal = _UpdateOperation.prototype.call.call(this, builder, args);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!this.model) {</span>
<span class="cstat-no" title="statement not covered" >      this.model = this.instance;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return retVal;</span>
  };
&nbsp;
  InstanceUpdateOperation.prototype.onBeforeBuild = <span class="fstat-no" title="function not covered" >function onBeforeBuild(builder) {</span>
<span class="cstat-no" title="statement not covered" >    _UpdateOperation.prototype.onBeforeBuild.call(this, builder);</span>
<span class="cstat-no" title="statement not covered" >    builder.whereComposite(builder.modelClass().getFullIdColumn(), this.instance.$id());</span>
  };
&nbsp;
  InstanceUpdateOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal(builder, numUpdated) {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var maybePromise = _UpdateOperation.prototype.onAfterInternal.call(this, builder, numUpdated);</span>
<span class="cstat-no" title="statement not covered" >    return (0, _promiseUtils.after)(maybePromise, <span class="fstat-no" title="function not covered" >function (result) {</span></span>
<span class="cstat-no" title="statement not covered" >      _this2.instance.$set(_this2.model);</span>
