...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/SelectOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/SelectOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; SelectOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function SelectOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, SelectOperation);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = (0, _possibleConstructorReturn3.default)(this, _WrappingQueryBuilder.call(this, name, opt));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.selections = [];</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  SelectOperation.parseSelection = <span class="fstat-no" title="function not covered" >function parseSelection(selection) {</span>
<span class="cstat-no" title="statement not covered" >    if (!_lodash2.default.isString(selection)) {</span>
<span class="cstat-no" title="statement not covered" >      return null;</span>
    }
&nbsp;
    // Discard the possible alias.
<span class="cstat-no" title="statement not covered" >    selection = selection.split(/\s+as\s+/i)[0].trim();</span>
<span class="cstat-no" title="statement not covered" >    var dotIdx = selection.lastIndexOf('.');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (dotIdx !== -1) {</span>
...
&nbsp;
  SelectOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    var selections = _lodash2.default.flatten(args);</span>
&nbsp;
    // Don't add an empty selection.
<span class="cstat-no" title="statement not covered" >    if (selections.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >      return false;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var ret = _WrappingQueryBuilder.prototype.call.call(this, builder, selections);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = selections.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var selection = SelectOperation.parseSelection(selections[i]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (selection) {</span>
<span class="cstat-no" title="statement not covered" >        this.selections.push(selection);</span>
      }
    }
&nbsp;
...
&nbsp;
  SelectOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(builder) {</span>
<span class="cstat-no" title="statement not covered" >    builder[this.name].apply(builder, this.args);</span>
  };
&nbsp;
  SelectOperation.prototype.hasSelection = <span class="fstat-no" title="function not covered" >function hasSelection(fromTable, selection) {</span>
<span class="cstat-no" title="statement not covered" >    var testSelect = SelectOperation.parseSelection(selection);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!testSelect) {</span>
<span class="cstat-no" title="statement not covered" >      return false;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var testTable = testSelect.table || fromTable;</span>
<span class="cstat-no" title="statement not covered" >    var testColumn = testSelect.column;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = this.selections.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var table = this.selections[i].table || fromTable;</span>
<span class="cstat-no" title="statement not covered" >      var column = this.selections[i].column;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (testTable === table &amp;&amp; (column === testColumn || column === '*')) {</span>
