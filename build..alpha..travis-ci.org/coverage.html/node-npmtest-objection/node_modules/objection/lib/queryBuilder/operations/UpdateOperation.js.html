...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/UpdateOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/UpdateOperation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">50.77% <small>(33 / 65)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; UpdateOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function UpdateOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, UpdateOperation);</span>
&nbsp;
    /**
     * The update model.
     *
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.model = null;</span>
&nbsp;
    /**
...
&nbsp;
  UpdateOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (json instanceof modelClass) {</span>
<span class="cstat-no" title="statement not covered" >      this.model = json;</span>
    } else <span class="cstat-no" title="statement not covered" >if (json) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.model = split.model;</span>
...
&nbsp;
  UpdateOperation.prototype.onBeforeInternal = <span class="fstat-no" title="function not covered" >function onBeforeInternal(builder, result) {</span>
<span class="cstat-no" title="statement not covered" >    var maybePromise = this.model.$beforeUpdate(this.modelOptions, builder.context());</span>
<span class="cstat-no" title="statement not covered" >    return (0, _promiseUtils.afterReturn)(maybePromise, result);</span>
  };
&nbsp;
  UpdateOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(knexBuilder, builder) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var json = (0, _modelFactory.toDatabaseJson)({</span>
      model: this.model,
...
<span class="cstat-no" title="statement not covered" >    var loweredJson = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _lodash2.default.forOwn(json, <span class="fstat-no" title="function not covered" >function (val, key) {</span></span>
      // convert ref values to raw
<span class="cstat-no" title="statement not covered" >      var loweredValue = val instanceof _ReferenceBuilder2.default ? knex.raw.apply(knex, (0, _toConsumableArray3.default)(val.toRawArgs())) : val;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        var parsed = _jsonFieldExpressionParser2.default.parse(key);</span>
<span class="cstat-no" title="statement not covered" >        var jsonRefs = '{' + (0, _lodash2.default)(parsed.access).map('ref').value().join(',') + '}';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        loweredJson[parsed.columnName] = knex.raw('jsonb_set(??, \'' + jsonRefs + '\', to_jsonb(?), true)', [parsed.columnName, loweredValue]);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        loweredJson[key] = loweredValue;</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    knexBuilder.update(loweredJson);</span>
  };
&nbsp;
  UpdateOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal(builder, numUpdated) {</span>
<span class="cstat-no" title="statement not covered" >    var maybePromise = this.model.$afterUpdate(this.modelOptions, builder.context());</span>
<span class="cstat-no" title="statement not covered" >    return (0, _promiseUtils.afterReturn)(maybePromise, numUpdated);</span>
  };
&nbsp;
