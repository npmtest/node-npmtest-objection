...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/WrappingQueryBuilderOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/WrappingQueryBuilderOperation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">36.05% <small>(31 / 86)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; WrappingQueryBuilderOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function WrappingQueryBuilderOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, WrappingQueryBuilderOperation);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.args = null;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  WrappingQueryBuilderOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    var ret = wrapArgs(this, builder, args);</span>
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function wrapArgs(op, builder, args) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var skipUndefined = builder.internalOptions().skipUndefined;</span>
<span class="cstat-no" title="statement not covered" >  var knex = builder.knex();</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (skipUndefined) {</span>
<span class="cstat-no" title="statement not covered" >        return false;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        throw new Error('undefined passed as argument #' + l + ' for \'' + op.name + '\' operation. Call skipUndefined() method to ignore the undefined values.');</span>
      }
    } else <span class="cstat-no" title="statement not covered" >if (arg instanceof _ReferenceBuilder2.default) {</span>
<span class="cstat-no" title="statement not covered" >      args[i] = knex.raw.apply(knex, (0, _toConsumableArray3.default)(args[i].toRawArgs()));</span>
    } else <span class="cstat-no" title="statement not covered" >if (arg instanceof QueryBuilderBase) {</span>
      // Convert QueryBuilderBase instances into knex query builders.
<span class="cstat-no" title="statement not covered" >      args[i] = arg.build();</span>
    } else <span class="cstat-no" title="statement not covered" >if (Array.isArray(arg)) {</span>
<span class="cstat-no" title="statement not covered" >      if (skipUndefined) {</span>
<span class="cstat-no" title="statement not covered" >        args[i] = withoutUndefined(arg);</span>
      } else <span class="cstat-no" title="statement not covered" >if (includesUndefined(arg)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('undefined passed as an item in argument #' + l + ' for \'' + op.name + '\' operation. Call skipUndefined() method to ignore the undefined values.');</span>
      }
      // convert reference builders to knex.raw
<span class="cstat-no" title="statement not covered" >      args[i] = args[i].map(<span class="fstat-no" title="function not covered" >function (arg) {</span></span>
<span class="cstat-no" title="statement not covered" >        return arg instanceof _ReferenceBuilder2.default ? knex.raw.apply(knex, (0, _toConsumableArray3.default)(arg.toRawArgs())) : arg;</span>
      });
...
<span class="cstat-no" title="statement not covered" >      args[i] = wrapFunctionArg(arg, knex);</span>
    }
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function wrapFunctionArg(func, knex) {</span>
  // Preventing cyclic deps
<span class="cstat-no" title="statement not covered" >  QueryBuilderBase = QueryBuilderBase || requireQueryBuilderBase();</span>
<span class="cstat-no" title="statement not covered" >  JoinBuilder = JoinBuilder || requireJoinBuilder();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function wrappedKnexFunctionArg() {</span></span>
<span class="cstat-no" title="statement not covered" >    if ((0, _knexUtils.isKnexQueryBuilder)(this)) {</span>
<span class="cstat-no" title="statement not covered" >      var knexQueryBuilder = this;</span>
<span class="cstat-no" title="statement not covered" >      var wrappedQueryBuilder = new QueryBuilderBase(knex);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      func.call(wrappedQueryBuilder, wrappedQueryBuilder);</span>
<span class="cstat-no" title="statement not covered" >      wrappedQueryBuilder.buildInto(knexQueryBuilder);</span>
    } else <span class="cstat-no" title="statement not covered" >if ((0, _knexUtils.isKnexJoinBuilder)(this)) {</span>
<span class="cstat-no" title="statement not covered" >      var _knexQueryBuilder = this;</span>
<span class="cstat-no" title="statement not covered" >      var joinClauseBuilder = new JoinBuilder(knex);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      func.call(joinClauseBuilder, joinClauseBuilder);</span>
<span class="cstat-no" title="statement not covered" >      joinClauseBuilder.buildInto(_knexQueryBuilder);</span>
    } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function withoutUndefined(arr) {</span>
...
<span class="cstat-no" title="statement not covered" >    if (arr[i] !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >      out.push(arr[i]);</span>
    }
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function includesUndefined(arr) {</span>
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = arr.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    if (arr[i] === undefined) {</span>
<span class="cstat-no" title="statement not covered" >      return true;</span>
    }
...
<span class="cstat-no" title="statement not covered" >  return require('../QueryBuilderBase').default;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function requireJoinBuilder() {</span>
<span class="cstat-no" title="statement not covered" >  return require('../JoinBuilder').default;</span>
}
