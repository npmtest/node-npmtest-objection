...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/eager/EagerOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/eager/EagerOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/eager/</a> &#187; EagerOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function EagerOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, EagerOperation);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    _this.filters = null;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  EagerOperation.prototype.clone = <span class="fstat-no" title="function not covered" >function clone(props) {</span>
<span class="cstat-no" title="statement not covered" >    props = props || {};</span>
<span class="cstat-no" title="statement not covered" >    var copy = new this.constructor(this.name, props.opt || (0, _clone3.default)(this.opt));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    copy.isWriteOperation = this.isWriteOperation;</span>
<span class="cstat-no" title="statement not covered" >    copy.expression = this.expression.clone();</span>
<span class="cstat-no" title="statement not covered" >    copy.filters = (0, _clone3.default)(this.filters);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return copy;</span>
  };
&nbsp;
  EagerOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    this.expression = args[0].clone();</span>
<span class="cstat-no" title="statement not covered" >    this.filters = args[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = this.filters.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var filter = this.filters[i];</span>
<span class="cstat-no" title="statement not covered" >      this.expression.addAnonymousFilterAtPath(filter.path, filter.filter);</span>
    }
&nbsp;
