...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/eager/JoinEagerOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/eager/JoinEagerOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/eager/</a> &#187; JoinEagerOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function JoinEagerOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, JoinEagerOperation);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.joinBuilder = null;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  JoinEagerOperation.prototype.clone = <span class="fstat-no" title="function not covered" >function clone() {</span>
<span class="cstat-no" title="statement not covered" >    var _EagerOperation$proto;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var copy = (_EagerOperation$proto = _EagerOperation.prototype.clone).call.apply(_EagerOperation$proto, [this].concat(args));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.joinBuilder) {</span>
<span class="cstat-no" title="statement not covered" >      copy.joinBuilder = this.joinBuilder.clone({</span>
        opt: copy.opt,
...
&nbsp;
  JoinEagerOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
...
<span class="cstat-no" title="statement not covered" >      this.joinBuilder = new _RelationJoinBuilder2.default({</span>
...
&nbsp;
  JoinEagerOperation.prototype.onBeforeInternal = <span class="fstat-no" title="function not covered" >function onBeforeInternal(builder) {</span>
<span class="cstat-no" title="statement not covered" >    return this.joinBuilder.fetchColumnInfo(builder.knex());</span>
  };
&nbsp;
  JoinEagerOperation.prototype.onBeforeBuild = <span class="fstat-no" title="function not covered" >function onBeforeBuild(builder) {</span>
<span class="cstat-no" title="statement not covered" >    this.joinBuilder.build(builder);</span>
  };
&nbsp;
  JoinEagerOperation.prototype.onRawResult = <span class="fstat-no" title="function not covered" >function onRawResult(builder, rows) {</span>
<span class="cstat-no" title="statement not covered" >    return this.joinBuilder.rowsToTree(rows);</span>
  };
&nbsp;
