...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/jsonApi/WhereJsonNotObjectPostgresOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/jsonApi/WhereJsonNotObjectPostgresOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/jsonApi/</a> &#187; WhereJsonNotObjectPostgresOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function WhereJsonNotObjectPostgresOperation() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, WhereJsonNotObjectPostgresOperation);</span>
...
&nbsp;
  WhereJsonNotObjectPostgresOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(knexBuilder, builder) {</span>
<span class="cstat-no" title="statement not covered" >    this.whereJsonNotObject(knexBuilder, builder.knex(), this.args[0]);</span>
  };
&nbsp;
  WhereJsonNotObjectPostgresOperation.prototype.whereJsonNotObject = <span class="fstat-no" title="function not covered" >function whereJsonNotObject(knexBuilder, knex, fieldExpression) {</span>
<span class="cstat-no" title="statement not covered" >    var self = this;</span>
&nbsp;
<span class="fstat-no" title="function not covered" >    function innerQuery() {</span>
<span class="cstat-no" title="statement not covered" >      var builder = _postgresJsonApi2.default.whereJsonbRefOnLeftJsonbValOrRefOnRight(this, fieldExpression, "@&gt;", self.opt.compareValue, 'not');</span>
<span class="cstat-no" title="statement not covered" >      var ifRefNotExistQuery = _postgresJsonApi2.default.whereJsonFieldQuery(knex, fieldExpression, "IS", null);</span>
<span class="cstat-no" title="statement not covered" >      builder.orWhereRaw(ifRefNotExistQuery);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.opt.bool === 'or') {</span>
<span class="cstat-no" title="statement not covered" >      knexBuilder.orWhere(innerQuery);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      knexBuilder.where(innerQuery);</span>
    }
  };
&nbsp;
