...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/jsonApi/WhereJsonPostgresOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/jsonApi/WhereJsonPostgresOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/jsonApi/</a> &#187; WhereJsonPostgresOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function WhereJsonPostgresOperation(builder, name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, WhereJsonPostgresOperation);</span>
&nbsp;
    /**
     * @type {Array.&lt;string&gt;}
     */
<span class="cstat-no" title="statement not covered" >    var _this = (0, _possibleConstructorReturn3.default)(this, _WrappingQueryBuilder.call(this, builder, name, opt));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.rawArgs = null;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  WhereJsonPostgresOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    _WrappingQueryBuilder.prototype.call.call(this, builder, args);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.rawArgs = _postgresJsonApi2.default.whereJsonbRefOnLeftJsonbValOrRefOnRightRawQueryParams(this.args[0], this.opt.operator, this.args[1], this.opt.prefix);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return true;</span>
  };
&nbsp;
  WhereJsonPostgresOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(knexBuilder) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.opt.bool === 'or') {</span>
<span class="cstat-no" title="statement not covered" >      knexBuilder.orWhereRaw.apply(knexBuilder, this.rawArgs);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      knexBuilder.whereRaw.apply(knexBuilder, this.rawArgs);</span>
    }
  };
&nbsp;
