...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/whereInComposite/WhereInCompositeSqliteOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/whereInComposite/WhereInCompositeSqliteOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/whereInComposite/</a> &#187; WhereInCompositeSqliteOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function WhereInCompositeSqliteOperation() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, WhereInCompositeSqliteOperation);</span>
...
&nbsp;
  WhereInCompositeSqliteOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(knexBuilder) {</span>
<span class="cstat-no" title="statement not covered" >    this.build(knexBuilder, this.args[0], this.args[1]);</span>
  };
&nbsp;
  WhereInCompositeSqliteOperation.prototype.build = <span class="fstat-no" title="function not covered" >function build(knexBuilder, columns, values) {</span>
...
&nbsp;
  WhereInCompositeSqliteOperation.prototype.buildComposite = <span class="fstat-no" title="function not covered" >function buildComposite(knexBuilder, columns, values) {</span>
...
<span class="cstat-no" title="statement not covered" >      throw new Error('sqlite doesn\'t support multi-column where in clauses');</span>
    }
&nbsp;
    // Sqlite doesn't support the `where in` syntax for multiple columns but
    // we can emulate it using grouped `or` clauses.
<span class="cstat-no" title="statement not covered" >    knexBuilder.where(<span class="fstat-no" title="function not covered" >function (builder) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        builder.orWhere(<span class="fstat-no" title="function not covered" >function (builder) {</span></span>
<span class="cstat-no" title="statement not covered" >          columns.forEach(<span class="fstat-no" title="function not covered" >function (col, idx) {</span></span>
<span class="cstat-no" title="statement not covered" >            builder.andWhere(col, val[idx]);</span>
          });
        });
      });
    });
...
&nbsp;
  WhereInCompositeSqliteOperation.prototype.buildNonComposite = <span class="fstat-no" title="function not covered" >function buildNonComposite(knexBuilder, columns, values) {</span>
