...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/parsers/jsonFieldExpressionParser.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/parsers/jsonFieldExpressionParser.js</span></h1>
    <h2>
        
        Statements: <span class="metric">7.71% <small>(35 / 454)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">7.71% <small>(35 / 454)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/parsers/</a> &#187; jsonFieldExpressionParser.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    var options = arguments.length &gt; 1 ? arguments[1] : {},</span>
        ...
        peg$c4 = [],
        peg$c5 = <span class="fstat-no" title="function not covered" >function peg$c5(column, refs) {</span>
...
<span class="cstat-no" title="statement not covered" >        var firstAccess = refs[1];</span>
<span class="cstat-no" title="statement not covered" >        access = refs[2];</span>
<span class="cstat-no" title="statement not covered" >        access.unshift(firstAccess);</span>
      }
<span class="cstat-no" title="statement not covered" >      return { columnName: column, access: access };</span>
    },
        peg$c6 = "[",
        ...
        peg$c14 = <span class="fstat-no" title="function not covered" >function peg$c14(key) {</span>
<span class="cstat-no" title="statement not covered" >      return { type: 'object', ref: Array.isArray(key) ? key[1] : key };</span>
    },
        peg$c15 = <span class="fstat-no" title="function not covered" >function peg$c15(index) {</span>
<span class="cstat-no" title="statement not covered" >      return { type: 'array', ref: parseInt(index, 10) };</span>
    },
        peg$c16 = <span class="fstat-no" title="function not covered" >function peg$c16(key) {</span>
<span class="cstat-no" title="statement not covered" >      return { type: 'object', ref: key };</span>
    },
        peg$c17 = ".",
        peg$c18 = { type: "literal", value: ".", description: "\".\"" },
        peg$c19 = /^[^\][]/,
        peg$c20 = { type: "class", value: "[^\\][]", description: "[^\\][]" },
        peg$c21 = <span class="fstat-no" title="function not covered" >function peg$c21(chars) {</span>
<span class="cstat-no" title="statement not covered" >      return chars.join("");</span>
        ...
        peg$c32 = <span class="fstat-no" title="function not covered" >function peg$c32(digits) {</span>
...
<span class="cstat-no" title="statement not covered" >      throw peg$buildException(null, [{ type: "other", description: description }], peg$reportedPos);</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            return '\\x' + hex(ch);</span>
          }).replace(/[\u0180-\u0FFF]/g, <span class="fstat-no" title="function not covered" >function (ch) {</span>
<span class="cstat-no" title="statement not covered" >            return "\\u0" + hex(ch);</span>
          }).replace(/[\u1080-\uFFFF]/g, <span class="fstat-no" title="function not covered" >function (ch) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return new SyntaxError(message !== null ? message : buildMessage(expected, found), expected, found, pos, posDetails.line, posDetails.column);</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      s1 = peg$parsestringWithoutColon();</span>
...
<span class="cstat-no" title="statement not covered" >            peg$fail(peg$c3);</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        if (s3 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >          s4 = peg$parsebracketIndexRef();</span>
<span class="cstat-no" title="statement not covered" >          if (s4 === peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >            s4 = peg$parsebracketStringRef();</span>
<span class="cstat-no" title="statement not covered" >            if (s4 === peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >              s4 = peg$parsecolonReference();</span>
            }
          }
<span class="cstat-no" title="statement not covered" >          if (s4 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >            s5 = [];</span>
<span class="cstat-no" title="statement not covered" >            s6 = peg$parsebracketIndexRef();</span>
<span class="cstat-no" title="statement not covered" >            if (s6 === peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >              s6 = peg$parsebracketStringRef();</span>
<span class="cstat-no" title="statement not covered" >              if (s6 === peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >                s6 = peg$parsedotReference();</span>
              }
            }
...
<span class="cstat-no" title="statement not covered" >              s2 = peg$c0;</span>
            }
          } else {
<span class="cstat-no" title="statement not covered" >            peg$currPos = s2;</span>
<span class="cstat-no" title="statement not covered" >            s2 = peg$c0;</span>
...
<span class="cstat-no" title="statement not covered" >          s1 = peg$c5(s1, s2);</span>
...
<span class="cstat-no" title="statement not covered" >          s0 = peg$c0;</span>
        }
      } else {
<span class="cstat-no" title="statement not covered" >        peg$currPos = s0;</span>
<span class="cstat-no" title="statement not covered" >        s0 = peg$c0;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parsebracketStringRef() {</span>
...
<span class="cstat-no" title="statement not covered" >        s1 = peg$c6;</span>
<span class="cstat-no" title="statement not covered" >        peg$currPos++;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        s1 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >        if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >          peg$fail(peg$c7);</span>
        }
      }
<span class="cstat-no" title="statement not covered" >      if (s1 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        s2 = peg$currPos;</span>
...
<span class="cstat-no" title="statement not covered" >          s3 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >          if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >            peg$fail(peg$c9);</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        if (s3 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >          s4 = peg$parsestringWithoutDoubleQuotes();</span>
<span class="cstat-no" title="statement not covered" >          if (s4 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >            if (input.charCodeAt(peg$currPos) === 34) {</span>
<span class="cstat-no" title="statement not covered" >              s5 = peg$c8;</span>
<span class="cstat-no" title="statement not covered" >              peg$currPos++;</span>
            } else {
...
<span class="cstat-no" title="statement not covered" >            s3 = peg$c10;</span>
<span class="cstat-no" title="statement not covered" >            peg$currPos++;</span>
          } else {
<span class="cstat-no" title="statement not covered" >            s3 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >            if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >              peg$fail(peg$c11);</span>
            }
          }
<span class="cstat-no" title="statement not covered" >          if (s3 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >            s4 = peg$parsestringWithoutSingleQuotes();</span>
<span class="cstat-no" title="statement not covered" >            if (s4 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >              if (input.charCodeAt(peg$currPos) === 39) {</span>
<span class="cstat-no" title="statement not covered" >                s5 = peg$c10;</span>
<span class="cstat-no" title="statement not covered" >                peg$currPos++;</span>
              } else {
<span class="cstat-no" title="statement not covered" >                s5 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >                if (peg$silentFails === 0) {</span>
...
<span class="cstat-no" title="statement not covered" >          if (s2 === peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >            s2 = peg$parsestringWithoutSquareBrackets();</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        if (s2 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >          if (input.charCodeAt(peg$currPos) === 93) {</span>
<span class="cstat-no" title="statement not covered" >            s3 = peg$c12;</span>
<span class="cstat-no" title="statement not covered" >            peg$currPos++;</span>
          } else {
<span class="cstat-no" title="statement not covered" >            s3 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >            if (peg$silentFails === 0) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parsebracketIndexRef() {</span>
...
<span class="cstat-no" title="statement not covered" >      if (s1 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        s2 = peg$parseinteger();</span>
<span class="cstat-no" title="statement not covered" >        if (s2 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >          if (input.charCodeAt(peg$currPos) === 93) {</span>
<span class="cstat-no" title="statement not covered" >            s3 = peg$c12;</span>
<span class="cstat-no" title="statement not covered" >            peg$currPos++;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parsecolonReference() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = peg$parsestringWithoutSquareBracketsOrDots();</span>
<span class="cstat-no" title="statement not covered" >      if (s1 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        peg$reportedPos = s0;</span>
<span class="cstat-no" title="statement not covered" >        s1 = peg$c16(s1);</span>
      }
<span class="cstat-no" title="statement not covered" >      s0 = s1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return s0;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parsedotReference() {</span>
...
<span class="cstat-no" title="statement not covered" >      if (s1 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        s2 = peg$parsestringWithoutSquareBracketsOrDots();</span>
<span class="cstat-no" title="statement not covered" >        if (s2 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >          peg$reportedPos = s0;</span>
<span class="cstat-no" title="statement not covered" >          s1 = peg$c16(s2);</span>
<span class="cstat-no" title="statement not covered" >          s0 = s1;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          peg$currPos = s0;</span>
<span class="cstat-no" title="statement not covered" >          s0 = peg$c0;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parsestringWithoutSquareBrackets() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1, s2;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = [];</span>
<span class="cstat-no" title="statement not covered" >      if (peg$c19.test(input.charAt(peg$currPos))) {</span>
...
<span class="cstat-no" title="statement not covered" >        if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >          peg$fail(peg$c20);</span>
        }
      }
<span class="cstat-no" title="statement not covered" >      if (s2 !== peg$FAILED) {</span>
...
<span class="cstat-no" title="statement not covered" >        s1 = peg$c0;</span>
      }
<span class="cstat-no" title="statement not covered" >      if (s1 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        peg$reportedPos = s0;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parsestringWithoutColon() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1, s2;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = [];</span>
<span class="cstat-no" title="statement not covered" >      if (peg$c22.test(input.charAt(peg$currPos))) {</span>
<span class="cstat-no" title="statement not covered" >        s2 = input.charAt(peg$currPos);</span>
<span class="cstat-no" title="statement not covered" >        peg$currPos++;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        s2 = peg$FAILED;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parsestringWithoutDoubleQuotes() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1, s2;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = [];</span>
<span class="cstat-no" title="statement not covered" >      if (peg$c24.test(input.charAt(peg$currPos))) {</span>
<span class="cstat-no" title="statement not covered" >        s2 = input.charAt(peg$currPos);</span>
<span class="cstat-no" title="statement not covered" >        peg$currPos++;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        s2 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >        if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >          peg$fail(peg$c25);</span>
        }
      }
<span class="cstat-no" title="statement not covered" >      if (s2 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        while (s2 !== peg$FAILED) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parsestringWithoutSingleQuotes() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1, s2;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = [];</span>
<span class="cstat-no" title="statement not covered" >      if (peg$c26.test(input.charAt(peg$currPos))) {</span>
<span class="cstat-no" title="statement not covered" >        s2 = input.charAt(peg$currPos);</span>
<span class="cstat-no" title="statement not covered" >        peg$currPos++;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        s2 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >        if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >          peg$fail(peg$c27);</span>
        }
      }
<span class="cstat-no" title="statement not covered" >      if (s2 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        while (s2 !== peg$FAILED) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parsestringWithoutSquareBracketsOrDots() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1, s2;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = [];</span>
<span class="cstat-no" title="statement not covered" >      if (peg$c28.test(input.charAt(peg$currPos))) {</span>
<span class="cstat-no" title="statement not covered" >        s2 = input.charAt(peg$currPos);</span>
<span class="cstat-no" title="statement not covered" >        peg$currPos++;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        s2 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >        if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >          peg$fail(peg$c29);</span>
        }
      }
<span class="cstat-no" title="statement not covered" >      if (s2 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        while (s2 !== peg$FAILED) {</span>
...
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = [];</span>
<span class="cstat-no" title="statement not covered" >      if (peg$c30.test(input.charAt(peg$currPos))) {</span>
<span class="cstat-no" title="statement not covered" >        s2 = input.charAt(peg$currPos);</span>
<span class="cstat-no" title="statement not covered" >        peg$currPos++;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        s2 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >        if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >          peg$fail(peg$c31);</span>
        }
      }
<span class="cstat-no" title="statement not covered" >      if (s2 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        while (s2 !== peg$FAILED) {</span>
...
<span class="cstat-no" title="statement not covered" >      if (s1 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        peg$reportedPos = s0;</span>
<span class="cstat-no" title="statement not covered" >        s1 = peg$c32(s1);</span>
      }
<span class="cstat-no" title="statement not covered" >      s0 = s1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return s0;</span>
