...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/parsers/relationExpressionParser.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/parsers/relationExpressionParser.js</span></h1>
    <h2>
        
        Statements: <span class="metric">7.54% <small>(34 / 451)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">0% <small>(0 / 197)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">6.67% <small>(3 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">7.54% <small>(34 / 451)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/parsers/</a> &#187; relationExpressionParser.js</div>
</div>
<div class="body">
...
795
796
797</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function peg$SyntaxError(message, expected, found, location) {</span>
...
<span class="cstat-no" title="statement not covered" >      Error.captureStackTrace(this, peg$SyntaxError);</span>
    }
  }
&nbsp;
  peg$subclass(peg$SyntaxError, Error);
&nbsp;
<span class="fstat-no" title="function not covered" >  function peg$parse(input) {</span>
<span class="cstat-no" title="statement not covered" >    var options = arguments.length &gt; 1 ? arguments[1] : {},</span>
        parser = this,
        peg$FAILED = {},
        peg$startRuleFunctions = { start: peg$parsestart },
        peg$startRuleFunction = peg$parsestart,
        peg$c0 = <span class="fstat-no" title="function not covered" >function peg$c0(expr) {</span>
<span class="cstat-no" title="statement not covered" >      var node = { name: null, args: [], numChildren: 1, children: {} };</span>
<span class="cstat-no" title="statement not covered" >      node.children[expr.name] = expr;</span>
<span class="cstat-no" title="statement not covered" >      return node;</span>
    },
        peg$c1 = <span class="fstat-no" title="function not covered" >function peg$c1(list) {</span>
<span class="cstat-no" title="statement not covered" >      return { name: null, args: [], numChildren: list.list.length, children: list.byName };</span>
    },
        peg$c2 = <span class="fstat-no" title="function not covered" >function peg$c2(rel, args, list) {</span>
<span class="cstat-no" title="statement not covered" >      return { name: rel, args: args || [], numChildren: list.list.length, children: list.byName };</span>
    },
        peg$c3 = <span class="fstat-no" title="function not covered" >function peg$c3(rel, args, sub) {</span>
<span class="cstat-no" title="statement not covered" >      var node = { name: rel, args: args || [], numChildren: 0, children: {} };</span>
<span class="cstat-no" title="statement not covered" >      if (sub) {</span>
<span class="cstat-no" title="statement not covered" >        node.numChildren = 1;</span>
<span class="cstat-no" title="statement not covered" >        node.children[sub.name] = sub;</span>
      }
<span class="cstat-no" title="statement not covered" >      return node;</span>
    },
        peg$c4 = <span class="fstat-no" title="function not covered" >function peg$c4(rel) {</span>
<span class="cstat-no" title="statement not covered" >      return rel.join('');</span>
    },
        peg$c5 = /^[^[\](),. \t\r\n]/,
        ...
        peg$c11 = <span class="fstat-no" title="function not covered" >function peg$c11(args) {</span>
<span class="cstat-no" title="statement not covered" >      return args;</span>
    },
        peg$c12 = ",",
        peg$c13 = { type: "literal", value: ",", description: "\",\"" },
        peg$c14 = <span class="fstat-no" title="function not covered" >function peg$c14(arg) {</span>
<span class="cstat-no" title="statement not covered" >      return arg;</span>
        ...
        peg$c19 = <span class="fstat-no" title="function not covered" >function peg$c19(list) {</span>
<span class="cstat-no" title="statement not covered" >      return list;</span>
        ...
        peg$c24 = <span class="fstat-no" title="function not covered" >function peg$c24(items) {</span>
<span class="cstat-no" title="statement not covered" >      var itemsByName = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var i = 0; i &lt; items.length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        itemsByName[items[i].name] = items[i];</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return {</span>
        ...
        peg$c25 = <span class="fstat-no" title="function not covered" >function peg$c25(expr) {</span>
<span class="cstat-no" title="statement not covered" >      return expr;</span>
    },
        peg$c26 = <span class="fstat-no" title="function not covered" >function peg$c26(sub) {</span>
...
<span class="cstat-no" title="statement not covered" >      return input.substring(peg$savedPos, peg$currPos);</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      throw peg$buildException(null, [{ type: "other", description: description }], input.substring(peg$savedPos, peg$currPos), peg$computeLocation(peg$savedPos, peg$currPos));</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function error(message) {</span>
<span class="cstat-no" title="statement not covered" >      throw peg$buildException(message, null, input.substring(peg$savedPos, peg$currPos), peg$computeLocation(peg$savedPos, peg$currPos));</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$computePosDetails(pos) {</span>
<span class="cstat-no" title="statement not covered" >      var details = peg$posDetailsCache[pos],</span>
          p,
          ch;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        p = pos - 1;</span>
<span class="cstat-no" title="statement not covered" >        while (!peg$posDetailsCache[p]) {</span>
<span class="cstat-no" title="statement not covered" >          p--;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        details = peg$posDetailsCache[p];</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        while (p &lt; pos) {</span>
...
<span class="cstat-no" title="statement not covered" >            if (!details.seenCR) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        peg$posDetailsCache[pos] = details;</span>
<span class="cstat-no" title="statement not covered" >        return details;</span>
      }
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$computeLocation(startPos, endPos) {</span>
<span class="cstat-no" title="statement not covered" >      var startPosDetails = peg$computePosDetails(startPos),</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$buildException(message, expected, found, location) {</span>
...
<span class="fstat-no" title="function not covered" >          function hex(ch) {</span>
<span class="cstat-no" title="statement not covered" >            return ch.charCodeAt(0).toString(16).toUpperCase();</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          return s.replace(/\\/g, '\\\\').replace(/"/g, '\\"').replace(/\x08/g, '\\b').replace(/\t/g, '\\t').replace(/\n/g, '\\n').replace(/\f/g, '\\f').replace(/\r/g, '\\r').replace(/[\x00-\x07\x0B\x0E\x0F]/g, <span class="fstat-no" title="function not covered" >function (ch) {</span></span>
<span class="cstat-no" title="statement not covered" >            return '\\x0' + hex(ch);</span>
          }).replace(/[\x10-\x1F\x80-\xFF]/g, <span class="fstat-no" title="function not covered" >function (ch) {</span>
<span class="cstat-no" title="statement not covered" >            return '\\x' + hex(ch);</span>
          }).replace(/[\u0100-\u0FFF]/g, <span class="fstat-no" title="function not covered" >function (ch) {</span>
<span class="cstat-no" title="statement not covered" >            return "\\u0" + hex(ch);</span>
          }).replace(/[\u1000-\uFFFF]/g, <span class="fstat-no" title="function not covered" >function (ch) {</span>
<span class="cstat-no" title="statement not covered" >            return "\\u" + hex(ch);</span>
          });
        }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        expectedDesc = expected.length &gt; 1 ? expectedDescs.slice(0, -1).join(", ") + " or " + expectedDescs[expected.length - 1] : expectedDescs[0];</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return new peg$SyntaxError(message !== null ? message : buildMessage(expected, found), expected, found, location);</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      s1 = peg$parseexpression();</span>
...
<span class="cstat-no" title="statement not covered" >        s1 = peg$c0(s1);</span>
      }
...
<span class="cstat-no" title="statement not covered" >        s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >        s1 = peg$parselistExpression();</span>
<span class="cstat-no" title="statement not covered" >        if (s1 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >          peg$savedPos = s0;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = peg$parserelation();</span>
<span class="cstat-no" title="statement not covered" >      if (s1 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        s2 = peg$parseargs();</span>
<span class="cstat-no" title="statement not covered" >        if (s2 === peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >          s2 = null;</span>
        }
<span class="cstat-no" title="statement not covered" >        if (s2 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >          s3 = peg$parsesubListExpression();</span>
<span class="cstat-no" title="statement not covered" >          if (s3 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >            peg$savedPos = s0;</span>
<span class="cstat-no" title="statement not covered" >            s1 = peg$c2(s1, s2, s3);</span>
<span class="cstat-no" title="statement not covered" >            s0 = s1;</span>
          } else {
...
<span class="cstat-no" title="statement not covered" >          if (s2 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >            s3 = peg$parsesubExpression();</span>
<span class="cstat-no" title="statement not covered" >            if (s3 === peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >              s3 = null;</span>
            }
<span class="cstat-no" title="statement not covered" >            if (s3 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >              peg$savedPos = s0;</span>
<span class="cstat-no" title="statement not covered" >              s1 = peg$c3(s1, s2, s3);</span>
<span class="cstat-no" title="statement not covered" >              s0 = s1;</span>
            } else {
<span class="cstat-no" title="statement not covered" >              peg$currPos = s0;</span>
<span class="cstat-no" title="statement not covered" >              s0 = peg$FAILED;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parserelation() {</span>
...
<span class="cstat-no" title="statement not covered" >      if (s1 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        peg$savedPos = s0;</span>
<span class="cstat-no" title="statement not covered" >        s1 = peg$c4(s1);</span>
      }
<span class="cstat-no" title="statement not covered" >      s0 = s1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return s0;</span>
...
<span class="cstat-no" title="statement not covered" >        s0 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >        if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >          peg$fail(peg$c6);</span>
        }
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return s0;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parseargs() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1, s2, s3, s4, s5;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = peg$parsews();</span>
<span class="cstat-no" title="statement not covered" >      if (s1 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        if (input.charCodeAt(peg$currPos) === 40) {</span>
...
<span class="cstat-no" title="statement not covered" >          if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >            peg$fail(peg$c8);</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        if (s2 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >          s3 = [];</span>
<span class="cstat-no" title="statement not covered" >          s4 = peg$parseargListItem();</span>
...
<span class="cstat-no" title="statement not covered" >          if (s3 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >            if (input.charCodeAt(peg$currPos) === 41) {</span>
...
<span class="cstat-no" title="statement not covered" >              if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >                peg$fail(peg$c10);</span>
              }
            }
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parseargListItem() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1, s2, s3, s4, s5;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = peg$parsews();</span>
<span class="cstat-no" title="statement not covered" >      if (s1 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >        s2 = peg$parsearg();</span>
<span class="cstat-no" title="statement not covered" >        if (s2 !== peg$FAILED) {</span>
...
<span class="cstat-no" title="statement not covered" >              s4 = peg$c12;</span>
<span class="cstat-no" title="statement not covered" >              peg$currPos++;</span>
            } else {
<span class="cstat-no" title="statement not covered" >              s4 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >              if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >                peg$fail(peg$c13);</span>
              }
            }
<span class="cstat-no" title="statement not covered" >            if (s4 === peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >              s4 = null;</span>
            }
<span class="cstat-no" title="statement not covered" >            if (s4 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >              s5 = peg$parsews();</span>
<span class="cstat-no" title="statement not covered" >              if (s5 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >                peg$savedPos = s0;</span>
<span class="cstat-no" title="statement not covered" >                s1 = peg$c14(s2);</span>
<span class="cstat-no" title="statement not covered" >                s0 = s1;</span>
              } else {
<span class="cstat-no" title="statement not covered" >                peg$currPos = s0;</span>
<span class="cstat-no" title="statement not covered" >                s0 = peg$FAILED;</span>
...
<span class="cstat-no" title="statement not covered" >      if (peg$c15.test(input.charAt(peg$currPos))) {</span>
<span class="cstat-no" title="statement not covered" >        s1 = input.charAt(peg$currPos);</span>
<span class="cstat-no" title="statement not covered" >        peg$currPos++;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        s1 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >        if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >          peg$fail(peg$c16);</span>
        }
      }
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parsearg() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1, s2;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = [];</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parsesubListExpression() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1, s2, s3, s4, s5;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = peg$parsews();</span>
...
<span class="cstat-no" title="statement not covered" >          s2 = peg$c17;</span>
<span class="cstat-no" title="statement not covered" >          peg$currPos++;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          s2 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >          if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >            peg$fail(peg$c18);</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        if (s2 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >          s3 = peg$parsews();</span>
<span class="cstat-no" title="statement not covered" >          if (s3 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >            s4 = peg$parselistExpression();</span>
<span class="cstat-no" title="statement not covered" >            if (s4 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >              s5 = peg$parsews();</span>
<span class="cstat-no" title="statement not covered" >              if (s5 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >                peg$savedPos = s0;</span>
<span class="cstat-no" title="statement not covered" >                s1 = peg$c19(s4);</span>
<span class="cstat-no" title="statement not covered" >                s0 = s1;</span>
              } else {
<span class="cstat-no" title="statement not covered" >                peg$currPos = s0;</span>
<span class="cstat-no" title="statement not covered" >                s0 = peg$FAILED;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parselistExpression() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1, s2, s3, s4, s5;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = peg$parsews();</span>
...
<span class="cstat-no" title="statement not covered" >          s2 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >          if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >            peg$fail(peg$c21);</span>
          }
        }
<span class="cstat-no" title="statement not covered" >        if (s2 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >          s3 = [];</span>
<span class="cstat-no" title="statement not covered" >          s4 = peg$parselistExpressionItem();</span>
<span class="cstat-no" title="statement not covered" >          while (s4 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >            s3.push(s4);</span>
<span class="cstat-no" title="statement not covered" >            s4 = peg$parselistExpressionItem();</span>
          }
...
<span class="cstat-no" title="statement not covered" >              s4 = peg$FAILED;</span>
<span class="cstat-no" title="statement not covered" >              if (peg$silentFails === 0) {</span>
<span class="cstat-no" title="statement not covered" >                peg$fail(peg$c23);</span>
              }
            }
<span class="cstat-no" title="statement not covered" >            if (s4 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >              s5 = peg$parsews();</span>
<span class="cstat-no" title="statement not covered" >              if (s5 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >                peg$savedPos = s0;</span>
<span class="cstat-no" title="statement not covered" >                s1 = peg$c24(s3);</span>
<span class="cstat-no" title="statement not covered" >                s0 = s1;</span>
              } else {
<span class="cstat-no" title="statement not covered" >                peg$currPos = s0;</span>
<span class="cstat-no" title="statement not covered" >                s0 = peg$FAILED;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parselistExpressionItem() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1, s2, s3, s4, s5;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = peg$parsews();</span>
...
<span class="cstat-no" title="statement not covered" >              if (s5 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >                peg$savedPos = s0;</span>
<span class="cstat-no" title="statement not covered" >                s1 = peg$c25(s2);</span>
<span class="cstat-no" title="statement not covered" >                s0 = s1;</span>
              } else {
<span class="cstat-no" title="statement not covered" >                peg$currPos = s0;</span>
<span class="cstat-no" title="statement not covered" >                s0 = peg$FAILED;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function peg$parsesubExpression() {</span>
<span class="cstat-no" title="statement not covered" >      var s0, s1, s2, s3, s4, s5;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      s0 = peg$currPos;</span>
<span class="cstat-no" title="statement not covered" >      s1 = peg$parsews();</span>
...
<span class="cstat-no" title="statement not covered" >          s3 = peg$parsews();</span>
<span class="cstat-no" title="statement not covered" >          if (s3 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >            s4 = peg$parseexpression();</span>
<span class="cstat-no" title="statement not covered" >            if (s4 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >              s5 = peg$parsews();</span>
<span class="cstat-no" title="statement not covered" >              if (s5 !== peg$FAILED) {</span>
<span class="cstat-no" title="statement not covered" >                peg$savedPos = s0;</span>
<span class="cstat-no" title="statement not covered" >                s1 = peg$c26(s4);</span>
<span class="cstat-no" title="statement not covered" >                s0 = s1;</span>
              } else {
<span class="cstat-no" title="statement not covered" >                peg$currPos = s0;</span>
<span class="cstat-no" title="statement not covered" >                s0 = peg$FAILED;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      throw peg$buildException(null, peg$maxFailExpected, peg$maxFailPos &lt; input.length ? input.charAt(peg$maxFailPos) : null, peg$maxFailPos &lt; input.length ? peg$computeLocation(peg$maxFailPos, peg$maxFailPos + 1) : peg$computeLocation(peg$maxFailPos, peg$maxFailPos));</span>
    }
  }
&nbsp;
  return {
