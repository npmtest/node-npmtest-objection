...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/belongsToOne/BelongsToOneInsertOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/belongsToOne/BelongsToOneInsertOperation.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">47.5% <small>(19 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/belongsToOne/</a> &#187; BelongsToOneInsertOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function BelongsToOneInsertOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, BelongsToOneInsertOperation);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = (0, _possibleConstructorReturn3.default)(this, _InsertOperation.call(this, name, opt));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.relation = opt.relation;</span>
<span class="cstat-no" title="statement not covered" >    _this.owner = opt.owner;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  BelongsToOneInsertOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    var retVal = _InsertOperation.prototype.call.call(this, builder, args);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.models.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >      this.relation.throwError('can only insert one model to a BelongsToOneRelation');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return retVal;</span>
  };
&nbsp;
  BelongsToOneInsertOperation.prototype.onAfterQuery = <span class="fstat-no" title="function not covered" >function onAfterQuery(builder, inserted) {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var maybePromise = _InsertOperation.prototype.onAfterQuery.call(this, builder, inserted);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return (0, _promiseUtils.after)(maybePromise, <span class="fstat-no" title="function not covered" >function (inserted) {</span></span>
<span class="cstat-no" title="statement not covered" >      _this2.owner[_this2.relation.name] = inserted[0] || null;</span>
<span class="cstat-no" title="statement not covered" >      var patch = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = _this2.relation.ownerProp.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        var ownerProp = _this2.relation.ownerProp[i];</span>
<span class="cstat-no" title="statement not covered" >        var relatedProp = _this2.relation.relatedProp[i];</span>
<span class="cstat-no" title="statement not covered" >        var relatedValue = inserted[0][relatedProp];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _this2.owner[ownerProp] = inserted[0][relatedProp];</span>
<span class="cstat-no" title="statement not covered" >        patch[ownerProp] = relatedValue;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _this2.relation.ownerModelClass.query().childQueryOf(builder).patch(patch).whereComposite(_this2.relation.ownerModelClass.getFullIdColumn(), _this2.owner.$id()).return(inserted);</span>
    });
  };
&nbsp;
