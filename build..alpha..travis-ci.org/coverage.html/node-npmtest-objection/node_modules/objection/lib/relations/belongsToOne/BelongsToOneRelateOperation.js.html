...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/belongsToOne/BelongsToOneRelateOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/belongsToOne/BelongsToOneRelateOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/belongsToOne/</a> &#187; BelongsToOneRelateOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function BelongsToOneRelateOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, BelongsToOneRelateOperation);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    _this.input = null;</span>
<span class="cstat-no" title="statement not covered" >    _this.ids = null;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  BelongsToOneRelateOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    this.input = args[0];</span>
<span class="cstat-no" title="statement not covered" >    this.ids = (0, _normalizeIds2.default)(args[0], this.relation.relatedProp, { arrayOutput: true });</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.ids.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >      this.relation.throwError('can only relate one model to a BelongsToOneRelation');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return true;</span>
  };
&nbsp;
  BelongsToOneRelateOperation.prototype.queryExecutor = <span class="fstat-no" title="function not covered" >function queryExecutor(builder) {</span>
<span class="cstat-no" title="statement not covered" >    var patch = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = this.relation.ownerProp.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var prop = this.relation.ownerProp[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.owner[prop] = this.ids[0][i];</span>
<span class="cstat-no" title="statement not covered" >      patch[prop] = this.ids[0][i];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.relation.ownerModelClass.query().childQueryOf(builder).copyFrom(builder, /where/i).patch(patch).whereComposite(this.relation.ownerModelClass.getFullIdColumn(), this.owner.$id());</span>
  };
&nbsp;
  BelongsToOneRelateOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal(builder) {</span>
