...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/belongsToOne/BelongsToOneRelation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/belongsToOne/BelongsToOneRelation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/belongsToOne/</a> &#187; BelongsToOneRelation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function BelongsToOneRelation() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, BelongsToOneRelation);</span>
...
&nbsp;
  BelongsToOneRelation.prototype.isOneToOne = <span class="fstat-no" title="function not covered" >function isOneToOne() {</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  };
&nbsp;
  BelongsToOneRelation.prototype.insert = <span class="fstat-no" title="function not covered" >function insert(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    return new _BelongsToOneInsertOperation2.default('insert', {</span>
      relation: this,
      owner: owner
    });
  };
&nbsp;
  BelongsToOneRelation.prototype.relate = <span class="fstat-no" title="function not covered" >function relate(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    return new _BelongsToOneRelateOperation2.default('relate', {</span>
      relation: this,
      owner: owner
    });
  };
&nbsp;
  BelongsToOneRelation.prototype.unrelate = <span class="fstat-no" title="function not covered" >function unrelate(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    return new _BelongsToOneUnrelateOperation2.default('unrelate', {</span>
      relation: this,
      owner: owner
    });
  };
