...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/hasMany/HasManyInsertOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/hasMany/HasManyInsertOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/hasMany/</a> &#187; HasManyInsertOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function HasManyInsertOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, HasManyInsertOperation);</span>
&nbsp;
...
&nbsp;
  HasManyInsertOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    var retVal = _InsertOperation.prototype.call.call(this, builder, args);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, lm = this.models.length; i &lt; lm; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var model = this.models[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var j = 0, lp = this.relation.relatedProp.length; j &lt; lp; ++j) {</span>
<span class="cstat-no" title="statement not covered" >        var relatedProp = this.relation.relatedProp[j];</span>
<span class="cstat-no" title="statement not covered" >        var ownerProp = this.relation.ownerProp[j];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        model[relatedProp] = this.owner[ownerProp];</span>
      }
    }
&nbsp;
...
&nbsp;
  HasManyInsertOperation.prototype.onAfterQuery = <span class="fstat-no" title="function not covered" >function onAfterQuery(builder, inserted) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return inserted;</span>
    });
  };
&nbsp;
