...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/hasMany/HasManyRelateOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/hasMany/HasManyRelateOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/hasMany/</a> &#187; HasManyRelateOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function HasManyRelateOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, HasManyRelateOperation);</span>
&nbsp;
...
&nbsp;
  HasManyRelateOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    this.input = args[0];</span>
<span class="cstat-no" title="statement not covered" >    this.ids = (0, _normalizeIds2.default)(args[0], this.relation.relatedModelClass.getIdPropertyArray(), { arrayOutput: true });</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  };
&nbsp;
  HasManyRelateOperation.prototype.queryExecutor = <span class="fstat-no" title="function not covered" >function queryExecutor(builder) {</span>
<span class="cstat-no" title="statement not covered" >    var patch = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = this.relation.relatedProp.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var relatedProp = this.relation.relatedProp[i];</span>
<span class="cstat-no" title="statement not covered" >      var ownerProp = this.relation.ownerProp[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      patch[relatedProp] = this.owner[ownerProp];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.relation.relatedModelClass.query().childQueryOf(builder).patch(patch).copyFrom(builder, /where/i).whereInComposite(this.relation.relatedModelClass.getFullIdColumn(), this.ids).modify(this.relation.modify);</span>
  };
&nbsp;
  HasManyRelateOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal() {</span>
