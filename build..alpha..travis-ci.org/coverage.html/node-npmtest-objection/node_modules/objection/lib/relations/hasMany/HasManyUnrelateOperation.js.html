...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/hasMany/HasManyUnrelateOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/hasMany/HasManyUnrelateOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/hasMany/</a> &#187; HasManyUnrelateOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function HasManyUnrelateOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, HasManyUnrelateOperation);</span>
&nbsp;
...
&nbsp;
  HasManyUnrelateOperation.prototype.queryExecutor = <span class="fstat-no" title="function not covered" >function queryExecutor(builder) {</span>
...
<span class="cstat-no" title="statement not covered" >      patch[this.relation.relatedProp[i]] = null;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.relation.relatedModelClass.query().childQueryOf(builder).patch(patch).copyFrom(builder, /where/i).whereComposite(this.relation.fullRelatedCol(), this.owner.$values(this.relation.ownerProp)).modify(this.relation.modify);</span>
  };
&nbsp;
  HasManyUnrelateOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal() {</span>
