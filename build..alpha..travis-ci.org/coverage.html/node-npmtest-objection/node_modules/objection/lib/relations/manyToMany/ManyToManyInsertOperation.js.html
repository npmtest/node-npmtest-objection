...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/ManyToManyInsertOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/ManyToManyInsertOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/</a> &#187; ManyToManyInsertOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ManyToManyInsertOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, ManyToManyInsertOperation);</span>
&nbsp;
...
&nbsp;
  ManyToManyInsertOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    var retVal = _InsertOperation.prototype.call.call(this, builder, args);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.relation.omitExtraProps(this.models);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return retVal;</span>
  };
&nbsp;
  ManyToManyInsertOperation.prototype.onAfterQuery = <span class="fstat-no" title="function not covered" >function onAfterQuery(builder, inserted) {</span>
...
<span class="cstat-no" title="statement not covered" >    var relName = this.relation.name;</span>
<span class="cstat-no" title="statement not covered" >    var owner = this.owner;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var ownerId = _this2.owner.$values(_this2.relation.ownerProp);</span>
<span class="cstat-no" title="statement not covered" >      var joinModels = _this2.relation.createJoinModels(ownerId, inserted);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (isOneToOne) {</span>
<span class="cstat-no" title="statement not covered" >        owner[relName] = inserted[0] || null;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        owner[relName] = _this2.relation.mergeModels(owner[relName], inserted);</span>
      }
&nbsp;
      // Insert the join rows to the join table.
<span class="cstat-no" title="statement not covered" >      return _this2.relation.joinTableModelClass(builder.knex()).query().childQueryOf(builder).insert(joinModels).return(inserted);</span>
    });
  };
&nbsp;
