...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/ManyToManyUnrelateOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/ManyToManyUnrelateOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/</a> &#187; ManyToManyUnrelateOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ManyToManyUnrelateOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, ManyToManyUnrelateOperation);</span>
&nbsp;
...
&nbsp;
  ManyToManyUnrelateOperation.prototype.queryExecutor = <span class="fstat-no" title="function not covered" >function queryExecutor(builder) {</span>
<span class="cstat-no" title="statement not covered" >    var selectRelatedColQuery = this.relation.relatedModelClass.query().childQueryOf(builder).copyFrom(builder, /where/i).select(this.relation.fullRelatedCol()).modify(this.relation.modify);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.relation.joinTableModelClass(builder.knex()).query().childQueryOf(builder).delete().whereComposite(this.relation.fullJoinTableOwnerCol(), this.owner.$values(this.relation.ownerProp)).whereInComposite(this.relation.fullJoinTableRelatedCol(), selectRelatedColQuery).runAfter(_lodash2.default.constant({}));</span>
  };
&nbsp;
