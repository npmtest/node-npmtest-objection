...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/ManyToManyUpdateSqliteOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/ManyToManyUpdateSqliteOperation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">72% <small>(18 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/</a> &#187; ManyToManyUpdateSqliteOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ManyToManyUpdateSqliteOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, ManyToManyUpdateSqliteOperation);</span>
&nbsp;
...
&nbsp;
  ManyToManyUpdateSqliteOperation.prototype.onBeforeBuild = <span class="fstat-no" title="function not covered" >function onBeforeBuild(builder) {</span>
<span class="cstat-no" title="statement not covered" >    _UpdateOperation.prototype.onBeforeBuild.call(this, builder);</span>
<span class="cstat-no" title="statement not covered" >    this.relation.selectForModifySqlite(builder, this.owner).modify(this.relation.modify);</span>
  };
&nbsp;
