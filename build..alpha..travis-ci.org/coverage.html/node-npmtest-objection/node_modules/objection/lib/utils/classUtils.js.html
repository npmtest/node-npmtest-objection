...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/utils/classUtils.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/utils/classUtils.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/utils/</a> &#187; classUtils.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function inherits(subClass, superClass) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof superClass !== "function" &amp;&amp; superClass !== null) {</span>
<span class="cstat-no" title="statement not covered" >    throw new TypeError("Super expression must either be null or a function, not " + (typeof superClass === "undefined" ? "undefined" : (0, _typeof3.default)(superClass)));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  subClass.prototype = (0, _create2.default)(superClass &amp;&amp; superClass.prototype, {</span>
    constructor: {
      value: subClass,
      enumerable: false,
      writable: true,
 ...
 * @returns {boolean}
 */
<span class="fstat-no" title="function not covered" >function isSubclassOf(Constructor, SuperConstructor) {</span>
<span class="cstat-no" title="statement not covered" >  if (!_lodash2.default.isFunction(SuperConstructor)) {</span>
<span class="cstat-no" title="statement not covered" >    return false;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  while (_lodash2.default.isFunction(Constructor)) {</span>
<span class="cstat-no" title="statement not covered" >    if (Constructor === SuperConstructor) <span class="cstat-no" title="statement not covered" >return true;</span></span>
<span class="cstat-no" title="statement not covered" >    var proto = Constructor.prototype.__proto__;</span>
<span class="cstat-no" title="statement not covered" >    Constructor = proto &amp;&amp; proto.constructor;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return false;</span>
}
