...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/utils/decorators/memoize.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/utils/decorators/memoize.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/utils/decorators/</a> &#187; memoize.js</div>
</div>
<div class="body">
...
&nbsp;
  return <span class="fstat-no" title="function not covered" >function decorator$memoize() {</span>
<span class="cstat-no" title="statement not covered" >    var value = get(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (value === undefined) {</span>
<span class="cstat-no" title="statement not covered" >      value = impl.call(this);</span>
<span class="cstat-no" title="statement not covered" >      set(this, value);</span>
    }
&nbsp;
...
function memoizeSingleArg(impl, cacheProp) {
  ...
  var set = (0, _hiddenData.createSetter)(cacheProp);
&nbsp;
  return <span class="fstat-no" title="function not covered" >function decorator$memoize(input) {</span>
<span class="cstat-no" title="statement not covered" >    var cache = get(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (cache === undefined) {</span>
<span class="cstat-no" title="statement not covered" >      cache = (0, _create2.default)(null);</span>
<span class="cstat-no" title="statement not covered" >      set(this, cache);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (cache[input] !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >      return cache[input];</span>
    } else {
<span class="cstat-no" title="statement not covered" >      var value = impl.call(this, input);</span>
<span class="cstat-no" title="statement not covered" >      cache[input] = value;</span>
<span class="cstat-no" title="statement not covered" >      return value;</span>
    }
  };
}
