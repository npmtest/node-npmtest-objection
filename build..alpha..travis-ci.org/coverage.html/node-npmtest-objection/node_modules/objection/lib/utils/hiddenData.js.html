...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/utils/hiddenData.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/utils/hiddenData.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/utils/</a> &#187; hiddenData.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function init(obj, data) {</span>
<span class="cstat-no" title="statement not covered" >  (0, _defineProperty2.default)(obj, HIDDEN_DATA, {</span>
    enumerable: false,
    writable: true,
...
&nbsp;
<span class="fstat-no" title="function not covered" >function inheritHiddenData(src, dst) {</span>
<span class="cstat-no" title="statement not covered" >  init(dst, (0, _create2.default)(src[HIDDEN_DATA] || null));</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function copyHiddenData(src, dst) {</span>
<span class="cstat-no" title="statement not covered" >  init(dst, src[HIDDEN_DATA]);</span>
}
&nbsp;
