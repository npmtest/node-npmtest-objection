...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/utils/knexUtils.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/utils/knexUtils.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/utils/</a> &#187; knexUtils.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getDialect(knex) {</span>
<span class="cstat-no" title="statement not covered" >  return knex &amp;&amp; knex.client &amp;&amp; knex.client.dialect || null;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isPostgres(knex) {</span>
<span class="cstat-no" title="statement not covered" >  return getDialect(knex) === 'postgresql';</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isMySql(knex) {</span>
<span class="cstat-no" title="statement not covered" >  return getDialect(knex) === 'mysql';</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isSqlite(knex) {</span>
<span class="cstat-no" title="statement not covered" >  return getDialect(knex) === 'sqlite3';</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isMsSql(knex) {</span>
<span class="cstat-no" title="statement not covered" >  return getDialect(knex) === 'mssql';</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isKnexQueryBuilder(value) {</span>
<span class="cstat-no" title="statement not covered" >  return value instanceof _builder2.default;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isKnexJoinBuilder(value) {</span>
<span class="cstat-no" title="statement not covered" >  return value instanceof _joinclause2.default;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isKnexRaw(value) {</span>
<span class="cstat-no" title="statement not covered" >  return value instanceof _raw2.default;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isKnexTransaction(knex) {</span>
<span class="cstat-no" title="statement not covered" >  return !!getDialect(knex) &amp;&amp; typeof knex.commit === 'function' &amp;&amp; typeof knex.rollback === 'function';</span>
}
