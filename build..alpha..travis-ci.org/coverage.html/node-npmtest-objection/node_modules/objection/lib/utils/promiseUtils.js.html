...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/utils/promiseUtils.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/utils/promiseUtils.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/utils/</a> &#187; promiseUtils.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  return obj &amp;&amp; (typeof obj === 'undefined' ? 'undefined' : (0, _typeof3.default)(obj)) === 'object' &amp;&amp; typeof obj.then === 'function';</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function after(obj, func) {</span>
<span class="cstat-no" title="statement not covered" >  if (isPromise(obj)) {</span>
<span class="cstat-no" title="statement not covered" >    return obj.then(func);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    return func(obj);</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function afterReturn(obj, returnValue) {</span>
<span class="cstat-no" title="statement not covered" >  if (obj instanceof _bluebird2.default) {</span>
<span class="cstat-no" title="statement not covered" >    return obj.return(returnValue);</span>
  } else <span class="cstat-no" title="statement not covered" >if (isPromise(obj)) {</span>
<span class="cstat-no" title="statement not covered" >    return obj.then(<span class="fstat-no" title="function not covered" >function () {</span></span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function mapAfterAllReturn(arr, mapper, returnValue) {</span>
<span class="cstat-no" title="statement not covered" >  var results = new Array(arr.length);</span>
...
<span class="cstat-no" title="statement not covered" >    results[i] = mapper(arr[i]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (isPromise(results[i])) {</span>
...
<span class="cstat-no" title="statement not covered" >    return _bluebird2.default.all(results).return(returnValue);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    return returnValue;</span>
  }
}
