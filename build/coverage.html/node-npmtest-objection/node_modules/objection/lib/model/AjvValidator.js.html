...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/model/AjvValidator.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/model/AjvValidator.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">35.34% <small>(41 / 116)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/model/</a> &#187; AjvValidator.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function AjvValidator(conf) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, AjvValidator);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = (0, _possibleConstructorReturn3.default)(this, _Validator.call(this));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.ajv = new _ajv2.default(_lodash2.default.defaults({}, conf.options, {</span>
      useDefaults: true
    }));
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.ajvNoDefaults = new _ajv2.default(_lodash2.default.assign({}, conf.options, {</span>
      useDefaults: false
    }));
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.cache = (0, _create2.default)(null);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    conf.onCreateAjv(_this.ajv);</span>
<span class="cstat-no" title="statement not covered" >    conf.onCreateAjv(_this.ajvNoDefaults);</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  AjvValidator.prototype.beforeValidate = <span class="fstat-no" title="function not covered" >function beforeValidate(_ref) {</span>
<span class="cstat-no" title="statement not covered" >    var model = _ref.model,</span>
        json = _ref.json,
        options = _ref.options,
        ctx = _ref.ctx;
&nbsp;
<span class="cstat-no" title="statement not covered" >    ctx.jsonSchema = model.constructor.getJsonSchema();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (model.$beforeValidate !== _Model2.default.prototype.$beforeValidate) {</span>
<span class="cstat-no" title="statement not covered" >      ctx.jsonSchema = _lodash2.default.cloneDeep(ctx.jsonSchema);</span>
<span class="cstat-no" title="statement not covered" >      ctx.jsonSchema = model.$beforeValidate(ctx.jsonSchema, json, options);</span>
    }
  };
&nbsp;
  AjvValidator.prototype.validate = <span class="fstat-no" title="function not covered" >function validate(_ref2) {</span>
<span class="cstat-no" title="statement not covered" >    var model = _ref2.model,</span>
        json = _ref2.json,
        options = _ref2.options,
        ctx = _ref2.ctx;
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!ctx.jsonSchema) {</span>
<span class="cstat-no" title="statement not covered" >      return json;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var validator = this.getJsonSchemaValidator(model.constructor, ctx.jsonSchema, !!options.patch);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!options.mutable &amp;&amp; !options.patch &amp;&amp; this.setsDefaultValues(ctx.jsonSchema)) {</span>
<span class="cstat-no" title="statement not covered" >      json = _lodash2.default.cloneDeep(json);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    validator(json);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (validator.errors) {</span>
<span class="cstat-no" title="statement not covered" >      throw parseValidationError(validator.errors);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return json;</span>
  };
&nbsp;
  AjvValidator.prototype.getJsonSchemaValidator = <span class="fstat-no" title="function not covered" >function getJsonSchemaValidator(ModelClass, jsonSchema, skipRequired) {</span>
<span class="cstat-no" title="statement not covered" >    var key = jsonSchema === ModelClass.getJsonSchema() ? 'default' : (0, _stringify2.default)(jsonSchema);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var validators = this.cache[key];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!validators) {</span>
<span class="cstat-no" title="statement not covered" >      validators = {};</span>
<span class="cstat-no" title="statement not covered" >      this.cache[key] = validators;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var validator = validators[skipRequired];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!validator) {</span>
<span class="cstat-no" title="statement not covered" >      validator = this.compileJsonSchemaValidator(jsonSchema, skipRequired);</span>
<span class="cstat-no" title="statement not covered" >      validators[skipRequired] = validator;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return validator;</span>
  };
&nbsp;
  AjvValidator.prototype.compileJsonSchemaValidator = <span class="fstat-no" title="function not covered" >function compileJsonSchemaValidator(jsonSchema, skipRequired) {</span>
<span class="cstat-no" title="statement not covered" >    var origRequired = void 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      if (skipRequired) {</span>
<span class="cstat-no" title="statement not covered" >        origRequired = jsonSchema.required;</span>
<span class="cstat-no" title="statement not covered" >        jsonSchema.required = [];</span>
<span class="cstat-no" title="statement not covered" >        return this.ajvNoDefaults.compile(jsonSchema);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        return this.ajv.compile(jsonSchema);</span>
      }
    } finally {
<span class="cstat-no" title="statement not covered" >      if (skipRequired) {</span>
<span class="cstat-no" title="statement not covered" >        jsonSchema.required = origRequired;</span>
      }
    }
  };
&nbsp;
  AjvValidator.prototype.setsDefaultValues = <span class="fstat-no" title="function not covered" >function setsDefaultValues(jsonSchema) {</span>
<span class="cstat-no" title="statement not covered" >    return jsonSchema &amp;&amp; jsonSchema.properties &amp;&amp; hasDefaults(jsonSchema.properties);</span>
  };
&nbsp;
  return AjvValidator;
}(_Validator3.default);
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function parseValidationError(errors) {</span>
<span class="cstat-no" title="statement not covered" >  var errorHash = {};</span>
...
<span class="cstat-no" title="statement not covered" >    var error = errors[i];</span>
<span class="cstat-no" title="statement not covered" >    var key = error.dataPath.substring(1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!key) {</span>
<span class="cstat-no" title="statement not covered" >      var match = /should have required property '(.+)'/.exec(error.message);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!key &amp;&amp; error.params &amp;&amp; error.params.additionalProperty) {</span>
<span class="cstat-no" title="statement not covered" >      key = error.params.additionalProperty;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!key) {</span>
<span class="cstat-no" title="statement not covered" >      key = (index++).toString();</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    errorHash[key] = [{</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return new _ValidationError2.default(errorHash);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function hasDefaults(obj) {</span>
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(obj)) {</span>
<span class="cstat-no" title="statement not covered" >    return arrayHasDefaults(obj);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    return objectHasDefaults(obj);</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function arrayHasDefaults(arr) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (val &amp;&amp; (typeof val === 'undefined' ? 'undefined' : (0, _typeof3.default)(val)) === 'object' &amp;&amp; hasDefaults(val)) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function objectHasDefaults(obj) {</span>
