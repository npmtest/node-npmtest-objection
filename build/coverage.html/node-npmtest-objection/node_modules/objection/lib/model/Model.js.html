...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/model/Model.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/model/Model.js</span></h1>
    <h2>
        
        Statements: <span class="metric">27.7% <small>(172 / 621)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">5.11% <small>(14 / 274)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">4% <small>(5 / 125)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">27.58% <small>(171 / 620)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric">1 statement</span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/model/</a> &#187; Model.js</div>
</div>
<div class="body">
...
1717
1718
1719</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
var JoinEagerAlgorithm = <span class="fstat-no" title="function not covered" >function JoinEagerAlgorithm() {</span>
<span class="cstat-no" title="statement not covered" >  return new _JoinEagerOperation2.default('eager');</span>
};
&nbsp;
var WhereInEagerAlgorithm = <span class="fstat-no" title="function not covered" >function WhereInEagerAlgorithm() {</span>
<span class="cstat-no" title="statement not covered" >  return new _WhereInEagerOperation2.default('eager');</span>
};
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >  function Model() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, Model);</span>
  }
&nbsp;
  /**
   * @param {*=} id
...
&nbsp;
   ...
   * @type {string}
   */
  Model.prototype.$id = <span class="fstat-no" title="function not covered" >function $id(id) {</span>
<span class="cstat-no" title="statement not covered" >    if (arguments.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >      return setId(this, arguments[0]);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return getId(this);</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.prototype.$query = <span class="fstat-no" title="function not covered" >function $query(trx) {</span>
<span class="cstat-no" title="statement not covered" >    var _this = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var ModelClass = this.constructor;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return ModelClass.QueryBuilder.forClass(ModelClass).transacting(trx).findOperationFactory(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      return new _InstanceFindOperation2.default('find', { instance: _this });</span>
    }).insertOperationFactory(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      return new _InstanceInsertOperation2.default('insert', { instance: _this });</span>
    }).updateOperationFactory(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      return new _InstanceUpdateOperation2.default('update', { instance: _this });</span>
    }).patchOperationFactory(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      return new _InstanceUpdateOperation2.default('patch', { instance: _this, modelOptions: { patch: true } });</span>
    }).deleteOperationFactory(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      return new _InstanceDeleteOperation2.default('delete', { instance: _this });</span>
    }).relateOperationFactory(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('`relate` makes no sense in this context');</span>
    }).unrelateOperationFactory(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('`unrelate` makes no sense in this context');</span>
    });
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.prototype.$relatedQuery = <span class="fstat-no" title="function not covered" >function $relatedQuery(relationName, trx) {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var ModelClass = this.constructor;</span>
<span class="cstat-no" title="statement not covered" >    var relation = ModelClass.getRelation(relationName);</span>
<span class="cstat-no" title="statement not covered" >    var RelatedModelClass = relation.relatedModelClass;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return ModelClass.RelatedQueryBuilder.forClass(RelatedModelClass).transacting(trx).findOperationFactory(<span class="fstat-no" title="function not covered" >function (builder) {</span></span>
<span class="cstat-no" title="statement not covered" >      return relation.find(builder, [_this2]);</span>
    }).insertOperationFactory(<span class="fstat-no" title="function not covered" >function (builder) {</span>
<span class="cstat-no" title="statement not covered" >      return relation.insert(builder, _this2);</span>
    }).updateOperationFactory(<span class="fstat-no" title="function not covered" >function (builder) {</span>
<span class="cstat-no" title="statement not covered" >      return relation.update(builder, _this2);</span>
    }).patchOperationFactory(<span class="fstat-no" title="function not covered" >function (builder) {</span>
<span class="cstat-no" title="statement not covered" >      return relation.patch(builder, _this2);</span>
    }).deleteOperationFactory(<span class="fstat-no" title="function not covered" >function (builder) {</span>
<span class="cstat-no" title="statement not covered" >      return relation.delete(builder, _this2);</span>
    }).relateOperationFactory(<span class="fstat-no" title="function not covered" >function (builder) {</span>
<span class="cstat-no" title="statement not covered" >      return relation.relate(builder, _this2);</span>
    }).unrelateOperationFactory(<span class="fstat-no" title="function not covered" >function (builder) {</span>
<span class="cstat-no" title="statement not covered" >      return relation.unrelate(builder, _this2);</span>
    });
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.prototype.$loadRelated = <span class="fstat-no" title="function not covered" >function $loadRelated(relationExpression, filters) {</span>
<span class="cstat-no" title="statement not covered" >    return this.constructor.loadRelated(this, relationExpression, filters);</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.prototype.$beforeValidate = <span class="fstat-no" title="function not covered" >function $beforeValidate(jsonSchema, json, options) {</span>
    /* istanbul ignore next */
<span class="cstat-skip" title="statement not covered" >    return jsonSchema;</span>
  };
&nbsp;
  /**
   * @param {Object=} json
...
&nbsp;
&nbsp;
  Model.prototype.$validate = <span class="fstat-no" title="function not covered" >function $validate() {</span>
<span class="cstat-no" title="statement not covered" >    var json = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : this;</span>
<span class="cstat-no" title="statement not covered" >    var options = arguments[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    options = options || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (json instanceof Model) {</span>
      // Strip away relations and other internal stuff.
<span class="cstat-no" title="statement not covered" >      json = cloneModel(json, true, true);</span>
      // We can mutate `json` now that we took a copy of it.
<span class="cstat-no" title="statement not covered" >      options.mutable = true;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (options.skipValidation) {</span>
<span class="cstat-no" title="statement not covered" >      return json;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var validator = this.constructor.getValidator();</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    validator.beforeValidate(args);</span>
<span class="cstat-no" title="statement not covered" >    json = validator.validate(args);</span>
<span class="cstat-no" title="statement not covered" >    validator.afterValidate(args);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return json;</span>
  };
&nbsp;
...
&nbsp;
&nbsp;
  Model.prototype.$afterValidate = <span class="fstat-no" title="function not covered" >function $afterValidate(json, options) {</span>}
...
&nbsp;
  ...
  ;
&nbsp;
  Model.prototype.$parseDatabaseJson = <span class="fstat-no" title="function not covered" >function $parseDatabaseJson(json) {</span>
<span class="cstat-no" title="statement not covered" >    var jsonAttr = this.constructor.getJsonAttributes();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (jsonAttr.length) {</span>
      // JSON attributes may be returned as strings depending on the database and
      // the database client. Convert them to objects here.
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = jsonAttr.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        var attr = jsonAttr[i];</span>
<span class="cstat-no" title="statement not covered" >        var value = json[attr];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2.default.isString(value)) {</span>
<span class="cstat-no" title="statement not covered" >          var parsed = tryParseJson(value);</span>
&nbsp;
          // tryParseJson returns undefined if parsing failed.
<span class="cstat-no" title="statement not covered" >          if (parsed !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >            json[attr] = parsed;</span>
          }
        }
      }
    }
...
&nbsp;
&nbsp;
  Model.prototype.$formatDatabaseJson = <span class="fstat-no" title="function not covered" >function $formatDatabaseJson(json) {</span>
<span class="cstat-no" title="statement not covered" >    var jsonAttr = this.constructor.getJsonAttributes();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (jsonAttr.length) {</span>
...
<span class="cstat-no" title="statement not covered" >        var value = json[attr];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2.default.isObject(value)) {</span>
<span class="cstat-no" title="statement not covered" >          json[attr] = (0, _stringify2.default)(value);</span>
        }
      }
    }
&nbsp;
...
&nbsp;
&nbsp;
  Model.prototype.$parseJson = <span class="fstat-no" title="function not covered" >function $parseJson(json, options) {</span>
<span class="cstat-no" title="statement not covered" >    return json;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.prototype.$formatJson = <span class="fstat-no" title="function not covered" >function $formatJson(json) {</span>
<span class="cstat-no" title="statement not covered" >    return json;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.prototype.$setJson = <span class="fstat-no" title="function not covered" >function $setJson(json) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Object.prototype.toString.call(json) !== '[object Object]') {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('You should only pass objects to $setJson method. ' + '$setJson method was given an invalid value ' + json);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    json = this.$parseJson(json, options);</span>
<span class="cstat-no" title="statement not covered" >    json = this.$validate(json, options);</span>
<span class="cstat-no" title="statement not covered" >    this.$set(json);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var relations = this.constructor.getRelationArray();</span>
    // Parse relations into Model instances.
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = relations.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var relation = relations[i];</span>
<span class="cstat-no" title="statement not covered" >      var relationName = relation.name;</span>
<span class="cstat-no" title="statement not covered" >      var relationJson = json[relationName];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (relationJson !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >        if (Array.isArray(relationJson)) {</span>
<span class="cstat-no" title="statement not covered" >          this[relationName] = relation.relatedModelClass.ensureModelArray(relationJson, options);</span>
        } else <span class="cstat-no" title="statement not covered" >if (relationJson) {</span>
<span class="cstat-no" title="statement not covered" >          this[relationName] = relation.relatedModelClass.ensureModel(relationJson, options);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          this[relationName] = null;</span>
        }
      }
    }
  };
...
&nbsp;
&nbsp;
  Model.prototype.$setDatabaseJson = <span class="fstat-no" title="function not covered" >function $setDatabaseJson(json) {</span>
<span class="cstat-no" title="statement not covered" >    json = this.$parseDatabaseJson(json);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (json) {</span>
<span class="cstat-no" title="statement not covered" >      var keys = (0, _keys4.default)(json);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        this[key] = json[key];</span>
      }
    }
&nbsp;
...
&nbsp;
&nbsp;
  Model.prototype.$set = <span class="fstat-no" title="function not covered" >function $set(obj) {</span>
<span class="cstat-no" title="statement not covered" >    if (obj) {</span>
<span class="cstat-no" title="statement not covered" >      var keys = (0, _keys4.default)(obj);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = keys.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        var key = keys[i];</span>
<span class="cstat-no" title="statement not covered" >        var value = obj[key];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (key.charAt(0) !== '$' &amp;&amp; typeof value !== 'function') {</span>
...
&nbsp;
&nbsp;
  Model.prototype.$toJson = <span class="fstat-no" title="function not covered" >function $toJson(shallow) {</span>
<span class="cstat-no" title="statement not covered" >    if (shallow) {</span>
<span class="cstat-no" title="statement not covered" >      return this.$$toJson(false, this.constructor.getRelations(), null);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return this.$$toJson(false, null, null);</span>
    }
  };
&nbsp;
  Model.prototype.toJSON = <span class="fstat-no" title="function not covered" >function toJSON() {</span>
<span class="cstat-no" title="statement not covered" >    return this.$toJson(false);</span>
  };
&nbsp;
  /**
   * @override
...
&nbsp;
&nbsp;
  Model.prototype.$toDatabaseJson = <span class="fstat-no" title="function not covered" >function $toDatabaseJson() {</span>
<span class="cstat-no" title="statement not covered" >    var jsonSchema = this.constructor.getJsonSchema();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (jsonSchema &amp;&amp; this.constructor.pickJsonSchemaProperties) {</span>
<span class="cstat-no" title="statement not covered" >      return this.$$toJson(true, null, jsonSchema.properties);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return this.$$toJson(true, this.constructor.getRelations(), null);</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.prototype.$beforeInsert = <span class="fstat-no" title="function not covered" >function $beforeInsert(queryContext) {</span>};
&nbsp;
  /**
   * @param {Object} queryContext
   * @returns {Promise|*}
...
&nbsp;
&nbsp;
  Model.prototype.$afterInsert = <span class="fstat-no" title="function not covered" >function $afterInsert(queryContext) {</span>};
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.prototype.$beforeUpdate = <span class="fstat-no" title="function not covered" >function $beforeUpdate(opt, queryContext) {</span>};
&nbsp;
  /**
   * @param {ModelOptions} opt
   * @param {QueryBuilderContext} queryContext
...
&nbsp;
&nbsp;
  Model.prototype.$afterUpdate = <span class="fstat-no" title="function not covered" >function $afterUpdate(opt, queryContext) {</span>};
&nbsp;
  /**
   * @param {QueryBuilderContext} queryContext
   * @returns {Promise|*}
...
&nbsp;
&nbsp;
  Model.prototype.$afterGet = <span class="fstat-no" title="function not covered" >function $afterGet(queryContext) {</span>};
&nbsp;
  /**
   * @param {QueryBuilderContext} queryContext
   * @returns {Promise|*}
...
&nbsp;
&nbsp;
  Model.prototype.$beforeDelete = <span class="fstat-no" title="function not covered" >function $beforeDelete(queryContext) {</span>};
&nbsp;
  /**
   * @param {QueryBuilderContext} queryContext
   * @returns {Promise|*}
...
&nbsp;
&nbsp;
  Model.prototype.$afterDelete = <span class="fstat-no" title="function not covered" >function $afterDelete(queryContext) {</span>};
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.prototype.$traverse = <span class="fstat-no" title="function not covered" >function $traverse(filterConstructor, callback) {</span>
<span class="cstat-no" title="statement not covered" >    if (_lodash2.default.isUndefined(callback)) {</span>
<span class="cstat-no" title="statement not covered" >      callback = filterConstructor;</span>
<span class="cstat-no" title="statement not covered" >      filterConstructor = null;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.constructor.traverse(filterConstructor, this, callback);</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.prototype.$omit = <span class="fstat-no" title="function not covered" >function $omit() {</span>
<span class="cstat-no" title="statement not covered" >    if (arguments.length === 1 &amp;&amp; _lodash2.default.isObject(arguments[0])) {</span>
<span class="cstat-no" title="statement not covered" >      var keys = arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (Array.isArray(keys)) {</span>
<span class="cstat-no" title="statement not covered" >        omitArray(this, keys);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        omitObject(this, keys);</span>
      }
    } else {
<span class="cstat-no" title="statement not covered" >      var _keys = new Array(arguments.length);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = _keys.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        _keys[i] = arguments[i];</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      omitArray(this, _keys);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
...
&nbsp;
&nbsp;
  Model.prototype.$pick = <span class="fstat-no" title="function not covered" >function $pick() {</span>
<span class="cstat-no" title="statement not covered" >    if (arguments.length === 1 &amp;&amp; _lodash2.default.isObject(arguments[0])) {</span>
<span class="cstat-no" title="statement not covered" >      var keys = arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (Array.isArray(keys)) {</span>
<span class="cstat-no" title="statement not covered" >        pickArray(this, keys);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        pickObject(this, keys);</span>
      }
    } else {
<span class="cstat-no" title="statement not covered" >      var _keys2 = new Array(arguments.length);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = _keys2.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        _keys2[i] = arguments[i];</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      pickArray(this, _keys2);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
...
&nbsp;
&nbsp;
  Model.prototype.$values = <span class="fstat-no" title="function not covered" >function $values() {</span>
<span class="cstat-no" title="statement not covered" >    if (arguments.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >      return _lodash2.default.values(this);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      if (arguments.length === 1 &amp;&amp; Array.isArray(arguments[0])) {</span>
<span class="cstat-no" title="statement not covered" >        return this.$$values(arguments[0]);</span>
      } else {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return this.$$values(args);</span>
      }
    }
  };
&nbsp;
...
&nbsp;
&nbsp;
  Model.prototype.$$values = <span class="fstat-no" title="function not covered" >function $$values(args) {</span>
<span class="cstat-no" title="statement not covered" >    switch (args.length) {</span>
      case 1:
<span class="cstat-no" title="statement not covered" >        return [this[args[0]]];</span>
      case 2:
<span class="cstat-no" title="statement not covered" >        return [this[args[0]], this[args[1]]];</span>
      case 3:
<span class="cstat-no" title="statement not covered" >        return [this[args[0]], this[args[1]], this[args[2]]];</span>
      default:
        {
<span class="cstat-no" title="statement not covered" >          var ret = new Array(args.length);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (var i = 0, l = args.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >            ret[i] = this[args[i]];</span>
          }
&nbsp;
...
&nbsp;
&nbsp;
  Model.prototype.$propKey = <span class="fstat-no" title="function not covered" >function $propKey(props) {</span>
<span class="cstat-no" title="statement not covered" >    switch (props.length) {</span>
      case 1:
<span class="cstat-no" title="statement not covered" >        return this[props[0]] + '';</span>
      case 2:
<span class="cstat-no" title="statement not covered" >        return this[props[0]] + ',' + this[props[1]];</span>
      case 3:
<span class="cstat-no" title="statement not covered" >        return this[props[0]] + ',' + this[props[1]] + ',' + this[props[2]];</span>
      default:
        {
<span class="cstat-no" title="statement not covered" >          var key = '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (var i = 0, l = props.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >            key += this[props[i]] + (i &lt; props.length - 1 ? ',' : '');</span>
          }
&nbsp;
...
&nbsp;
&nbsp;
  Model.prototype.$clone = <span class="fstat-no" title="function not covered" >function $clone(shallow) {</span>
<span class="cstat-no" title="statement not covered" >    return cloneModel(this, shallow, false);</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.prototype.$omitFromJson = <span class="fstat-no" title="function not covered" >function $omitFromJson(keys) {</span>};
&nbsp;
  /**
   * @param {Array.&lt;string&gt;=} keys
   * @returns {Array.&lt;string&gt;}
...
&nbsp;
&nbsp;
  Model.prototype.$omitFromDatabaseJson = <span class="fstat-no" title="function not covered" >function $omitFromDatabaseJson(keys) {</span>};
&nbsp;
  /**
   * @returns {knex}
   */
&nbsp;
&nbsp;
  Model.prototype.$knex = <span class="fstat-no" title="function not covered" >function $knex() {</span>
<span class="cstat-no" title="statement not covered" >    return this.constructor.knex();</span>
  };
&nbsp;
  /**
   * @returns {knex}
...
&nbsp;
&nbsp;
  Model.prototype.$transaction = <span class="fstat-no" title="function not covered" >function $transaction() {</span>
<span class="cstat-no" title="statement not covered" >    return this.constructor.transaction();</span>
  };
&nbsp;
  /**
   * @protected
...
&nbsp;
&nbsp;
  Model.prototype.$$toJson = <span class="fstat-no" title="function not covered" >function $$toJson(createDbJson, omit, pick) {</span>
<span class="cstat-no" title="statement not covered" >    var json = toJsonImpl(this, createDbJson, omit, pick);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (createDbJson) {</span>
<span class="cstat-no" title="statement not covered" >      return this.$formatDatabaseJson(json);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return this.$formatJson(json);</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.extend = <span class="fstat-no" title="function not covered" >function extend(subclassConstructor) {</span>
<span class="cstat-no" title="statement not covered" >    if (_lodash2.default.isEmpty(subclassConstructor.name)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Each Model subclass constructor must have a name');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    (0, _classUtils.inherits)(subclassConstructor, this);</span>
<span class="cstat-no" title="statement not covered" >    return subclassConstructor;</span>
  };
&nbsp;
  /**
   * @param {Object=} json
...
&nbsp;
&nbsp;
  Model.fromJson = <span class="fstat-no" title="function not covered" >function fromJson(json, options) {</span>
<span class="cstat-no" title="statement not covered" >    var model = new this();</span>
<span class="cstat-no" title="statement not covered" >    model.$setJson(json || {}, options);</span>
...
&nbsp;
&nbsp;
  Model.fromDatabaseJson = <span class="fstat-no" title="function not covered" >function fromDatabaseJson(json) {</span>
<span class="cstat-no" title="statement not covered" >    var model = new this();</span>
<span class="cstat-no" title="statement not covered" >    model.$setDatabaseJson(json || {});</span>
<span class="cstat-no" title="statement not covered" >    return model;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.omitImpl = <span class="fstat-no" title="function not covered" >function omitImpl(obj, prop) {</span>
...
&nbsp;
&nbsp;
  Model.createValidator = <span class="fstat-no" title="function not covered" >function createValidator() {</span>
<span class="cstat-no" title="statement not covered" >    return new _AjvValidator2.default({</span>
      onCreateAjv: <span class="fstat-no" title="function not covered" >function onCreateAjv(ajv) {</span>/* Do Nothing by default */},
      options: {
        allErrors: true,
...
&nbsp;
&nbsp;
  Model.getValidator = <span class="fstat-no" title="function not covered" >function getValidator() {</span>
<span class="cstat-no" title="statement not covered" >    return this.createValidator();</span>
  };
&nbsp;
  /**
   * @return {Object}
...
&nbsp;
&nbsp;
  Model.getJsonSchema = <span class="fstat-no" title="function not covered" >function getJsonSchema() {</span>
    // Memoized getter in case jsonSchema is a getter property (usually is with ES6).
<span class="cstat-no" title="statement not covered" >    return this.jsonSchema;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.columnNameToPropertyName = <span class="fstat-no" title="function not covered" >function columnNameToPropertyName(columnName) {</span>
<span class="cstat-no" title="statement not covered" >    var model = new this();</span>
<span class="cstat-no" title="statement not covered" >    var addedProps = _lodash2.default.keys(model.$parseDatabaseJson({}));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var row = {};</span>
<span class="cstat-no" title="statement not covered" >    row[columnName] = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var props = _lodash2.default.keys(model.$parseDatabaseJson(row));</span>
<span class="cstat-no" title="statement not covered" >    var propertyName = _lodash2.default.first(_lodash2.default.difference(props, addedProps));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return propertyName || null;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.propertyNameToColumnName = <span class="fstat-no" title="function not covered" >function propertyNameToColumnName(propertyName) {</span>
<span class="cstat-no" title="statement not covered" >    var model = new this();</span>
<span class="cstat-no" title="statement not covered" >    var addedCols = _lodash2.default.keys(model.$formatDatabaseJson({}));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var obj = {};</span>
<span class="cstat-no" title="statement not covered" >    obj[propertyName] = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var cols = _lodash2.default.keys(model.$formatDatabaseJson(obj));</span>
<span class="cstat-no" title="statement not covered" >    var columnName = _lodash2.default.first(_lodash2.default.difference(cols, addedCols));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return columnName || null;</span>
  };
&nbsp;
  /**
   * @param {Transaction=} trx
...
&nbsp;
&nbsp;
  Model.query = <span class="fstat-no" title="function not covered" >function query(trx) {</span>
<span class="cstat-no" title="statement not covered" >    var ModelClass = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return ModelClass.QueryBuilder.forClass(ModelClass).transacting(trx).relateOperationFactory(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      throw new Error('`relate` makes no sense in this context');</span>
    }).unrelateOperationFactory(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('`unrelate` makes no sense in this context');</span>
    });
...
&nbsp;
&nbsp;
  Model.knex = <span class="fstat-no" title="function not covered" >function knex() {</span>
...
<span class="cstat-no" title="statement not covered" >      Object.defineProperty(this, '$$knex', {</span>
        enumerable: false,
        writable: true,
        value: arguments[0]
      });
    } else {
<span class="cstat-no" title="statement not covered" >      return this.$$knex;</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.transaction = <span class="fstat-no" title="function not covered" >function transaction() {</span>
<span class="cstat-no" title="statement not covered" >    return this.knex();</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.raw = <span class="fstat-no" title="function not covered" >function raw() {</span>
<span class="cstat-no" title="statement not covered" >    var knex = this.knex();</span>
<span class="cstat-no" title="statement not covered" >    return knex.raw.apply(knex, arguments);</span>
  };
&nbsp;
  /**
   * @return {Object}
...
&nbsp;
&nbsp;
  Model.fn = <span class="fstat-no" title="function not covered" >function fn() {</span>
<span class="cstat-no" title="statement not covered" >    var knex = this.knex();</span>
<span class="cstat-no" title="statement not covered" >    return knex.fn;</span>
  };
&nbsp;
  /**
   * @return {Formatter}
...
&nbsp;
&nbsp;
  Model.formatter = <span class="fstat-no" title="function not covered" >function formatter() {</span>
<span class="cstat-no" title="statement not covered" >    return this.knex().client.formatter();</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.knexQuery = <span class="fstat-no" title="function not covered" >function knexQuery() {</span>
<span class="cstat-no" title="statement not covered" >    return this.knex().table(this.tableName);</span>
  };
&nbsp;
  /**
   * @returns {string}
...
&nbsp;
&nbsp;
  Model.uniqueTag = <span class="fstat-no" title="function not covered" >function uniqueTag() {</span>
<span class="cstat-no" title="statement not covered" >    return this.tableName;</span>
  };
&nbsp;
  /**
   * @param {knex} knex
...
&nbsp;
&nbsp;
  Model.bindKnex = <span class="fstat-no" title="function not covered" >function bindKnex(knex) {</span>
<span class="cstat-no" title="statement not covered" >    var ModelClass = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!knex.$$objection) {</span>
<span class="cstat-no" title="statement not covered" >      Object.defineProperty(knex, '$$objection', {</span>
        enumerable: false,
        writable: false,
        value: {
...
<span class="cstat-no" title="statement not covered" >    if (knex.$$objection.boundModels[ModelClass.uniqueTag()]) {</span>
<span class="cstat-no" title="statement not covered" >      return knex.$$objection.boundModels[ModelClass.uniqueTag()];</span>
    }
&nbsp;
    // Create a new subclass of this class.
<span class="cstat-no" title="statement not covered" >    var BoundModelClass = (0, _inheritModel2.default)(ModelClass);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    (0, _hiddenData.inheritHiddenData)(ModelClass, BoundModelClass);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    BoundModelClass.knex(knex);</span>
<span class="cstat-no" title="statement not covered" >    knex.$$objection.boundModels[ModelClass.uniqueTag()] = BoundModelClass;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var boundRelations = (0, _create2.default)(null);</span>
<span class="cstat-no" title="statement not covered" >    var relations = ModelClass.getRelationArray();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = relations.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var relation = relations[i];</span>
<span class="cstat-no" title="statement not covered" >      boundRelations[relation.name] = relation.bindKnex(knex);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    BoundModelClass.relations = boundRelations;</span>
<span class="cstat-no" title="statement not covered" >    BoundModelClass.relationArray = _lodash2.default.values(boundRelations);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return BoundModelClass;</span>
  };
&nbsp;
  /**
   * @param {knex} trx
...
&nbsp;
&nbsp;
  Model.bindTransaction = <span class="fstat-no" title="function not covered" >function bindTransaction(trx) {</span>
<span class="cstat-no" title="statement not covered" >    return this.bindKnex(trx);</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.ensureModel = <span class="fstat-no" title="function not covered" >function ensureModel(model, options) {</span>
<span class="cstat-no" title="statement not covered" >    var ModelClass = this;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (model instanceof ModelClass) {</span>
<span class="cstat-no" title="statement not covered" >      return model;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return ModelClass.fromJson(model, options);</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.ensureModelArray = <span class="fstat-no" title="function not covered" >function ensureModelArray(input, options) {</span>
...
<span class="cstat-no" title="statement not covered" >      var models = new Array(input.length);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = input.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        models[i] = this.ensureModel(input[i], options);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return models;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return [this.ensureModel(input, options)];</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.getIdColumnArray = <span class="fstat-no" title="function not covered" >function getIdColumnArray() {</span>
<span class="cstat-no" title="statement not covered" >    if (Array.isArray(this.idColumn)) {</span>
<span class="cstat-no" title="statement not covered" >      return this.idColumn;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return [this.idColumn];</span>
    }
  };
...
&nbsp;
&nbsp;
  Model.getFullIdColumn = <span class="fstat-no" title="function not covered" >function getFullIdColumn() {</span>
<span class="cstat-no" title="statement not covered" >    var _this3 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Array.isArray(this.idColumn)) {</span>
<span class="cstat-no" title="statement not covered" >      return this.idColumn.map(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >        return _this3.tableName + '.' + col;</span>
      });
    } else {
<span class="cstat-no" title="statement not covered" >      return this.tableName + '.' + this.idColumn;</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.getIdPropertyArray = <span class="fstat-no" title="function not covered" >function getIdPropertyArray() {</span>
<span class="cstat-no" title="statement not covered" >    var _this4 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.getIdColumnArray().map(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >      return idColumnToIdProperty(_this4, col);</span>
    });
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.getIdProperty = <span class="fstat-no" title="function not covered" >function getIdProperty() {</span>
<span class="cstat-no" title="statement not covered" >    var _this5 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Array.isArray(this.idColumn)) {</span>
<span class="cstat-no" title="statement not covered" >      return this.idColumn.map(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >        return idColumnToIdProperty(_this5, col);</span>
      });
    } else {
<span class="cstat-no" title="statement not covered" >      return idColumnToIdProperty(this, this.idColumn);</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
   ...
   */
  Model.getRelations = <span class="fstat-no" title="function not covered" >function getRelations() {</span>
<span class="cstat-no" title="statement not covered" >    var _this6 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var relations = this.relations;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!relations) {</span>
<span class="cstat-no" title="statement not covered" >      relations = _lodash2.default.reduce(_lodash2.default.result(this, 'relationMappings'), <span class="fstat-no" title="function not covered" >function (relations, mapping, relationName) {</span></span>
<span class="cstat-no" title="statement not covered" >        relations[relationName] = new mapping.relation(relationName, _this6);</span>
<span class="cstat-no" title="statement not covered" >        relations[relationName].setMapping(mapping);</span>
<span class="cstat-no" title="statement not covered" >        return relations;</span>
      }, (0, _create2.default)(null));
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.relations = relations;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return relations;</span>
  };
...
&nbsp;
&nbsp;
  Model.getRelationArray = <span class="fstat-no" title="function not covered" >function getRelationArray() {</span>
<span class="cstat-no" title="statement not covered" >    var relationArray = this.relationArray;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!relationArray) {</span>
<span class="cstat-no" title="statement not covered" >      relationArray = _lodash2.default.values(this.getRelations());</span>
<span class="cstat-no" title="statement not covered" >      this.relationArray = relationArray;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return relationArray;</span>
  };
&nbsp;
  /**
   * @return {Relation}
...
&nbsp;
&nbsp;
  Model.getRelation = <span class="fstat-no" title="function not covered" >function getRelation(name) {</span>
<span class="cstat-no" title="statement not covered" >    var relation = this.getRelations()[name];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!relation) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('A model class (tableName = ' + this.tableName + ') doesn\'t have relation ' + name);</span>
    }
&nbsp;
...
&nbsp;
&nbsp;
  Model.loadRelated = <span class="fstat-no" title="function not covered" >function loadRelated($models, expression, filters) {</span>
<span class="cstat-no" title="statement not covered" >    return this.query().resolve(this.ensureModelArray($models)).findOptions({ dontCallAfterGet: true }).eager(expression, filters).runAfter(<span class="fstat-no" title="function not covered" >function (models) {</span></span>
<span class="cstat-no" title="statement not covered" >      return Array.isArray($models) ? models : models[0];</span>
    });
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Model.traverse = <span class="fstat-no" title="function not covered" >function traverse(filterConstructor, models, traverser) {</span>
<span class="cstat-no" title="statement not covered" >    filterConstructor = filterConstructor || null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (_lodash2.default.isUndefined(traverser)) {</span>
<span class="cstat-no" title="statement not covered" >      traverser = models;</span>
<span class="cstat-no" title="statement not covered" >      models = filterConstructor;</span>
<span class="cstat-no" title="statement not covered" >      filterConstructor = null;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!_lodash2.default.isFunction(traverser)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('traverser must be a function');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (_lodash2.default.isEmpty(models)) {</span>
<span class="cstat-no" title="statement not covered" >      return this;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var modelClass = Array.isArray(models) ? models[0].constructor : models.constructor;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    (0, _modelVisitor.visitModels)(models, modelClass, <span class="fstat-no" title="function not covered" >function (model, modelClass, parent, relation) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (!filterConstructor || model instanceof filterConstructor) {</span>
<span class="cstat-no" title="statement not covered" >        traverser(model, parent, relation &amp;&amp; relation.name);</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
...
&nbsp;
&nbsp;
  Model.getJsonAttributes = <span class="fstat-no" title="function not covered" >function getJsonAttributes() {</span>
...
<span class="cstat-no" title="statement not covered" >    if (!this.jsonAttributes &amp;&amp; this.getJsonSchema()) {</span>
<span class="cstat-no" title="statement not covered" >      this.jsonAttributes = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      _lodash2.default.forOwn(this.getJsonSchema().properties, <span class="fstat-no" title="function not covered" >function (prop, propName) {</span></span>
<span class="cstat-no" title="statement not covered" >        var types = _lodash2.default.compact(ensureArray(prop.type));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (types.length === 0 &amp;&amp; Array.isArray(prop.anyOf)) {</span>
<span class="cstat-no" title="statement not covered" >          types = _lodash2.default.flattenDeep(_lodash2.default.map(prop.anyOf, 'type'));</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (types.length === 0 &amp;&amp; Array.isArray(prop.oneOf)) {</span>
<span class="cstat-no" title="statement not covered" >          types = _lodash2.default.flattenDeep(_lodash2.default.map(prop.oneOf, 'type'));</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_lodash2.default.includes(types, 'object') || _lodash2.default.includes(types, 'array')) {</span>
<span class="cstat-no" title="statement not covered" >          _this7.jsonAttributes.push(propName);</span>
        }
      });
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!Array.isArray(this.jsonAttributes)) {</span>
<span class="cstat-no" title="statement not covered" >      this.jsonAttributes = [];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.jsonAttributes;</span>
  };
&nbsp;
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function setId(model, id) {</span>
<span class="cstat-no" title="statement not covered" >  var idProp = model.constructor.getIdProperty();</span>
<span class="cstat-no" title="statement not covered" >  var isArray = Array.isArray(idProp);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (id.length !== idProp.length) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('trying to set an invalid identifier for a model');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var i = 0; i &lt; id.length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        model[idProp[i]] = id[i];</span>
      }
    } else {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      model[idProp] = id[0];</span>
    }
  } else {
<span class="cstat-no" title="statement not covered" >    if (isArray) {</span>
<span class="cstat-no" title="statement not covered" >      if (idProp.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('trying to set an invalid identifier for a model');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      model[idProp[0]] = id;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      model[idProp] = id;</span>
    }
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getId(model) {</span>
<span class="cstat-no" title="statement not covered" >  var idProp = model.constructor.getIdProperty();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(idProp)) {</span>
<span class="cstat-no" title="statement not covered" >    return model.$values(idProp);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    return model[idProp];</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function tryParseJson(maybeJsonStr) {</span>
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    return JSON.parse(maybeJsonStr);</span>
  } catch (err) {
    // Ignore error.
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function toJsonImpl(model, createDbJson, omit, pick) {</span>
<span class="cstat-no" title="statement not covered" >  if (createDbJson) {</span>
<span class="cstat-no" title="statement not covered" >    return toDatabaseJsonImpl(model, omit, pick);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    return toExternalJsonImpl(model, omit, pick);</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function toDatabaseJsonImpl(model, omit, pick) {</span>
<span class="cstat-no" title="statement not covered" >  var json = {};</span>
<span class="cstat-no" title="statement not covered" >  var omitFromJson = model.$omitFromDatabaseJson();</span>
<span class="cstat-no" title="statement not covered" >  var keys = (0, _keys4.default)(model);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = keys.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var key = keys[i];</span>
<span class="cstat-no" title="statement not covered" >    assignJsonValue(json, key, model[key], omit, pick, omitFromJson, true);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return json;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function toExternalJsonImpl(model, omit, pick) {</span>
<span class="cstat-no" title="statement not covered" >  var json = {};</span>
<span class="cstat-no" title="statement not covered" >  var omitFromJson = model.$omitFromJson();</span>
<span class="cstat-no" title="statement not covered" >  var keys = (0, _keys4.default)(model);</span>
<span class="cstat-no" title="statement not covered" >  var vAttr = model.constructor.virtualAttributes;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = keys.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var key = keys[i];</span>
<span class="cstat-no" title="statement not covered" >    var value = model[key];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    assignJsonValue(json, key, value, omit, pick, omitFromJson, false);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (vAttr) {</span>
<span class="cstat-no" title="statement not covered" >    assignVirtualAttributes(json, model, vAttr, omit, pick, omitFromJson);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return json;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function assignVirtualAttributes(json, model, vAttr, omit, pick, omitFromJson) {</span>
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = vAttr.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var key = vAttr[i];</span>
<span class="cstat-no" title="statement not covered" >    var value = model[key];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof value === 'function') {</span>
<span class="cstat-no" title="statement not covered" >      value = value.call(model);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    assignJsonValue(json, key, value, omit, pick, omitFromJson, false);</span>
  }
...
&nbsp;
<span class="fstat-no" title="function not covered" >function assignJsonValue(json, key, value, omit, pick, omitFromJson, createDbJson) {</span>
<span class="cstat-no" title="statement not covered" >  var type = typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (key.charAt(0) !== '$' &amp;&amp; type !== 'function' &amp;&amp; type !== 'undefined' &amp;&amp; (!omit || !omit[key]) &amp;&amp; (!pick || pick[key]) &amp;&amp; (!omitFromJson || !contains(omitFromJson, key))) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (value !== null &amp;&amp; type === 'object') {</span>
<span class="cstat-no" title="statement not covered" >      json[key] = toJsonObject(value, createDbJson);</span>
    } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function toJsonObject(value, createDbJson) {</span>
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(value)) {</span>
<span class="cstat-no" title="statement not covered" >    return toJsonArray(value, createDbJson);</span>
  } else <span class="cstat-no" title="statement not covered" >if (value instanceof Model) {</span>
<span class="cstat-no" title="statement not covered" >    if (createDbJson) {</span>
<span class="cstat-no" title="statement not covered" >      return value.$toDatabaseJson();</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return value.$toJson();</span>
    }
  } else <span class="cstat-no" title="statement not covered" >if (Buffer.isBuffer(value)) {</span>
<span class="cstat-no" title="statement not covered" >    return value;</span>
  } else {
<span class="cstat-no" title="statement not covered" >    return _lodash2.default.cloneDeep(value);</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function toJsonArray(value, createDbJson) {</span>
<span class="cstat-no" title="statement not covered" >  var ret = new Array(value.length);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = ret.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    ret[i] = toJsonObject(value[i], createDbJson);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return ret;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function cloneModel(model, shallow, stripInternal) {</span>
<span class="cstat-no" title="statement not covered" >  var clone = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var omitFromJson = model.$omitFromJson();</span>
<span class="cstat-no" title="statement not covered" >  var omitFromDatabaseJson = model.$omitFromDatabaseJson();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!shallow &amp;&amp; !stripInternal) {</span>
<span class="cstat-no" title="statement not covered" >    clone = cloneModelSimple(model);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    clone = cloneModelWithOpt(model, shallow, stripInternal);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (omitFromJson) {</span>
<span class="cstat-no" title="statement not covered" >    clone.$omitFromJson(omitFromJson);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (omitFromDatabaseJson) {</span>
<span class="cstat-no" title="statement not covered" >    clone.$omitFromDatabaseJson(omitFromDatabaseJson);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return clone;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function cloneModelSimple(model) {</span>
<span class="cstat-no" title="statement not covered" >  var clone = new model.constructor();</span>
<span class="cstat-no" title="statement not covered" >  var keys = (0, _keys4.default)(model);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = keys.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var key = keys[i];</span>
<span class="cstat-no" title="statement not covered" >    var value = model[key];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (value !== null &amp;&amp; (typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value)) === 'object') {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function cloneModelWithOpt(model, shallow, stripInternal) {</span>
<span class="cstat-no" title="statement not covered" >  var clone = new model.constructor();</span>
<span class="cstat-no" title="statement not covered" >  var keys = (0, _keys4.default)(model);</span>
<span class="cstat-no" title="statement not covered" >  var relations = model.constructor.getRelations();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = keys.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var key = keys[i];</span>
<span class="cstat-no" title="statement not covered" >    var value = model[key];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (shallow &amp;&amp; relations[key]) {</span>
<span class="cstat-no" title="statement not covered" >      continue;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (stripInternal &amp;&amp; key.charAt(0) === '$') {</span>
<span class="cstat-no" title="statement not covered" >      continue;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (value !== null &amp;&amp; (typeof value === 'undefined' ? 'undefined' : (0, _typeof3.default)(value)) === 'object') {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function cloneObject(value) {</span>
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(value)) {</span>
<span class="cstat-no" title="statement not covered" >    return cloneArray(value);</span>
  } else <span class="cstat-no" title="statement not covered" >if (value instanceof Model) {</span>
<span class="cstat-no" title="statement not covered" >    return cloneModel(value, false, false);</span>
  } else <span class="cstat-no" title="statement not covered" >if (Buffer.isBuffer(value)) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function cloneArray(value) {</span>
<span class="cstat-no" title="statement not covered" >  var ret = new Array(value.length);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = ret.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    ret[i] = cloneObject(value[i]);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return ret;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function omitObject(model, keyObj) {</span>
<span class="cstat-no" title="statement not covered" >  var ModelClass = model.constructor;</span>
<span class="cstat-no" title="statement not covered" >  var keys = (0, _keys4.default)(keyObj);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = keys.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var key = keys[i];</span>
<span class="cstat-no" title="statement not covered" >    var value = keyObj[key];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (value &amp;&amp; key.charAt(0) !== '$' &amp;&amp; _lodash2.default.has(model, key)) {</span>
<span class="cstat-no" title="statement not covered" >      ModelClass.omitImpl(model, key);</span>
    }
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function omitArray(model, keys) {</span>
<span class="cstat-no" title="statement not covered" >  var ModelClass = model.constructor;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = keys.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var key = keys[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (key.charAt(0) !== '$' &amp;&amp; _lodash2.default.has(model, key)) {</span>
<span class="cstat-no" title="statement not covered" >      ModelClass.omitImpl(model, key);</span>
    }
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function pickObject(model, keyObj) {</span>
<span class="cstat-no" title="statement not covered" >  var ModelClass = model.constructor;</span>
<span class="cstat-no" title="statement not covered" >  var keys = (0, _keys4.default)(model);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = keys.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var key = keys[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (key.charAt(0) !== '$' &amp;&amp; !keyObj[key]) {</span>
<span class="cstat-no" title="statement not covered" >      ModelClass.omitImpl(model, key);</span>
    }
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function pickArray(model, pick) {</span>
<span class="cstat-no" title="statement not covered" >  var ModelClass = model.constructor;</span>
<span class="cstat-no" title="statement not covered" >  var keys = (0, _keys4.default)(model);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = keys.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var key = keys[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (key.charAt(0) !== '$' &amp;&amp; !contains(pick, key)) {</span>
<span class="cstat-no" title="statement not covered" >      ModelClass.omitImpl(model, key);</span>
    }
  }
}
...
&nbsp;
<span class="fstat-no" title="function not covered" >function ensureArray(obj) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function idColumnToIdProperty(ModelClass, idColumn) {</span>
<span class="cstat-no" title="statement not covered" >  var idProperty = ModelClass.columnNameToPropertyName(idColumn);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!idProperty) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error(ModelClass.tableName + '.$parseDatabaseJson probably changes the value of the id column `' + idColumn + '` which is a no-no.');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return idProperty;</span>
}
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Thu Apr 20 2017 17:07:19 GMT+0000 (UTC)</div>
</div>
</body>
</html>
