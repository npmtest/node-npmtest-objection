...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/model/inheritModel.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/model/inheritModel.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/model/</a> &#187; inheritModel.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>if (isClassKeywordSupported()) {
  createInheritor = createClassInheritor;
} else {
<span class="cstat-no" title="statement not covered" >  createInheritor = createFunctionInheritor;</span>
}
&nbsp;
exports.default = <span class="fstat-no" title="function not covered" >function (ModelClass) {</span>
<span class="cstat-no" title="statement not covered" >  var inherit = cache[ModelClass.name];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!inherit) {</span>
<span class="cstat-no" title="statement not covered" >    inherit = createInheritor(ModelClass.name);</span>
<span class="cstat-no" title="statement not covered" >    cache[ModelClass.name] = inherit;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return inherit(ModelClass);</span>
};
&nbsp;
<span class="fstat-no" title="function not covered" >function createFunctionInheritor(className) {</span>
<span class="cstat-no" title="statement not covered" >  return new Function('BaseClass', '\n    function ' + className + '() { \n      BaseClass.apply(this, arguments); \n    }\n    \n    BaseClass.extend(' + className + ');\n    return ' + className + ';\n  ');</span>
}
&nbsp;
