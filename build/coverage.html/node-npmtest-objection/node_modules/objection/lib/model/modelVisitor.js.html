...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/model/modelVisitor.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/model/modelVisitor.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/model/</a> &#187; modelVisitor.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function visitModels(models, modelClass, visitor) {</span>
<span class="cstat-no" title="statement not covered" >  doVisit(models, modelClass, null, null, visitor);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function doVisit(models, modelClass, parent, rel, visitor) {</span>
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(models)) {</span>
<span class="cstat-no" title="statement not covered" >    visitMany(models, modelClass, parent, rel, visitor);</span>
  } else <span class="cstat-no" title="statement not covered" >if (models) {</span>
<span class="cstat-no" title="statement not covered" >    visitOne(models, modelClass, parent, rel, visitor);</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function visitMany(models, modelClass, parent, rel, visitor) {</span>
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = models.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    visitOne(models[i], modelClass, parent, rel, visitor);</span>
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function visitOne(model, modelClass, parent, rel, visitor) {</span>
<span class="cstat-no" title="statement not covered" >  if (model) {</span>
<span class="cstat-no" title="statement not covered" >    visitor(model, modelClass, parent, rel);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    doVisit(model[relation.name], relation.relatedModelClass, model, relation, visitor);</span>
  }
}
