...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/QueryBuilder.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/QueryBuilder.js</span></h1>
    <h2>
        
        Statements: <span class="metric">35.81% <small>(193 / 539)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">8% <small>(12 / 150)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">6.72% <small>(8 / 119)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">35.69% <small>(192 / 538)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/</a> &#187; QueryBuilder.js</div>
</div>
<div class="body">
...
1490
1491
1492</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function QueryBuilder(modelClass) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, QueryBuilder);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = (0, _possibleConstructorReturn3.default)(this, _QueryBuilderBase.call(this, modelClass.knex(), _QueryBuilderContext2.default));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this._modelClass = modelClass;</span>
<span class="cstat-no" title="statement not covered" >    _this._explicitRejectValue = null;</span>
<span class="cstat-no" title="statement not covered" >    _this._explicitResolveValue = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this._eagerExpression = null;</span>
<span class="cstat-no" title="statement not covered" >    _this._eagerFilterExpressions = [];</span>
<span class="cstat-no" title="statement not covered" >    _this._allowedEagerExpression = null;</span>
<span class="cstat-no" title="statement not covered" >    _this._allowedInsertExpression = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this._findOperationOptions = {};</span>
<span class="cstat-no" title="statement not covered" >    _this._eagerOperationOptions = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this._findOperationFactory = findOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    _this._insertOperationFactory = insertOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    _this._updateOperationFactory = updateOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    _this._patchOperationFactory = patchOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    _this._relateOperationFactory = relateOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    _this._unrelateOperationFactory = unrelateOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    _this._deleteOperationFactory = deleteOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    _this._eagerOperationFactory = modelClass.defaultEagerAlgorithm;</span>
...
&nbsp;
&nbsp;
  QueryBuilder.forClass = <span class="fstat-no" title="function not covered" >function forClass(modelClass) {</span>
<span class="cstat-no" title="statement not covered" >    return new this(modelClass);</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.childQueryOf = <span class="fstat-no" title="function not covered" >function childQueryOf(query) {</span>
<span class="cstat-no" title="statement not covered" >    if (query) {</span>
<span class="cstat-no" title="statement not covered" >      this.internalContext(query.internalContext());</span>
    }
&nbsp;
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.reject = <span class="fstat-no" title="function not covered" >function reject(error) {</span>
<span class="cstat-no" title="statement not covered" >    this._explicitRejectValue = error;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.resolve = <span class="fstat-no" title="function not covered" >function resolve(value) {</span>
<span class="cstat-no" title="statement not covered" >    this._explicitResolveValue = value;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.isExecutable = <span class="fstat-no" title="function not covered" >function isExecutable() {</span>
<span class="cstat-no" title="statement not covered" >    var hasExecutor = !!this._queryExecutorOperation();</span>
<span class="cstat-no" title="statement not covered" >    return !this._explicitRejectValue &amp;&amp; !this._explicitResolveValue &amp;&amp; !hasExecutor;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.runBefore = <span class="fstat-no" title="function not covered" >function runBefore(_runBefore) {</span>};
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(_onBuild) {</span>};
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.runAfter = <span class="fstat-no" title="function not covered" >function runAfter(_runAfter) {</span>};
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.eagerAlgorithm = <span class="fstat-no" title="function not covered" >function eagerAlgorithm(algorithm, eagerOptions) {</span>
<span class="cstat-no" title="statement not covered" >    this.eagerOperationFactory(algorithm);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (eagerOptions) {</span>
<span class="cstat-no" title="statement not covered" >      this.eagerOptions(eagerOptions);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.eagerOperationFactory = <span class="fstat-no" title="function not covered" >function eagerOperationFactory(factory) {</span>
<span class="cstat-no" title="statement not covered" >    this._eagerOperationFactory = factory;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.findOperationFactory = <span class="fstat-no" title="function not covered" >function findOperationFactory(factory) {</span>
<span class="cstat-no" title="statement not covered" >    this._findOperationFactory = factory;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.insertOperationFactory = <span class="fstat-no" title="function not covered" >function insertOperationFactory(factory) {</span>
<span class="cstat-no" title="statement not covered" >    this._insertOperationFactory = factory;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.updateOperationFactory = <span class="fstat-no" title="function not covered" >function updateOperationFactory(factory) {</span>
<span class="cstat-no" title="statement not covered" >    this._updateOperationFactory = factory;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.patchOperationFactory = <span class="fstat-no" title="function not covered" >function patchOperationFactory(factory) {</span>
<span class="cstat-no" title="statement not covered" >    this._patchOperationFactory = factory;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.deleteOperationFactory = <span class="fstat-no" title="function not covered" >function deleteOperationFactory(factory) {</span>
<span class="cstat-no" title="statement not covered" >    this._deleteOperationFactory = factory;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.relateOperationFactory = <span class="fstat-no" title="function not covered" >function relateOperationFactory(factory) {</span>
<span class="cstat-no" title="statement not covered" >    this._relateOperationFactory = factory;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.unrelateOperationFactory = <span class="fstat-no" title="function not covered" >function unrelateOperationFactory(factory) {</span>
<span class="cstat-no" title="statement not covered" >    this._unrelateOperationFactory = factory;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.eager = <span class="fstat-no" title="function not covered" >function eager(exp, filters) {</span>
<span class="cstat-no" title="statement not covered" >    this._eagerExpression = exp || null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof this._eagerExpression === 'string') {</span>
<span class="cstat-no" title="statement not covered" >      this._eagerExpression = _RelationExpression2.default.parse(this._eagerExpression);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (filters) {</span>
<span class="cstat-no" title="statement not covered" >      this._eagerExpression.filters = filters;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    checkEager(this);</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.mergeEager = <span class="fstat-no" title="function not covered" >function mergeEager(exp, filters) {</span>
<span class="cstat-no" title="statement not covered" >    if (!this._eagerExpression) {</span>
<span class="cstat-no" title="statement not covered" >      return this.eager(exp, filters);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var expr = _RelationExpression2.default.parse(exp);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (filters) {</span>
<span class="cstat-no" title="statement not covered" >      expr.filters = filters;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._eagerExpression = this._eagerExpression.merge(expr);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    checkEager(this);</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.allowEager = <span class="fstat-no" title="function not covered" >function allowEager(exp) {</span>
<span class="cstat-no" title="statement not covered" >    this._allowedEagerExpression = exp || null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof this._allowedEagerExpression === 'string') {</span>
<span class="cstat-no" title="statement not covered" >      this._allowedEagerExpression = _RelationExpression2.default.parse(this._allowedEagerExpression);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    checkEager(this);</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.modifyEager = <span class="fstat-no" title="function not covered" >function modifyEager(path, modifier) {</span>
<span class="cstat-no" title="statement not covered" >    this._eagerFilterExpressions.push({</span>
      path: path,
      filter: modifier
    });
&nbsp;
...
&nbsp;
  QueryBuilder.prototype.filterEager = <span class="fstat-no" title="function not covered" >function filterEager() {</span>
<span class="cstat-no" title="statement not covered" >    return this.modifyEager.apply(this, arguments);</span>
  };
&nbsp;
  /**
   * @param {string|RelationExpression} exp
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.allowInsert = <span class="fstat-no" title="function not covered" >function allowInsert(exp) {</span>
<span class="cstat-no" title="statement not covered" >    this._allowedInsertExpression = exp || null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof this._allowedInsertExpression === 'string') {</span>
<span class="cstat-no" title="statement not covered" >      this._allowedInsertExpression = _RelationExpression2.default.parse(this._allowedInsertExpression);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.eagerOptions = <span class="fstat-no" title="function not covered" >function eagerOptions(opt) {</span>
<span class="cstat-no" title="statement not covered" >    this._eagerOperationOptions = (0, _assign2.default)({}, this._eagerOperationOptions, opt);</span>
<span class="cstat-no" title="statement not covered" >    var opIdx = this.indexOfOperation(_EagerOperation2.default);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (opIdx !== -1) {</span>
<span class="cstat-no" title="statement not covered" >      this._operations[opIdx] = this._operations[opIdx].clone({</span>
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.findOptions = <span class="fstat-no" title="function not covered" >function findOptions(opt) {</span>
<span class="cstat-no" title="statement not covered" >    this._findOperationOptions = (0, _assign2.default)({}, this._findOperationOptions, opt);</span>
<span class="cstat-no" title="statement not covered" >    var opIdx = this.indexOfOperation(_FindOperation2.default);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (opIdx !== -1) {</span>
<span class="cstat-no" title="statement not covered" >      this._operations[opIdx] = this._operations[opIdx].clone({</span>
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.modelClass = <span class="fstat-no" title="function not covered" >function modelClass() {</span>
<span class="cstat-no" title="statement not covered" >    return this._modelClass;</span>
  };
&nbsp;
  /**
   * @returns {boolean}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.isFindQuery = <span class="fstat-no" title="function not covered" >function isFindQuery() {</span>
<span class="cstat-no" title="statement not covered" >    return !this._operations.some(<span class="fstat-no" title="function not covered" >function (method) {</span></span>
<span class="cstat-no" title="statement not covered" >      return method.isWriteOperation;</span>
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.toString = <span class="fstat-no" title="function not covered" >function toString() {</span>
<span class="cstat-no" title="statement not covered" >    return this.build().toString();</span>
  };
&nbsp;
  /**
   * @returns {string}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.toSql = <span class="fstat-no" title="function not covered" >function toSql() {</span>
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.clone = <span class="fstat-no" title="function not covered" >function clone() {</span>
<span class="cstat-no" title="statement not covered" >    var builder = new this.constructor(this._modelClass);</span>
<span class="cstat-no" title="statement not covered" >    this.baseCloneInto(builder);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    builder._explicitRejectValue = this._explicitRejectValue;</span>
<span class="cstat-no" title="statement not covered" >    builder._explicitResolveValue = this._explicitResolveValue;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    builder._eagerExpression = this._eagerExpression;</span>
<span class="cstat-no" title="statement not covered" >    builder._eagerFilterExpressions = this._eagerFilterExpressions.slice();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    builder._allowedEagerExpression = this._allowedEagerExpression;</span>
<span class="cstat-no" title="statement not covered" >    builder._allowedInsertExpression = this._allowedInsertExpression;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    builder._findOperationOptions = this._findOperationOptions;</span>
<span class="cstat-no" title="statement not covered" >    builder._eagerOperationOptions = this._eagerOperationOptions;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    builder._findOperationFactory = this._findOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    builder._insertOperationFactory = this._insertOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    builder._updateOperationFactory = this._updateOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    builder._patchOperationFactory = this._patchOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    builder._relateOperationFactory = this._relateOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    builder._unrelateOperationFactory = this._unrelateOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    builder._deleteOperationFactory = this._deleteOperationFactory;</span>
<span class="cstat-no" title="statement not covered" >    builder._eagerOperationFactory = this._eagerOperationFactory;</span>
&nbsp;
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.clearEager = <span class="fstat-no" title="function not covered" >function clearEager() {</span>
<span class="cstat-no" title="statement not covered" >    this._eagerExpression = null;</span>
<span class="cstat-no" title="statement not covered" >    this._eagerFilterExpressions = [];</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.clearReject = <span class="fstat-no" title="function not covered" >function clearReject() {</span>
<span class="cstat-no" title="statement not covered" >    this._explicitRejectValue = null;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.clearResolve = <span class="fstat-no" title="function not covered" >function clearResolve() {</span>
<span class="cstat-no" title="statement not covered" >    this._explicitResolveValue = null;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.then = <span class="fstat-no" title="function not covered" >function then(successHandler, errorHandler) {</span>
<span class="cstat-no" title="statement not covered" >    var promise = this.execute();</span>
<span class="cstat-no" title="statement not covered" >    return promise.then.apply(promise, arguments);</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.map = <span class="fstat-no" title="function not covered" >function map(mapper) {</span>
<span class="cstat-no" title="statement not covered" >    var promise = this.execute();</span>
<span class="cstat-no" title="statement not covered" >    return promise.map.apply(promise, arguments);</span>
  };
&nbsp;
  /**
   * @param {function} errorHandler
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.catch = <span class="fstat-no" title="function not covered" >function _catch(errorHandler) {</span>
<span class="cstat-no" title="statement not covered" >    var promise = this.execute();</span>
<span class="cstat-no" title="statement not covered" >    return promise.catch.apply(promise, arguments);</span>
  };
&nbsp;
  /**
   * @param {*} returnValue
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.return = <span class="fstat-no" title="function not covered" >function _return(returnValue) {</span>
<span class="cstat-no" title="statement not covered" >    var promise = this.execute();</span>
<span class="cstat-no" title="statement not covered" >    return promise.return.apply(promise, arguments);</span>
  };
&nbsp;
  /**
   * @param {*} context
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.bind = <span class="fstat-no" title="function not covered" >function bind(context) {</span>
<span class="cstat-no" title="statement not covered" >    var promise = this.execute();</span>
<span class="cstat-no" title="statement not covered" >    return promise.bind.apply(promise, arguments);</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.asCallback = <span class="fstat-no" title="function not covered" >function asCallback(callback) {</span>
<span class="cstat-no" title="statement not covered" >    var promise = this.execute();</span>
<span class="cstat-no" title="statement not covered" >    return promise.asCallback.apply(promise, arguments);</span>
  };
&nbsp;
  /**
   * @param {function} callback
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.nodeify = <span class="fstat-no" title="function not covered" >function nodeify(callback) {</span>
<span class="cstat-no" title="statement not covered" >    var promise = this.execute();</span>
<span class="cstat-no" title="statement not covered" >    return promise.nodeify.apply(promise, arguments);</span>
  };
&nbsp;
  /**
   * @returns {Promise}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.resultSize = <span class="fstat-no" title="function not covered" >function resultSize() {</span>
...
<span class="cstat-no" title="statement not covered" >    var query = this.clone().clear(/orderBy|offset|limit/).build();</span>
<span class="cstat-no" title="statement not covered" >    var rawQuery = knex.raw(query).wrap('(', ') as temp');</span>
<span class="cstat-no" title="statement not covered" >    var countQuery = knex.count('* as count').from(rawQuery);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.internalOptions().debug) {</span>
<span class="cstat-no" title="statement not covered" >      countQuery.debug();</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return countQuery.then(<span class="fstat-no" title="function not covered" >function (result) {</span></span>
<span class="cstat-no" title="statement not covered" >      return result[0] ? result[0].count : 0;</span>
    });
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.build = <span class="fstat-no" title="function not covered" >function build() {</span>
    // Take a clone so that we don't modify this instance during build.
<span class="cstat-no" title="statement not covered" >    var builder = this.clone();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (builder.isFindQuery()) {</span>
...
<span class="cstat-no" title="statement not covered" >      builder._callFindOperation();</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (builder._eagerExpression) {</span>
<span class="cstat-no" title="statement not covered" >      builder._callEagerFetchOperation();</span>
    }
&nbsp;
    // We need to build the builder even if a query executor operation
    // has been called so that the onBuild hooks get called.
<span class="cstat-no" title="statement not covered" >    var knexBuilder = _build(builder);</span>
<span class="cstat-no" title="statement not covered" >    var queryExecutorOperation = builder._queryExecutorOperation();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (queryExecutorOperation) {</span>
      // If the query executor is set, we build the builder that it returns.
<span class="cstat-no" title="statement not covered" >      return queryExecutorOperation.queryExecutor(builder).build();</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return knexBuilder;</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.execute = <span class="fstat-no" title="function not covered" >function execute() {</span>
    // Take a clone so that we don't modify this instance during execution.
<span class="cstat-no" title="statement not covered" >    var builder = this.clone();</span>
<span class="cstat-no" title="statement not covered" >    var promiseCtx = { builder: builder };</span>
<span class="cstat-no" title="statement not covered" >    var promise = _bluebird2.default.bind(promiseCtx);</span>
<span class="cstat-no" title="statement not covered" >    var context = builder.context() || {};</span>
<span class="cstat-no" title="statement not covered" >    var internalContext = builder.internalContext();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (builder.isFindQuery()) {</span>
      // If no write operations have been called at this point this query is a
      // find query and we need to call the custom find implementation.
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    promise = chainBeforeOperations(promise, builder._operations);</span>
<span class="cstat-no" title="statement not covered" >    promise = chainHooks(promise, context.runBefore);</span>
<span class="cstat-no" title="statement not covered" >    promise = chainHooks(promise, internalContext.runBefore);</span>
<span class="cstat-no" title="statement not covered" >    promise = chainBeforeInternalOperations(promise, builder._operations);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var promiseCtx = this;</span>
<span class="cstat-no" title="statement not covered" >      var builder = promiseCtx.builder;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var promise = null;</span>
<span class="cstat-no" title="statement not covered" >      var knexBuilder = _build(builder);</span>
<span class="cstat-no" title="statement not covered" >      var queryExecutorOperation = builder._queryExecutorOperation();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (builder._explicitRejectValue) {</span>
<span class="cstat-no" title="statement not covered" >        promise = _bluebird2.default.reject(builder._explicitRejectValue).bind(promiseCtx);</span>
      } else <span class="cstat-no" title="statement not covered" >if (builder._explicitResolveValue) {</span>
<span class="cstat-no" title="statement not covered" >        promise = _bluebird2.default.resolve(builder._explicitResolveValue).bind(promiseCtx);</span>
      } else <span class="cstat-no" title="statement not covered" >if (queryExecutorOperation) {</span>
<span class="cstat-no" title="statement not covered" >        promise = queryExecutorOperation.queryExecutor(builder).bind(promiseCtx);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        promise = knexBuilder.bind(promiseCtx);</span>
<span class="cstat-no" title="statement not covered" >        promise = chainRawResultOperations(promise, builder._operations);</span>
<span class="cstat-no" title="statement not covered" >        promise = promise.then(createModels);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      promise = chainAfterQueryOperations(promise, builder._operations);</span>
<span class="cstat-no" title="statement not covered" >      promise = chainAfterInternalOperations(promise, builder._operations);</span>
<span class="cstat-no" title="statement not covered" >      promise = chainHooks(promise, context.runAfter);</span>
<span class="cstat-no" title="statement not covered" >      promise = chainHooks(promise, internalContext.runAfter);</span>
<span class="cstat-no" title="statement not covered" >      promise = chainAfterOperations(promise, builder._operations);</span>
&nbsp;
...
&nbsp;
&nbsp;
  QueryBuilder.prototype._queryExecutorOperation = <span class="fstat-no" title="function not covered" >function _queryExecutorOperation() {</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = this._operations.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var op = this._operations[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (op.hasQueryExecutor()) {</span>
...
&nbsp;
&nbsp;
  QueryBuilder.prototype._callFindOperation = <span class="fstat-no" title="function not covered" >function _callFindOperation() {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.has(_FindOperation2.default)) {</span>
<span class="cstat-no" title="statement not covered" >      var operation = this._findOperationFactory(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      operation.opt = (0, _assign2.default)(operation.opt, this._findOperationOptions);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.callQueryBuilderOperation(operation, [], /* pushFront = */true);</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype._callEagerFetchOperation = <span class="fstat-no" title="function not covered" >function _callEagerFetchOperation() {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.has(_EagerOperation2.default) &amp;&amp; this._eagerExpression) {</span>
<span class="cstat-no" title="statement not covered" >      var operation = this._eagerOperationFactory(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      operation.opt = (0, _assign2.default)(operation.opt, this._modelClass.defaultEagerOptions, this._eagerOperationOptions);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.callQueryBuilderOperation(operation, [this._eagerExpression, this._eagerFilterExpressions]);</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.pluck = <span class="fstat-no" title="function not covered" >function pluck(propertyName) {</span>
<span class="cstat-no" title="statement not covered" >    return this.runAfter(<span class="fstat-no" title="function not covered" >function (result) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (Array.isArray(result)) {</span>
<span class="cstat-no" title="statement not covered" >        return result.map(<span class="fstat-no" title="function not covered" >function (it) {</span></span>
<span class="cstat-no" title="statement not covered" >          return it &amp;&amp; it[propertyName];</span>
        });
      } else {
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.first = <span class="fstat-no" title="function not covered" >function first() {</span>
<span class="cstat-no" title="statement not covered" >    return this.runAfter(<span class="fstat-no" title="function not covered" >function (result) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (Array.isArray(result)) {</span>
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.hasSelection = <span class="fstat-no" title="function not covered" >function hasSelection(selection) {</span>
<span class="cstat-no" title="statement not covered" >    var explicit = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var table = this.modelClass().tableName;</span>
<span class="cstat-no" title="statement not covered" >    var noSelectStatements = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = this._operations.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var op = this._operations[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (op instanceof _SelectOperation2.default) {</span>
<span class="cstat-no" title="statement not covered" >        noSelectStatements = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (op.hasSelection(table, selection)) {</span>
<span class="cstat-no" title="statement not covered" >          return true;</span>
        }
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (noSelectStatements &amp;&amp; !explicit) {</span>
      // Implicit `select *`.
<span class="cstat-no" title="statement not covered" >      return true;</span>
    } else {
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.traverse = <span class="fstat-no" title="function not covered" >function traverse(modelClass, traverser) {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof traverser === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >      traverser = modelClass;</span>
<span class="cstat-no" title="statement not covered" >      modelClass = null;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.runAfter(<span class="fstat-no" title="function not covered" >function (result) {</span></span>
<span class="cstat-no" title="statement not covered" >      _this2._modelClass.traverse(modelClass, result, traverser);</span>
<span class="cstat-no" title="statement not covered" >      return result;</span>
    });
  };
&nbsp;
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.pick = <span class="fstat-no" title="function not covered" >function pick(modelClass, properties) {</span>
<span class="cstat-no" title="statement not covered" >    if (typeof properties === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >      properties = modelClass;</span>
<span class="cstat-no" title="statement not covered" >      modelClass = null;</span>
    }
&nbsp;
    // Turn the properties into a hash for performance.
<span class="cstat-no" title="statement not covered" >    properties = properties.reduce(<span class="fstat-no" title="function not covered" >function (obj, prop) {</span></span>
<span class="cstat-no" title="statement not covered" >      obj[prop] = true;</span>
<span class="cstat-no" title="statement not covered" >      return obj;</span>
    }, {});
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.traverse(modelClass, <span class="fstat-no" title="function not covered" >function (model) {</span></span>
<span class="cstat-no" title="statement not covered" >      model.$pick(properties);</span>
    });
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.omit = <span class="fstat-no" title="function not covered" >function omit(modelClass, properties) {</span>
<span class="cstat-no" title="statement not covered" >    if (typeof properties === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >      properties = modelClass;</span>
<span class="cstat-no" title="statement not covered" >      modelClass = null;</span>
    }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.traverse(modelClass, <span class="fstat-no" title="function not covered" >function (model) {</span></span>
<span class="cstat-no" title="statement not covered" >      model.$omit(properties);</span>
    });
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.page = <span class="fstat-no" title="function not covered" >function page(_page, pageSize) {</span>
<span class="cstat-no" title="statement not covered" >    return this.range(_page * pageSize, (_page + 1) * pageSize - 1);</span>
  };
&nbsp;
  /**
   * @param {number} start
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.range = <span class="fstat-no" title="function not covered" >function range(start, end) {</span>};
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.joinRelation = <span class="fstat-no" title="function not covered" >function joinRelation(relationName) {</span>};
&nbsp;
  /**
   * @param {string} relationName
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.innerJoinRelation = <span class="fstat-no" title="function not covered" >function innerJoinRelation(relationName) {</span>};
&nbsp;
  /**
   * @param {string} relationName
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.outerJoinRelation = <span class="fstat-no" title="function not covered" >function outerJoinRelation(relationName) {</span>};
&nbsp;
  /**
   * @param {string} relationName
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.leftJoinRelation = <span class="fstat-no" title="function not covered" >function leftJoinRelation(relationName) {</span>};
&nbsp;
  /**
   * @param {string} relationName
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.leftOuterJoinRelation = <span class="fstat-no" title="function not covered" >function leftOuterJoinRelation(relationName) {</span>};
&nbsp;
  /**
   * @param {string} relationName
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.rightJoinRelation = <span class="fstat-no" title="function not covered" >function rightJoinRelation(relationName) {</span>};
&nbsp;
  /**
   * @param {string} relationName
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.rightOuterJoinRelation = <span class="fstat-no" title="function not covered" >function rightOuterJoinRelation(relationName) {</span>};
&nbsp;
  /**
   * @param {string} relationName
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.fullOuterJoinRelation = <span class="fstat-no" title="function not covered" >function fullOuterJoinRelation(relationName) {</span>};
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.findById = <span class="fstat-no" title="function not covered" >function findById(id) {</span>
<span class="cstat-no" title="statement not covered" >    return this.whereComposite(this._modelClass.getFullIdColumn(), id).first();</span>
  };
&nbsp;
  /**
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.withSchema = <span class="fstat-no" title="function not covered" >function withSchema(schema) {</span>
<span class="cstat-no" title="statement not covered" >    this.internalContext().onBuild.push(<span class="fstat-no" title="function not covered" >function (builder) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (!builder.has(/withSchema/)) {</span>
        // Need to push this operation to the front because knex doesn't use the
        // schema for operations called before `withSchema`.
<span class="cstat-no" title="statement not covered" >        builder.callKnexQueryBuilderOperation('withSchema', [schema], true);</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.debug = <span class="fstat-no" title="function not covered" >function debug() {</span>
<span class="cstat-no" title="statement not covered" >    this.internalOptions().debug = true;</span>
<span class="cstat-no" title="statement not covered" >    this.internalContext().onBuild.push(<span class="fstat-no" title="function not covered" >function (builder) {</span></span>
<span class="cstat-no" title="statement not covered" >      builder.callKnexQueryBuilderOperation('debug', []);</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.insert = <span class="fstat-no" title="function not covered" >function insert(modelsOrObjects) {</span>
<span class="cstat-no" title="statement not covered" >    var insertOperation = this._insertOperationFactory(this);</span>
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(insertOperation, [modelsOrObjects]);</span>
  };
&nbsp;
  /**
   * @param {Object|Model|Array.&lt;Object&gt;|Array.&lt;Model&gt;} modelsOrObjects
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.insertAndFetch = <span class="fstat-no" title="function not covered" >function insertAndFetch(modelsOrObjects) {</span>
<span class="cstat-no" title="statement not covered" >    var insertAndFetchOperation = new _InsertAndFetchOperation2.default('insertAndFetch', {</span>
      delegate: this._insertOperationFactory(this)
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(insertAndFetchOperation, [modelsOrObjects]);</span>
  };
&nbsp;
  /**
   * @param {Object|Model|Array.&lt;Object&gt;|Array.&lt;Model&gt;} modelsOrObjects
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.insertGraph = <span class="fstat-no" title="function not covered" >function insertGraph(modelsOrObjects) {</span>
<span class="cstat-no" title="statement not covered" >    var insertGraphOperation = new _InsertGraphOperation2.default('insertGraph', {</span>
      delegate: this._insertOperationFactory(this)
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(insertGraphOperation, [modelsOrObjects]);</span>
  };
&nbsp;
  /**
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.insertWithRelated = <span class="fstat-no" title="function not covered" >function insertWithRelated() {</span>
<span class="cstat-no" title="statement not covered" >    return this.insertGraph.apply(this, arguments);</span>
  };
&nbsp;
  /**
   * @param {Object|Model|Array.&lt;Object&gt;|Array.&lt;Model&gt;} modelsOrObjects
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.insertGraphAndFetch = <span class="fstat-no" title="function not covered" >function insertGraphAndFetch(modelsOrObjects) {</span>
<span class="cstat-no" title="statement not covered" >    var insertGraphAndFetchOperation = new _InsertGraphAndFetchOperation2.default('insertGraphAndFetch', {</span>
      delegate: new _InsertGraphOperation2.default('insertGraph', {
        delegate: this._insertOperationFactory(this)
      })
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(insertGraphAndFetchOperation, [modelsOrObjects]);</span>
  };
&nbsp;
  /**
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.insertWithRelatedAndFetch = <span class="fstat-no" title="function not covered" >function insertWithRelatedAndFetch() {</span>
<span class="cstat-no" title="statement not covered" >    return this.insertGraphAndFetch.apply(this, arguments);</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.update = <span class="fstat-no" title="function not covered" >function update(modelOrObject) {</span>
<span class="cstat-no" title="statement not covered" >    var updateOperation = this._updateOperationFactory(this);</span>
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(updateOperation, [modelOrObject]);</span>
  };
&nbsp;
  /**
   * @param {Model|Object=} modelOrObject
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.updateAndFetch = <span class="fstat-no" title="function not covered" >function updateAndFetch(modelOrObject) {</span>
<span class="cstat-no" title="statement not covered" >    var delegateOperation = this._updateOperationFactory(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!(delegateOperation.instance instanceof this._modelClass)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('updateAndFetch can only be called for instance operations');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var updateAndFetch = new _UpdateAndFetchOperation2.default('updateAndFetch', {</span>
      delegate: delegateOperation
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(updateAndFetch, [delegateOperation.instance.$id(), modelOrObject]);</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.updateAndFetchById = <span class="fstat-no" title="function not covered" >function updateAndFetchById(id, modelOrObject) {</span>
<span class="cstat-no" title="statement not covered" >    var updateAndFetch = new _UpdateAndFetchOperation2.default('updateAndFetch', {</span>
      delegate: this._updateOperationFactory(this)
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(updateAndFetch, [id, modelOrObject]);</span>
  };
&nbsp;
  /**
   * @param {Model|Object=} modelOrObject
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.patch = <span class="fstat-no" title="function not covered" >function patch(modelOrObject) {</span>
<span class="cstat-no" title="statement not covered" >    var patchOperation = this._patchOperationFactory(this);</span>
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(patchOperation, [modelOrObject]);</span>
  };
&nbsp;
  /**
   * @param {Model|Object=} modelOrObject
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.patchAndFetch = <span class="fstat-no" title="function not covered" >function patchAndFetch(modelOrObject) {</span>
<span class="cstat-no" title="statement not covered" >    var delegateOperation = this._patchOperationFactory(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!(delegateOperation.instance instanceof this._modelClass)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('patchAndFetch can only be called for instance operations');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var patchAndFetch = new _UpdateAndFetchOperation2.default('patchAndFetch', {</span>
      delegate: delegateOperation
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(patchAndFetch, [delegateOperation.instance.$id(), modelOrObject]);</span>
  };
&nbsp;
  /**
   * @param {number|string|Array.&lt;number|string&gt;} id
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.patchAndFetchById = <span class="fstat-no" title="function not covered" >function patchAndFetchById(id, modelOrObject) {</span>
<span class="cstat-no" title="statement not covered" >    var patchAndFetch = new _UpdateAndFetchOperation2.default('patchAndFetch', {</span>
      delegate: this._patchOperationFactory(this)
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(patchAndFetch, [id, modelOrObject]);</span>
  };
&nbsp;
  /**
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.delete = <span class="fstat-no" title="function not covered" >function _delete() {</span>
<span class="cstat-no" title="statement not covered" >    var deleteOperation = this._deleteOperationFactory(this);</span>
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(deleteOperation, []);</span>
  };
&nbsp;
  /**
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.del = <span class="fstat-no" title="function not covered" >function del() {</span>
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.deleteById = <span class="fstat-no" title="function not covered" >function deleteById(id) {</span>
<span class="cstat-no" title="statement not covered" >    return this.delete().whereComposite(this._modelClass.getFullIdColumn(), id);</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.relate = <span class="fstat-no" title="function not covered" >function relate(ids) {</span>
<span class="cstat-no" title="statement not covered" >    var relateOperation = this._relateOperationFactory(this);</span>
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(relateOperation, [ids]);</span>
  };
&nbsp;
  /**
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.unrelate = <span class="fstat-no" title="function not covered" >function unrelate() {</span>
<span class="cstat-no" title="statement not covered" >    var unrelateOperation = this._unrelateOperationFactory(this);</span>
<span class="cstat-no" title="statement not covered" >    return this.callQueryBuilderOperation(unrelateOperation, []);</span>
  };
&nbsp;
  /**
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.increment = <span class="fstat-no" title="function not covered" >function increment(propertyName, howMuch) {</span>
<span class="cstat-no" title="statement not covered" >    var columnName = this.modelClass().propertyNameToColumnName(propertyName);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.patch((0, _defineProperty3.default)({}, columnName, this.knex().raw('?? + ?', [columnName, howMuch])));</span>
  };
&nbsp;
  /**
   * @returns {QueryBuilder}
...
&nbsp;
&nbsp;
  QueryBuilder.prototype.decrement = <span class="fstat-no" title="function not covered" >function decrement(propertyName, howMuch) {</span>
<span class="cstat-no" title="statement not covered" >    var columnName = this.modelClass().propertyNameToColumnName(propertyName);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.patch((0, _defineProperty3.default)({}, columnName, this.knex().raw('?? - ?', [columnName, howMuch])));</span>
  };
...
&nbsp;
  descriptor.value = <span class="fstat-no" title="function not covered" >function decorator$writeQueryOperation() {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.isFindQuery()) {</span>
<span class="cstat-no" title="statement not covered" >      return this.reject(new Error('Double call to a write method. ' + 'You can only call one of the write methods ' + '(insert, update, patch, delete, relate, unrelate, increment, decrement) ' + 'and only once per query builder.'));</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      func.apply(this, arguments);</span>
    } catch (err) {
<span class="cstat-no" title="statement not covered" >      this.reject(err);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
...
&nbsp;
<span class="fstat-no" title="function not covered" >function checkEager(builder) {</span>
<span class="cstat-no" title="statement not covered" >  if (builder._eagerExpression &amp;&amp; builder._allowedEagerExpression) {</span>
<span class="cstat-no" title="statement not covered" >    if (!builder._allowedEagerExpression.isSubExpression(builder._eagerExpression)) {</span>
<span class="cstat-no" title="statement not covered" >      builder.reject(new _ValidationError2.default({ eager: 'eager expression not allowed' }));</span>
    }
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function createModels(result) {</span>
<span class="cstat-no" title="statement not covered" >  var builder = this.builder;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (result === null || result === undefined) {</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(result)) {</span>
<span class="cstat-no" title="statement not covered" >    if (result.length &amp;&amp; (0, _typeof3.default)(result[0]) === 'object' &amp;&amp; !(result[0] instanceof builder._modelClass)) {</span>
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = result.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        result[i] = builder._modelClass.fromDatabaseJson(result[i]);</span>
      }
    }
  } else <span class="cstat-no" title="statement not covered" >if ((typeof result === 'undefined' ? 'undefined' : (0, _typeof3.default)(result)) === 'object' &amp;&amp; !(result instanceof builder._modelClass)) {</span>
<span class="cstat-no" title="statement not covered" >    result = builder._modelClass.fromDatabaseJson(result);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return result;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function _build(builder) {</span>
<span class="cstat-no" title="statement not covered" >  var context = builder.context() || {};</span>
<span class="cstat-no" title="statement not covered" >  var internalContext = builder.internalContext();</span>
<span class="cstat-no" title="statement not covered" >  var knexBuilder = builder.knex().queryBuilder();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  callOnBuildHooks(builder, context.onBuild);</span>
<span class="cstat-no" title="statement not covered" >  callOnBuildHooks(builder, internalContext.onBuild);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  knexBuilder = builder.buildInto(knexBuilder);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!builder.has(_QueryBuilderBase3.default.FromSelector)) {</span>
<span class="cstat-no" title="statement not covered" >    var table = builder.modelClass().tableName;</span>
&nbsp;
    // Set the table only if it hasn't been explicitly set yet.
<span class="cstat-no" title="statement not covered" >    knexBuilder.table(table);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!builder.has(_QueryBuilderBase3.default.SelectSelector)) {</span>
<span class="cstat-no" title="statement not covered" >      knexBuilder.select(table + '.*');</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return knexBuilder;</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function chainHooks(promise, func) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof func === 'function') {</span>
<span class="cstat-no" title="statement not covered" >    promise = promise.then(<span class="fstat-no" title="function not covered" >function (result) {</span></span>
<span class="cstat-no" title="statement not covered" >      return func.call(this.builder, result, this.builder);</span>
    });
  } else <span class="cstat-no" title="statement not covered" >if (Array.isArray(func)) {</span>
<span class="cstat-no" title="statement not covered" >    func.forEach(<span class="fstat-no" title="function not covered" >function (func) {</span></span>
<span class="cstat-no" title="statement not covered" >      promise = promise.then(<span class="fstat-no" title="function not covered" >function (result) {</span></span>
<span class="cstat-no" title="statement not covered" >        return func.call(this.builder, result, this.builder);</span>
      });
    });
...
&nbsp;
<span class="fstat-no" title="function not covered" >function callOnBuildHooks(builder, func) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof func === 'function') {</span>
<span class="cstat-no" title="statement not covered" >    func.call(builder, builder);</span>
  } else <span class="cstat-no" title="statement not covered" >if (Array.isArray(func)) {</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = func.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      func[i].call(builder, builder);</span>
    }
  }
}
&nbsp;
...
&nbsp;
  return <span class="fstat-no" title="function not covered" >function (promise, operations) {</span>
<span class="cstat-no" title="statement not covered" >    var _loop = <span class="fstat-no" title="function not covered" >function _loop(i, l) {</span></span>
<span class="cstat-no" title="statement not covered" >      var op = operations[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (op[hasMethod]()) {</span>
<span class="cstat-no" title="statement not covered" >        promise = promise.then(<span class="fstat-no" title="function not covered" >function (result) {</span></span>
<span class="cstat-no" title="statement not covered" >          return op[hook](this.builder, result);</span>
        });
      }
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = operations.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      _loop(i, l);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return promise;</span>
  };
...
<span class="cstat-no" title="statement not covered" >    return new OperationClass(name, options);</span>
  };
}
&nbsp;
