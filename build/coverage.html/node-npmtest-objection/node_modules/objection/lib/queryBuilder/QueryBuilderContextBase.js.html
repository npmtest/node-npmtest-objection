...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/QueryBuilderContextBase.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/QueryBuilderContextBase.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/</a> &#187; QueryBuilderContextBase.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function QueryBuilderContextBase(userContext) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, QueryBuilderContextBase);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.userContext = userContext;</span>
<span class="cstat-no" title="statement not covered" >    this.options = new InternalOptions();</span>
<span class="cstat-no" title="statement not covered" >    this.knex = null;</span>
  }
&nbsp;
  QueryBuilderContextBase.prototype.clone = <span class="fstat-no" title="function not covered" >function clone() {</span>
<span class="cstat-no" title="statement not covered" >    var ctx = new this.constructor(this.userContext);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    ctx.options = this.options.clone();</span>
<span class="cstat-no" title="statement not covered" >    ctx.knex = this.knex;</span>
&nbsp;
...
<span class="fstat-no" title="function not covered" >  function InternalOptions() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, InternalOptions);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.skipUndefined = false;</span>
<span class="cstat-no" title="statement not covered" >    this.queryProps = null;</span>
<span class="cstat-no" title="statement not covered" >    this.debug = false;</span>
  }
&nbsp;
  InternalOptions.prototype.clone = <span class="fstat-no" title="function not covered" >function clone() {</span>
<span class="cstat-no" title="statement not covered" >    var copy = new InternalOptions();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    copy.skipUndefined = this.skipUndefined;</span>
<span class="cstat-no" title="statement not covered" >    copy.queryProps = this.queryProps;</span>
<span class="cstat-no" title="statement not covered" >    copy.debug = this.debug;</span>
&nbsp;
