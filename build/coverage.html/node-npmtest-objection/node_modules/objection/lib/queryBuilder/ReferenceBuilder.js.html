...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/ReferenceBuilder.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/ReferenceBuilder.js</span></h1>
    <h2>
        
        Statements: <span class="metric">45.45% <small>(25 / 55)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/</a> &#187; ReferenceBuilder.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function ReferenceBuilder(fieldExpression) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, ReferenceBuilder);</span>
&nbsp;
    // for premature optimization _reference could be lazy memoized getter... 
<span class="cstat-no" title="statement not covered" >    this._reference = _jsonFieldExpressionParser2.default.parse(fieldExpression);</span>
<span class="cstat-no" title="statement not covered" >    this._cast = null;</span>
<span class="cstat-no" title="statement not covered" >    this._toJson = false;</span>
<span class="cstat-no" title="statement not covered" >    this._as = null; </span>// TODO: UNIT TEST
  }
&nbsp;
  ReferenceBuilder.prototype.castText = <span class="fstat-no" title="function not covered" >function castText() {</span>
<span class="cstat-no" title="statement not covered" >    return this.castType('text');</span>
  };
&nbsp;
  ReferenceBuilder.prototype.castInt = <span class="fstat-no" title="function not covered" >function castInt() {</span>
<span class="cstat-no" title="statement not covered" >    return this.castType('integer');</span>
  };
&nbsp;
  ReferenceBuilder.prototype.castBigInt = <span class="fstat-no" title="function not covered" >function castBigInt() {</span>
<span class="cstat-no" title="statement not covered" >    return this.castType('bigint');</span>
  };
&nbsp;
  ReferenceBuilder.prototype.castFloat = <span class="fstat-no" title="function not covered" >function castFloat() {</span>
<span class="cstat-no" title="statement not covered" >    return this.castType('float');</span>
  };
&nbsp;
  ReferenceBuilder.prototype.castDecimal = <span class="fstat-no" title="function not covered" >function castDecimal() {</span>
<span class="cstat-no" title="statement not covered" >    return this.castType('decimal');</span>
  };
&nbsp;
  ReferenceBuilder.prototype.castReal = <span class="fstat-no" title="function not covered" >function castReal() {</span>
<span class="cstat-no" title="statement not covered" >    return this.castType('real');</span>
  };
&nbsp;
  ReferenceBuilder.prototype.castBool = <span class="fstat-no" title="function not covered" >function castBool() {</span>
<span class="cstat-no" title="statement not covered" >    return this.castType('boolean');</span>
  };
&nbsp;
  ReferenceBuilder.prototype.castJson = <span class="fstat-no" title="function not covered" >function castJson() {</span>
    // maybe different for mysql, no need to support postgres plain json
<span class="cstat-no" title="statement not covered" >    this._toJson = true;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  ReferenceBuilder.prototype.castType = <span class="fstat-no" title="function not covered" >function castType(sqlType) {</span>
    // we could maybe check some valid values here... at least fail on invalid chars 
<span class="cstat-no" title="statement not covered" >    this._cast = sqlType;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  ReferenceBuilder.prototype.as = <span class="fstat-no" title="function not covered" >function as(_as) {</span>
<span class="cstat-no" title="statement not covered" >    this._as = _as;</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  };
&nbsp;
  ReferenceBuilder.prototype.toRawArgs = <span class="fstat-no" title="function not covered" >function toRawArgs() {</span>
<span class="cstat-no" title="statement not covered" >    var referenceSql = '??';</span>
&nbsp;
    // if json field ref
<span class="cstat-no" title="statement not covered" >    if (this._reference.access.length &gt; 0) {</span>
      // TODO: for mysql this needs separate implementation... maybe something like SELECT JSON_EXTRACT('{"id": 14, "name": "Aztalan"}', '$.name');
<span class="cstat-no" title="statement not covered" >      var extractor = this._cast ? '#&gt;&gt;' : '#&gt;';</span>
<span class="cstat-no" title="statement not covered" >      var jsonFieldRef = this._reference.access.map(<span class="fstat-no" title="function not covered" >function (field) {</span></span>
<span class="cstat-no" title="statement not covered" >        return field.ref;</span>
      }).join(',');
<span class="cstat-no" title="statement not covered" >      referenceSql = '??' + extractor + '\'{' + jsonFieldRef + '}\'';</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var castedRefQuery = this._cast ? 'CAST(' + referenceSql + ' AS ' + this._cast + ')' : referenceSql;</span>
<span class="cstat-no" title="statement not covered" >    var toJsonQuery = this._toJson ? 'to_jsonb(' + castedRefQuery + ')' : castedRefQuery;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this._as) {</span>
<span class="cstat-no" title="statement not covered" >      return [toJsonQuery + ' AS ??', [this._reference.columnName, this._as]];</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return [toJsonQuery, [this._reference.columnName]];</span>
    }
  };
&nbsp;
...
&nbsp;
&nbsp;
var ref = <span class="fstat-no" title="function not covered" >function ref(fieldExpression) {</span>
<span class="cstat-no" title="statement not covered" >  return new ReferenceBuilder(fieldExpression);</span>
};
&nbsp;
exports.ref = ref;
