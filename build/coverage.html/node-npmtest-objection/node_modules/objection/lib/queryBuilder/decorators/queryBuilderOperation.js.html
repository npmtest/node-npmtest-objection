...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/decorators/queryBuilderOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/decorators/queryBuilderOperation.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">61.76% <small>(21 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/decorators/</a> &#187; queryBuilderOperation.js</div>
</div>
<div class="body">
...
&nbsp;
  return function (target, property, descriptor) {
    ...
    if (_lodash2.default.isFunction(input) || _lodash2.default.isArray(input)) {
      descriptor.value = <span class="fstat-no" title="function not covered" >function decorator$queryBuilderOperation() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        var methodDesc = normalizedInput.default;</span>
<span class="cstat-no" title="statement not covered" >        var method = new methodDesc.operationClass(operationName, methodDesc.opt);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return this.callQueryBuilderOperation(method, args);</span>
      };
    } else {
      descriptor.value = <span class="fstat-no" title="function not covered" >function decorator$queryBuilderOperationWithDialect() {</span>
<span class="cstat-no" title="statement not covered" >        var args = new Array(arguments.length);</span>
&nbsp;
        // Don't turn this into a function. This needs to be inline for V8 to optimize this.
<span class="cstat-no" title="statement not covered" >        for (var i = 0, l = arguments.length; i &lt; l; ++i) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        var dialect = (0, _knexUtils.getDialect)(this.knex());</span>
<span class="cstat-no" title="statement not covered" >        var methodDesc = normalizedInput[dialect] || normalizedInput.default;</span>
<span class="cstat-no" title="statement not covered" >        var method = new methodDesc.operationClass(operationName, methodDesc.opt);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return this.callQueryBuilderOperation(method, args);</span>
      };
