...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/GraphInserter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/GraphInserter.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">22.3% <small>(31 / 139)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/</a> &#187; GraphInserter.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function GraphInserter(_ref) {</span>
<span class="cstat-no" title="statement not covered" >    var modelClass = _ref.modelClass,</span>
        ...
        knex = _ref.knex;
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, GraphInserter);</span>
&nbsp;
    /**
     * @type {Constructor.&lt;Model&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this.modelClass = modelClass;</span>
&nbsp;
    /**
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.allowedRelations = allowedRelations || null;</span>
&nbsp;
    /**
     * @type {boolean}
     */
...
&nbsp;
     ...
     */
<span class="cstat-no" title="statement not covered" >    this.graph = this._buildDependencyGraph();</span>
&nbsp;
    /**
     * @type {knex}
     */
<span class="cstat-no" title="statement not covered" >    this.knex = knex;</span>
  }
&nbsp;
  /**
...
&nbsp;
&nbsp;
  GraphInserter.prototype.execute = <span class="fstat-no" title="function not covered" >function execute(inserter) {</span>
<span class="cstat-no" title="statement not covered" >    return this._executeNextBatch(inserter);</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  GraphInserter.prototype._buildDependencyGraph = <span class="fstat-no" title="function not covered" >function _buildDependencyGraph() {</span>
<span class="cstat-no" title="statement not covered" >    var graph = new _DependencyGraph2.default(this.allowedRelations);</span>
<span class="cstat-no" title="statement not covered" >    graph.build(this.modelClass, this.models);</span>
...
&nbsp;
&nbsp;
  GraphInserter.prototype._executeNextBatch = <span class="fstat-no" title="function not covered" >function _executeNextBatch(inserter) {</span>
<span class="cstat-no" title="statement not covered" >    var _this = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var batch = this._nextBatch();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!batch) {</span>
...
<span class="cstat-no" title="statement not covered" >    return _bluebird2.default.all((0, _keys2.default)(batch).map(<span class="fstat-no" title="function not covered" >function (tableName) {</span></span>
<span class="cstat-no" title="statement not covered" >      var tableInsertion = batch[tableName];</span>
<span class="cstat-no" title="statement not covered" >      var uids = void 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!tableInsertion.isJoinTableInsertion) {</span>
...
<span class="cstat-no" title="statement not covered" >        uids = _this._omitUids(tableInsertion);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return inserter(tableInsertion).then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        if (!tableInsertion.isJoinTableInsertion) {</span>
          // Resolve dependencies to the inserted objects. Join table insertions
          // never resolve any dependencies.
<span class="cstat-no" title="statement not covered" >          _this._resolveDepsForInsertion(tableInsertion, uids);</span>
        }
      });
    })).then(<span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      return _this._executeNextBatch(inserter);</span>
    });
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  GraphInserter.prototype._nextBatch = <span class="fstat-no" title="function not covered" >function _nextBatch() {</span>
<span class="cstat-no" title="statement not covered" >    if (this.done) {</span>
<span class="cstat-no" title="statement not covered" >      return null;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var batch = this._createBatch();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (_lodash2.default.isEmpty(batch)) {</span>
<span class="cstat-no" title="statement not covered" >      this.done = true;</span>
<span class="cstat-no" title="statement not covered" >      return this._createManyToManyRelationJoinRowBatch();</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this._markBatchHandled(batch);</span>
...
&nbsp;
&nbsp;
  GraphInserter.prototype._createBatch = <span class="fstat-no" title="function not covered" >function _createBatch() {</span>
<span class="cstat-no" title="statement not covered" >    var batch = (0, _create2.default)(null);</span>
<span class="cstat-no" title="statement not covered" >    var nodes = this.graph.nodes;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!node.handled &amp;&amp; node.needs.length === node.numHandledNeeds) {</span>
<span class="cstat-no" title="statement not covered" >        var tableInsertion = batch[node.modelClass.tableName];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!tableInsertion) {</span>
<span class="cstat-no" title="statement not covered" >          tableInsertion = new _TableInsertion2.default(node.modelClass, false);</span>
<span class="cstat-no" title="statement not covered" >          batch[node.modelClass.tableName] = tableInsertion;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        tableInsertion.models.push(node.model);</span>
<span class="cstat-no" title="statement not covered" >        tableInsertion.isInputModel.push(!!this.graph.inputNodesById[node.id]);</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return batch;</span>
...
&nbsp;
&nbsp;
  GraphInserter.prototype._markBatchHandled = <span class="fstat-no" title="function not covered" >function _markBatchHandled(batch) {</span>
<span class="cstat-no" title="statement not covered" >    var models = _lodash2.default.flatten(_lodash2.default.map(batch, 'models'));</span>
<span class="cstat-no" title="statement not covered" >    var nodes = this.graph.nodesById;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var m = 0, lm = models.length; m &lt; lm; ++m) {</span>
<span class="cstat-no" title="statement not covered" >      var id = models[m][models[m].constructor.uidProp];</span>
<span class="cstat-no" title="statement not covered" >      var node = nodes[id];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var nb = 0, lnb = node.isNeededBy.length; nb &lt; lnb; ++nb) {</span>
<span class="cstat-no" title="statement not covered" >        var dep = node.isNeededBy[nb];</span>
<span class="cstat-no" title="statement not covered" >        dep.node.numHandledNeeds++;</span>
      }
&nbsp;
...
&nbsp;
&nbsp;
  GraphInserter.prototype._createManyToManyRelationJoinRowBatch = <span class="fstat-no" title="function not covered" >function _createManyToManyRelationJoinRowBatch() {</span>
<span class="cstat-no" title="statement not covered" >    var batch = (0, _create2.default)(null);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var n = 0, ln = this.graph.nodes.length; n &lt; ln; ++n) {</span>
<span class="cstat-no" title="statement not covered" >      var node = this.graph.nodes[n];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        var tableInsertion = batch[conn.relation.joinTable];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var ownerProp = node.model.$values(conn.relation.ownerProp);</span>
<span class="cstat-no" title="statement not covered" >        var modelClass = conn.relation.joinTableModelClass(this.knex);</span>
<span class="cstat-no" title="statement not covered" >        var joinModel = conn.relation.createJoinModels(ownerProp, [conn.node.model])[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (conn.refNode) {</span>
          // Also take extra properties from the referring model, it there was one.
<span class="cstat-no" title="statement not covered" >          for (var k = 0, lk = conn.relation.joinTableExtras.length; k &lt; lk; ++k) {</span>
<span class="cstat-no" title="statement not covered" >            var extra = conn.relation.joinTableExtras[k];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!_lodash2.default.isUndefined(conn.refNode.model[extra.aliasProp])) {</span>
<span class="cstat-no" title="statement not covered" >              joinModel[extra.joinTableProp] = conn.refNode.model[extra.aliasProp];</span>
            }
          }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        joinModel = modelClass.fromJson(joinModel);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!tableInsertion) {</span>
<span class="cstat-no" title="statement not covered" >          tableInsertion = new _TableInsertion2.default(modelClass, true);</span>
<span class="cstat-no" title="statement not covered" >          batch[modelClass.tableName] = tableInsertion;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        tableInsertion.models.push(joinModel);</span>
<span class="cstat-no" title="statement not covered" >        tableInsertion.isInputModel.push(false);</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var modelNames = (0, _keys2.default)(batch);</span>
    // Remove duplicates.
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = modelNames.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var modelName = modelNames[i];</span>
<span class="cstat-no" title="statement not covered" >      var _tableInsertion = batch[modelName];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (_tableInsertion.models.length) {</span>
<span class="cstat-no" title="statement not covered" >        (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >          var keys = _lodash2.default.uniq(_lodash2.default.flatMap(_tableInsertion.models, _lodash2.default.keys));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          _tableInsertion.models = _lodash2.default.uniqBy(_tableInsertion.models, <span class="fstat-no" title="function not covered" >function (model) {</span></span>
<span class="cstat-no" title="statement not covered" >            return model.$propKey(keys);</span>
          });
<span class="cstat-no" title="statement not covered" >          _tableInsertion.isInputModel = _lodash2.default.times(_tableInsertion.models.length, _lodash2.default.constant(false));</span>
        })();
      }
    }
&nbsp;
...
&nbsp;
&nbsp;
  GraphInserter.prototype._omitUids = <span class="fstat-no" title="function not covered" >function _omitUids(tableInsertion) {</span>
<span class="cstat-no" title="statement not covered" >    var ids = _lodash2.default.map(tableInsertion.models, tableInsertion.modelClass.uidProp);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var m = 0, lm = tableInsertion.models.length; m &lt; lm; ++m) {</span>
<span class="cstat-no" title="statement not covered" >      tableInsertion.models[m].$omit(tableInsertion.modelClass.uidProp);</span>
    }
&nbsp;
...
&nbsp;
&nbsp;
  GraphInserter.prototype._resolveDepsForInsertion = <span class="fstat-no" title="function not covered" >function _resolveDepsForInsertion(tableInsertion, uids) {</span>
<span class="cstat-no" title="statement not covered" >    for (var m = 0, lm = tableInsertion.models.length; m &lt; lm; ++m) {</span>
<span class="cstat-no" title="statement not covered" >      var node = this.graph.nodesById[uids[m]];</span>
<span class="cstat-no" title="statement not covered" >      var model = tableInsertion.models[m];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var d = 0, ld = node.isNeededBy.length; d &lt; ld; ++d) {</span>
<span class="cstat-no" title="statement not covered" >        node.isNeededBy[d].resolve(model);</span>
      }
    }
  };
&nbsp;
...
&nbsp;
&nbsp;
  GraphInserter.prototype._finalize = <span class="fstat-no" title="function not covered" >function _finalize() {</span>
<span class="cstat-no" title="statement not covered" >    for (var n = 0, ln = this.graph.nodes.length; n &lt; ln; ++n) {</span>
<span class="cstat-no" title="statement not covered" >      var refNode = this.graph.nodes[n];</span>
...
<span class="cstat-no" title="statement not covered" >        var actualNode = this.graph.nodesById[ref];</span>
<span class="cstat-no" title="statement not covered" >        var relations = actualNode.modelClass.getRelations();</span>
<span class="cstat-no" title="statement not covered" >        var keys = (0, _keys2.default)(actualNode.model);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          var value = actualNode.model[key];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!relations[key] &amp;&amp; !_lodash2.default.isFunction(value)) {</span>
<span class="cstat-no" title="statement not covered" >            refNode.model[key] = value;</span>
          }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        refNode.model.$omit(refNode.modelClass.uidProp, refNode.modelClass.uidRefProp);</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _bluebird2.default.resolve(this.models);</span>
  };
&nbsp;
