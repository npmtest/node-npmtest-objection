...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/InterpolateValueDependency.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/InterpolateValueDependency.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/</a> &#187; InterpolateValueDependency.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function InterpolateValueDependency(node, path, refProp, match, inverse) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, InterpolateValueDependency);</span>
&nbsp;
    /**
     * @type {Array.&lt;string&gt;}
     */
<span class="cstat-no" title="statement not covered" >    var _this = (0, _possibleConstructorReturn3.default)(this, _Dependency.call(this, node));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.path = path.slice();</span>
&nbsp;
    /**
     * @type {string}
     */
<span class="cstat-no" title="statement not covered" >    _this.refProp = refProp;</span>
&nbsp;
    /**
     * @type {string}
     */
<span class="cstat-no" title="statement not covered" >    _this.match = match;</span>
&nbsp;
    /**
     * @type boolean
     */
<span class="cstat-no" title="statement not covered" >    _this.inverse = inverse;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  InterpolateValueDependency.prototype.resolve = <span class="fstat-no" title="function not covered" >function resolve(model) {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.inverse) {</span>
<span class="cstat-no" title="statement not covered" >      var value = _lodash2.default.get(model, this.path);</span>
<span class="cstat-no" title="statement not covered" >      value = value.replace(this.match, this.node.model[this.refProp]);</span>
<span class="cstat-no" title="statement not covered" >      _lodash2.default.set(model, this.path, value);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      var _value = _lodash2.default.get(this.node.model, this.path);</span>
<span class="cstat-no" title="statement not covered" >      _value = _value.replace(this.match, model[this.refProp]);</span>
<span class="cstat-no" title="statement not covered" >      _lodash2.default.set(this.node.model, this.path, _value);</span>
    }
  };
&nbsp;
