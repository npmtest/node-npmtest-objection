...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/ManyToManyConnection.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/ManyToManyConnection.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/</a> &#187; ManyToManyConnection.js</div>
</div>
<div class="body">
...
&nbsp;
var ManyToManyConnection = <span class="fstat-no" title="function not covered" >function ManyToManyConnection(node, relation) {</span>
<span class="cstat-no" title="statement not covered" >  (0, _classCallCheck3.default)(this, ManyToManyConnection);</span>
&nbsp;
  /**
   * @type {DependencyNode}
   */
...
&nbsp;
   ...
   * @type {DependencyNode}
   */
<span class="cstat-no" title="statement not covered" >  this.refNode = null;</span>
&nbsp;
  /**
   * @type {Relation}
   */
<span class="cstat-no" title="statement not covered" >  this.relation = relation;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  relation.omitExtraProps([node.model]);</span>
};
&nbsp;
