...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/ReplaceValueDependency.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/ReplaceValueDependency.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/</a> &#187; ReplaceValueDependency.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ReplaceValueDependency(node, path, refProp, inverse) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, ReplaceValueDependency);</span>
&nbsp;
    /**
     * @type {Array.&lt;string&gt;}
     */
...
&nbsp;
  ReplaceValueDependency.prototype.resolve = <span class="fstat-no" title="function not covered" >function resolve(model) {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.inverse) {</span>
<span class="cstat-no" title="statement not covered" >      _lodash2.default.set(model, this.path, this.node.model[this.refProp]);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      _lodash2.default.set(this.node.model, this.path, model[this.refProp]);</span>
    }
  };
&nbsp;
