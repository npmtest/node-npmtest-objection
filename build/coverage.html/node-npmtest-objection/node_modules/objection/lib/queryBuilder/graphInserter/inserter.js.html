...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/inserter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/inserter.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/graphInserter/</a> &#187; inserter.js</div>
</div>
<div class="body">
...
&nbsp;
exports.default = <span class="fstat-no" title="function not covered" >function (builder) {</span>
...
<span class="cstat-no" title="statement not covered" >  var batchSize = (0, _knexUtils.isPostgres)(builder.knex()) ? POSTGRES_INSERT_BATCH_SIZE : 1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function (tableInsertion) {</span></span>
<span class="cstat-no" title="statement not covered" >    var inputs = [];</span>
<span class="cstat-no" title="statement not covered" >    var others = [];</span>
<span class="cstat-no" title="statement not covered" >    var queries = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var insertQuery = tableInsertion.modelClass.query().childQueryOf(builder);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = tableInsertion.models.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var model = tableInsertion.models[i];</span>
&nbsp;
      // We need to validate here since at this point the models should no longer contain any special properties.
<span class="cstat-no" title="statement not covered" >      var json = model.$validate();</span>
&nbsp;
      // Set the return value back to model in case defaults were set.
<span class="cstat-no" title="statement not covered" >      model.$set(json);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (tableInsertion.isInputModel[i]) {</span>
<span class="cstat-no" title="statement not covered" >        inputs.push(model);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        others.push(model);</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    batchInsert(inputs, insertQuery.clone().copyFrom(builder, /returning/), batchSize, queries);</span>
<span class="cstat-no" title="statement not covered" >    batchInsert(others, insertQuery.clone(), batchSize, queries);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _bluebird2.default.all(queries);</span>
  };
};
&nbsp;
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function batchInsert(models, queryBuilder, batchSize, queries) {</span>
<span class="cstat-no" title="statement not covered" >  var batches = _lodash2.default.chunk(models, batchSize);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = batches.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    queries.push(queryBuilder.clone().insert(batches[i]));</span>
  }
}
