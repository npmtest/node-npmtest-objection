...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/InsertAndFetchOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/InsertAndFetchOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; InsertAndFetchOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function InsertAndFetchOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, InsertAndFetchOperation);</span>
&nbsp;
...
&nbsp;
  InsertAndFetchOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal(builder, inserted) {</span>
<span class="cstat-no" title="statement not covered" >    var maybePromise = _DelegateOperation.prototype.onAfterInternal.call(this, builder, inserted);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return (0, _promiseUtils.after)(maybePromise, <span class="fstat-no" title="function not covered" >function (insertedModels) {</span></span>
<span class="cstat-no" title="statement not covered" >      var insertedModelArray = Array.isArray(insertedModels) ? insertedModels : [insertedModels];</span>
<span class="cstat-no" title="statement not covered" >      var idProps = builder.modelClass().getIdPropertyArray();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return builder.modelClass().query().childQueryOf(builder).whereInComposite(builder.modelClass().getFullIdColumn(), insertedModelArray.map(<span class="fstat-no" title="function not covered" >function (model) {</span></span>
<span class="cstat-no" title="statement not covered" >        return model.$id();</span>
      })).then(<span class="fstat-no" title="function not covered" >function (fetchedModels) {</span>
<span class="cstat-no" title="statement not covered" >        fetchedModels = _lodash2.default.keyBy(fetchedModels, <span class="fstat-no" title="function not covered" >function (model) {</span></span>
<span class="cstat-no" title="statement not covered" >          return model.$propKey(idProps);</span>
        });
&nbsp;
        // Instead of returning the freshly fetched models, update the input
        // models with the fresh values.
<span class="cstat-no" title="statement not covered" >        insertedModelArray.forEach(<span class="fstat-no" title="function not covered" >function (insertedModel) {</span></span>
<span class="cstat-no" title="statement not covered" >          insertedModel.$set(fetchedModels[insertedModel.$propKey(idProps)]);</span>
        });
&nbsp;
<span class="cstat-no" title="statement not covered" >        return insertedModels;</span>
      });
    });
  };
&nbsp;
