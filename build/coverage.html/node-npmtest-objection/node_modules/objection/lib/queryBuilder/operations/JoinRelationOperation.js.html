...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/JoinRelationOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/JoinRelationOperation.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">48.15% <small>(26 / 54)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; JoinRelationOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function JoinRelationOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, JoinRelationOperation);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.expression = null;</span>
<span class="cstat-no" title="statement not covered" >    _this.callOpt = null;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  JoinRelationOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    this.expression = _RelationExpression2.default.parse(args[0]);</span>
<span class="cstat-no" title="statement not covered" >    this.callOpt = args[1] || {};</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  };
&nbsp;
  JoinRelationOperation.prototype.onBeforeBuild = <span class="fstat-no" title="function not covered" >function onBeforeBuild(builder) {</span>
<span class="cstat-no" title="statement not covered" >    var modelClass = builder.modelClass();</span>
<span class="cstat-no" title="statement not covered" >    var opt = (0, _assign2.default)({}, this.callOpt);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    opt.aliases = (0, _assign2.default)({}, opt.aliases);</span>
<span class="cstat-no" title="statement not covered" >    opt.joinOperation = this.opt.joinOperation;</span>
&nbsp;
    // Special case for one single relation.
<span class="cstat-no" title="statement not covered" >    if (this.expression.numChildren === 1) {</span>
<span class="cstat-no" title="statement not covered" >      var relationName = void 0;</span>
&nbsp;
      // A bit crappy way to get the only child.
<span class="cstat-no" title="statement not covered" >      this.expression.forEachChild(<span class="fstat-no" title="function not covered" >function (child, childName) {</span></span>
<span class="cstat-no" title="statement not covered" >        relationName = childName;</span>
      });
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (opt.alias === false) {</span>
<span class="cstat-no" title="statement not covered" >        alias = relation.relatedModelClass.tableName;</span>
      } else <span class="cstat-no" title="statement not covered" >if (opt.alias === true || !opt.alias) {</span>
<span class="cstat-no" title="statement not covered" >        alias = relation.name;</span>
      } else <span class="cstat-no" title="statement not covered" >if (_lodash2.default.isString(opt.alias)) {</span>
<span class="cstat-no" title="statement not covered" >        alias = opt.alias;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (alias) {</span>
<span class="cstat-no" title="statement not covered" >        opt.aliases[relationName] = alias;</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var joinBuilder = new _RelationJoinBuilder2.default({</span>
      modelClass: modelClass,
      expression: this.expression,
      opt: opt
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    joinBuilder.buildJoinOnly(builder);</span>
  };
&nbsp;
