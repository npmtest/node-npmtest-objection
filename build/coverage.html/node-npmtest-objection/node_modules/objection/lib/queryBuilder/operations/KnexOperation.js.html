...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/KnexOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/KnexOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; KnexOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function KnexOperation() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, KnexOperation);</span>
...
&nbsp;
  KnexOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(builder) {</span>
<span class="cstat-no" title="statement not covered" >    if (typeof builder[this.name] === 'function') {</span>
<span class="cstat-no" title="statement not covered" >      builder[this.name].apply(builder, this.args);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error('knex doesn\'t have the method \'' + this.name + '\'');</span>
    }
  };
&nbsp;
