...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/QueryBuilderOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/QueryBuilderOperation.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">64.44% <small>(29 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; QueryBuilderOperation.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   * @param {Object} opt
   */
<span class="fstat-no" title="function not covered" >  function QueryBuilderOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, QueryBuilderOperation);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this.isWriteOperation = false;</span>
  }
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.is = <span class="fstat-no" title="function not covered" >function is(OperationClass) {</span>
<span class="cstat-no" title="statement not covered" >    return this instanceof OperationClass;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
...
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.onBefore = <span class="fstat-no" title="function not covered" >function onBefore(builder, result) {</span>};
&nbsp;
  /**
   * @returns {boolean}
   */
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.hasOnBefore = <span class="fstat-no" title="function not covered" >function hasOnBefore() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onBefore !== QueryBuilderOperation.prototype.onBefore;</span>
  };
&nbsp;
  /**
   * @param {QueryBuilder} builder
...
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.onBeforeInternal = <span class="fstat-no" title="function not covered" >function onBeforeInternal(builder, result) {</span>};
&nbsp;
  /**
   * @returns {boolean}
   */
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.hasOnBeforeInternal = <span class="fstat-no" title="function not covered" >function hasOnBeforeInternal() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onBeforeInternal !== QueryBuilderOperation.prototype.onBeforeInternal;</span>
  };
&nbsp;
  /**
   * @param {QueryBuilder} builder
...
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.onBeforeBuild = <span class="fstat-no" title="function not covered" >function onBeforeBuild(builder) {</span>};
&nbsp;
  /**
   * @returns {boolean}
   */
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.hasOnBeforeBuild = <span class="fstat-no" title="function not covered" >function hasOnBeforeBuild() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onBeforeBuild !== QueryBuilderOperation.prototype.onBeforeBuild;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(knexBuilder, builder) {</span>};
&nbsp;
  /**
   * @returns {boolean}
   */
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.hasOnBuild = <span class="fstat-no" title="function not covered" >function hasOnBuild() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onBuild !== QueryBuilderOperation.prototype.onBuild;</span>
  };
&nbsp;
  /**
   * @param {QueryBuilder} builder
...
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.onRawResult = <span class="fstat-no" title="function not covered" >function onRawResult(builder, rows) {</span>
...
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.hasOnRawResult = <span class="fstat-no" title="function not covered" >function hasOnRawResult() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onRawResult !== QueryBuilderOperation.prototype.onRawResult;</span>
  };
&nbsp;
  /**
   * @param {QueryBuilder} builder
...
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.onAfterQuery = <span class="fstat-no" title="function not covered" >function onAfterQuery(builder, result) {</span>};
&nbsp;
  /**
   * @returns {boolean}
   */
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.hasOnAfterQuery = <span class="fstat-no" title="function not covered" >function hasOnAfterQuery() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onAfterQuery !== QueryBuilderOperation.prototype.onAfterQuery;</span>
  };
&nbsp;
  /**
   * @param {QueryBuilder} builder
...
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal(builder, result) {</span>};
&nbsp;
  /**
   * @returns {boolean}
   */
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.hasOnAfterInternal = <span class="fstat-no" title="function not covered" >function hasOnAfterInternal() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onAfterInternal !== QueryBuilderOperation.prototype.onAfterInternal;</span>
  };
&nbsp;
  /**
   * @param {QueryBuilder} builder
...
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.onAfter = <span class="fstat-no" title="function not covered" >function onAfter(builder, result) {</span>};
&nbsp;
  /**
   * @returns {boolean}
   */
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.hasOnAfter = <span class="fstat-no" title="function not covered" >function hasOnAfter() {</span>
<span class="cstat-no" title="statement not covered" >    return this.onAfter !== QueryBuilderOperation.prototype.onAfter;</span>
  };
&nbsp;
  /**
   * @param {QueryBuilder} builder
...
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.queryExecutor = <span class="fstat-no" title="function not covered" >function queryExecutor(builder) {</span>};
&nbsp;
  /**
   * @returns {boolean}
   */
&nbsp;
&nbsp;
  QueryBuilderOperation.prototype.hasQueryExecutor = <span class="fstat-no" title="function not covered" >function hasQueryExecutor() {</span>
<span class="cstat-no" title="statement not covered" >    return this.queryExecutor !== QueryBuilderOperation.prototype.queryExecutor;</span>
  };
&nbsp;
