...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/RangeOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/RangeOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; RangeOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function RangeOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, RangeOperation);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.resultSizePromise = null;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  RangeOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    if (args.length === 2) {</span>
<span class="cstat-no" title="statement not covered" >      var start = args[0];</span>
<span class="cstat-no" title="statement not covered" >      var end = args[1];</span>
&nbsp;
      // Need to set these here instead of `onBuild` so that they
      // don't end up in the resultSize query.
<span class="cstat-no" title="statement not covered" >      builder.limit(end - start + 1).offset(start);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return true;</span>
  };
&nbsp;
  RangeOperation.prototype.onBefore = <span class="fstat-no" title="function not covered" >function onBefore(builder) {</span>
    // Don't return the promise so that it is executed
    // in parallel with the actual query.
<span class="cstat-no" title="statement not covered" >    this.resultSizePromise = builder.resultSize();</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
  };
&nbsp;
  RangeOperation.prototype.onAfter = <span class="fstat-no" title="function not covered" >function onAfter(builder, result) {</span>
<span class="cstat-no" title="statement not covered" >    return this.resultSizePromise.then(<span class="fstat-no" title="function not covered" >function (count) {</span></span>
