...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/ReturningOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/ReturningOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; ReturningOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ReturningOperation() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, ReturningOperation);</span>
...
&nbsp;
  ReturningOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    args = (0, _flatten2.default)(args);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _WrappingQueryBuilder.prototype.call.call(this, builder, args);</span>
  };
&nbsp;
  ReturningOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(knexBuilder) {</span>
    // Always pass an array of columns to knex.returning.
<span class="cstat-no" title="statement not covered" >    knexBuilder.returning(this.args);</span>
  };
&nbsp;
