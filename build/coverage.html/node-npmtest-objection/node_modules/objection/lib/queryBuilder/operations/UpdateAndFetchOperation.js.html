...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/UpdateAndFetchOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/UpdateAndFetchOperation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">56.52% <small>(26 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; UpdateAndFetchOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function UpdateAndFetchOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, UpdateAndFetchOperation);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!_this.delegate.is(_UpdateOperation2.default)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid delegate');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.id = null;</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  UpdateAndFetchOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    this.id = args[0];</span>
<span class="cstat-no" title="statement not covered" >    return this.delegate.call(builder, args.slice(1));</span>
  };
&nbsp;
  UpdateAndFetchOperation.prototype.onBeforeBuild = <span class="fstat-no" title="function not covered" >function onBeforeBuild(builder) {</span>
<span class="cstat-no" title="statement not covered" >    _DelegateOperation.prototype.onBeforeBuild.call(this, builder);</span>
<span class="cstat-no" title="statement not covered" >    builder.whereComposite(builder.modelClass().getFullIdColumn(), this.id);</span>
  };
&nbsp;
  UpdateAndFetchOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal(builder, numUpdated) {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (numUpdated == 0) {</span>
      // If nothing was updated, we should fetch nothing.
<span class="cstat-no" title="statement not covered" >      return (0, _promiseUtils.afterReturn)(_DelegateOperation.prototype.onAfterInternal.call(this, builder, numUpdated), undefined);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return builder.modelClass().query().childQueryOf(builder).whereComposite(builder.modelClass().getFullIdColumn(), this.id).first().then(<span class="fstat-no" title="function not covered" >function (fetched) {</span></span>
<span class="cstat-no" title="statement not covered" >      var retVal = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (fetched) {</span>
<span class="cstat-no" title="statement not covered" >        _this2.model.$set(fetched);</span>
<span class="cstat-no" title="statement not covered" >        retVal = _this2.model;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return (0, _promiseUtils.afterReturn)(_DelegateOperation.prototype.onAfterInternal.call(_this2, builder, numUpdated), retVal);</span>
    });
  };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return this.delegate.model;</span>
    }
  }]);
