...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/WhereCompositeOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/WhereCompositeOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; WhereCompositeOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function WhereCompositeOperation() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, WhereCompositeOperation);</span>
...
&nbsp;
  WhereCompositeOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(knexBuilder) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.args.length === 2) {</span>
<span class="cstat-no" title="statement not covered" >      this.build(knexBuilder, this.args[0], '=', this.args[1]);</span>
    } else <span class="cstat-no" title="statement not covered" >if (this.args.length === 3) {</span>
<span class="cstat-no" title="statement not covered" >      this.build(knexBuilder, this.args[0], this.args[1], this.args[2]);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error('invalid number of arguments ' + this.args.length);</span>
    }
  };
&nbsp;
  WhereCompositeOperation.prototype.build = <span class="fstat-no" title="function not covered" >function build(knexBuilder, cols, op, values) {</span>
<span class="cstat-no" title="statement not covered" >    var colsIsArray = Array.isArray(cols);</span>
<span class="cstat-no" title="statement not covered" >    var valuesIsArray = Array.isArray(values);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!colsIsArray &amp;&amp; !valuesIsArray) {</span>
<span class="cstat-no" title="statement not covered" >      knexBuilder.where(cols, op, values);</span>
    } else <span class="cstat-no" title="statement not covered" >if (colsIsArray &amp;&amp; cols.length === 1 &amp;&amp; !valuesIsArray) {</span>
<span class="cstat-no" title="statement not covered" >      knexBuilder.where(cols[0], op, values);</span>
    } else <span class="cstat-no" title="statement not covered" >if (colsIsArray &amp;&amp; valuesIsArray &amp;&amp; cols.length === values.length) {</span>
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = cols.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        knexBuilder.where(cols[i], op, values[i]);</span>
      }
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error('both cols and values must have same dimensions');</span>
    }
  };
&nbsp;
