...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/WhereRefOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/WhereRefOperation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">55.88% <small>(19 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/</a> &#187; WhereRefOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function WhereRefOperation() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, WhereRefOperation);</span>
...
&nbsp;
  WhereRefOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(knexBuilder) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.args.length === 2) {</span>
<span class="cstat-no" title="statement not covered" >      this.whereRef(knexBuilder, this.args[0], '=', this.args[1]);</span>
    } else <span class="cstat-no" title="statement not covered" >if (this.args.length === 3) {</span>
<span class="cstat-no" title="statement not covered" >      this.whereRef(knexBuilder, this.args[0], this.args[1], this.args[2]);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error('expected 2 or 3 arguments');</span>
    }
  };
&nbsp;
  WhereRefOperation.prototype.whereRef = <span class="fstat-no" title="function not covered" >function whereRef(knexBuilder, lhs, op, rhs) {</span>
<span class="cstat-no" title="statement not covered" >    var formatter = knexBuilder.client.formatter();</span>
<span class="cstat-no" title="statement not covered" >    op = formatter.operator(op);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof lhs !== 'string' || typeof rhs !== 'string' || typeof op !== 'string') {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('whereRef: invalid operands or operator');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var sql = formatter.wrap(lhs) + ' ' + op + ' ' + formatter.wrap(rhs);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.opt.bool === 'or') {</span>
<span class="cstat-no" title="statement not covered" >      knexBuilder.orWhereRaw(sql);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      knexBuilder.whereRaw(sql);</span>
    }
  };
&nbsp;
