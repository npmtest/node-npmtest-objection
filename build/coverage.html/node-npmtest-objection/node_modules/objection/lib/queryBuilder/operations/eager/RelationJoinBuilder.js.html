...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/eager/RelationJoinBuilder.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/eager/RelationJoinBuilder.js</span></h1>
    <h2>
        
        Statements: <span class="metric">20.75% <small>(77 / 371)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">20.54% <small>(76 / 370)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/eager/</a> &#187; RelationJoinBuilder.js</div>
</div>
<div class="body">
...
793
794
795</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="fstat-no" title="function not covered" >  function RelationJoinBuilder(_ref) {</span>
<span class="cstat-no" title="statement not covered" >    var modelClass = _ref.modelClass,</span>
        expression = _ref.expression,
        opt = _ref.opt;
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, RelationJoinBuilder);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.rootModelClass = modelClass;</span>
<span class="cstat-no" title="statement not covered" >    this.expression = expression;</span>
<span class="cstat-no" title="statement not covered" >    this.allRelations = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.pathInfo = (0, _create2.default)(null);</span>
<span class="cstat-no" title="statement not covered" >    this.encodings = (0, _create2.default)(null);</span>
<span class="cstat-no" title="statement not covered" >    this.decodings = (0, _create2.default)(null);</span>
<span class="cstat-no" title="statement not covered" >    this.encIdx = 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.opt = _lodash2.default.defaults(opt, {</span>
      minimize: false,
      separator: ':',
      aliases: {}
    });
...
&nbsp;
  RelationJoinBuilder.prototype.clone = <span class="fstat-no" title="function not covered" >function clone(props) {</span>
<span class="cstat-no" title="statement not covered" >    props = props || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var copy = new RelationJoinBuilder({</span>
      modelClass: this.rootModelClass,
      expression: props.expression || this.expression,
      opt: props.opt || this.opt
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    copy.allRelations = this.allRelations;</span>
<span class="cstat-no" title="statement not covered" >    copy.pathInfo = this.pathInfo;</span>
<span class="cstat-no" title="statement not covered" >    copy.encodings = this.encodings;</span>
<span class="cstat-no" title="statement not covered" >    copy.decodings = this.decodings;</span>
<span class="cstat-no" title="statement not covered" >    copy.encIdx = this.encIdx;</span>
&nbsp;
...
&nbsp;
&nbsp;
  RelationJoinBuilder.prototype.fetchColumnInfo = <span class="fstat-no" title="function not covered" >function fetchColumnInfo(knex) {</span>
<span class="cstat-no" title="statement not covered" >    var allModelClasses = findAllModels(this.expression, this.rootModelClass);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _bluebird2.default.all(allModelClasses.map(<span class="fstat-no" title="function not covered" >function (ModelClass) {</span></span>
<span class="cstat-no" title="statement not covered" >      var table = ModelClass.tableName;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (columnInfo[table]) {</span>
<span class="cstat-no" title="statement not covered" >        return columnInfo[table];</span>
      } else {
<span class="cstat-no" title="statement not covered" >        columnInfo[table] = knex(table).columnInfo().then(<span class="fstat-no" title="function not covered" >function (info) {</span></span>
<span class="cstat-no" title="statement not covered" >          var result = {</span>
            columns: (0, _keys2.default)(info)
          };
&nbsp;
<span class="cstat-no" title="statement not covered" >          columnInfo[table] = result;</span>
...
&nbsp;
  RelationJoinBuilder.prototype.buildJoinOnly = <span class="fstat-no" title="function not covered" >function buildJoinOnly(builder) {</span>
<span class="cstat-no" title="statement not covered" >    this.doBuild({</span>
...
&nbsp;
  RelationJoinBuilder.prototype.build = <span class="fstat-no" title="function not covered" >function build(builder) {</span>
<span class="cstat-no" title="statement not covered" >    var builderClone = builder.clone();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    builder.table(this.rootModelClass.tableName + ' as ' + this.rootModelClass.tableName);</span>
<span class="cstat-no" title="statement not covered" >    builder.findOptions({ callAfterGetDeeply: true });</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.doBuild({</span>
      expr: this.expression,
      builder: builder,
      ...
      relation: null,
      path: '',
      selectFilter: <span class="fstat-no" title="function not covered" >function selectFilter(col) {</span>
<span class="cstat-no" title="statement not covered" >        return builderClone.hasSelection(col);</span>
      }
    });
  };
&nbsp;
  RelationJoinBuilder.prototype.rowsToTree = <span class="fstat-no" title="function not covered" >function rowsToTree(rows) {</span>
<span class="cstat-no" title="statement not covered" >    if (_lodash2.default.isEmpty(rows)) {</span>
<span class="cstat-no" title="statement not covered" >      return rows;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var keyInfoByPath = this.createKeyInfo(rows);</span>
<span class="cstat-no" title="statement not covered" >    var pathInfo = _lodash2.default.values(this.pathInfo);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var tree = (0, _create2.default)(null);</span>
<span class="cstat-no" title="statement not covered" >    var stack = (0, _create2.default)(null);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, lr = rows.length; i &lt; lr; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var row = rows[i];</span>
<span class="cstat-no" title="statement not covered" >      var curBranch = tree;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var j = 0, lp = pathInfo.length; j &lt; lp; ++j) {</span>
<span class="cstat-no" title="statement not covered" >        var pInfo = pathInfo[j];</span>
<span class="cstat-no" title="statement not covered" >        var id = pInfo.idGetter(row);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!id) {</span>
<span class="cstat-no" title="statement not covered" >          continue;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (pInfo.relation) {</span>
<span class="cstat-no" title="statement not covered" >          var parentModel = stack[pInfo.encParentPath];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          curBranch = pInfo.getBranch(parentModel);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!curBranch) {</span>
<span class="cstat-no" title="statement not covered" >            curBranch = pInfo.createBranch(parentModel);</span>
          }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        var model = pInfo.getModelFromBranch(curBranch, id);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!model) {</span>
<span class="cstat-no" title="statement not covered" >          model = createModel(row, pInfo, keyInfoByPath);</span>
<span class="cstat-no" title="statement not covered" >          pInfo.setModelToBranch(curBranch, id, model);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        stack[pInfo.encPath] = model;</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.finalize(pathInfo[0], _lodash2.default.values(tree));</span>
  };
&nbsp;
  RelationJoinBuilder.prototype.createKeyInfo = <span class="fstat-no" title="function not covered" >function createKeyInfo(rows) {</span>
<span class="cstat-no" title="statement not covered" >    var keys = (0, _keys2.default)(rows[0]);</span>
<span class="cstat-no" title="statement not covered" >    var keyInfo = [];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      var sepIdx = key.lastIndexOf(this.sep);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (sepIdx === -1) {</span>
<span class="cstat-no" title="statement not covered" >        var pInfo = this.pathInfo[''];</span>
<span class="cstat-no" title="statement not covered" >        var col = key;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!pInfo.omitCols[col]) {</span>
<span class="cstat-no" title="statement not covered" >          keyInfo.push({</span>
            pInfo: pInfo,
            key: key,
            col: col
          });
...
<span class="cstat-no" title="statement not covered" >        var encPath = key.substr(0, sepIdx);</span>
<span class="cstat-no" title="statement not covered" >        var path = this.decode(encPath);</span>
<span class="cstat-no" title="statement not covered" >        var _col = key.substr(sepIdx + 1);</span>
<span class="cstat-no" title="statement not covered" >        var _pInfo = this.pathInfo[path];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!_pInfo.omitCols[_col]) {</span>
<span class="cstat-no" title="statement not covered" >          keyInfo.push({</span>
            pInfo: _pInfo,
            key: key,
            col: _col
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _lodash2.default.groupBy(keyInfo, <span class="fstat-no" title="function not covered" >function (kInfo) {</span></span>
<span class="cstat-no" title="statement not covered" >      return kInfo.pInfo.encPath;</span>
    });
  };
&nbsp;
  RelationJoinBuilder.prototype.finalize = <span class="fstat-no" title="function not covered" >function finalize(pInfo, models) {</span>
<span class="cstat-no" title="statement not covered" >    var relNames = (0, _keys2.default)(pInfo.children);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Array.isArray(models)) {</span>
<span class="cstat-no" title="statement not covered" >      for (var m = 0, lm = models.length; m &lt; lm; ++m) {</span>
<span class="cstat-no" title="statement not covered" >        this.finalizeOne(pInfo, relNames, models[m]);</span>
      }
    } else <span class="cstat-no" title="statement not covered" >if (models) {</span>
<span class="cstat-no" title="statement not covered" >      this.finalizeOne(pInfo, relNames, models);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return models;</span>
  };
&nbsp;
  RelationJoinBuilder.prototype.finalizeOne = <span class="fstat-no" title="function not covered" >function finalizeOne(pInfo, relNames, model) {</span>
<span class="cstat-no" title="statement not covered" >    for (var r = 0, lr = relNames.length; r &lt; lr; ++r) {</span>
<span class="cstat-no" title="statement not covered" >      var relName = relNames[r];</span>
<span class="cstat-no" title="statement not covered" >      var branch = model[relName];</span>
<span class="cstat-no" title="statement not covered" >      var childPathInfo = pInfo.children[relName];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var finalized = childPathInfo.finalizeBranch(branch, model);</span>
<span class="cstat-no" title="statement not covered" >      this.finalize(childPathInfo, finalized);</span>
    }
  };
&nbsp;
  RelationJoinBuilder.prototype.doBuild = <span class="fstat-no" title="function not covered" >function doBuild(_ref2) {</span>
<span class="cstat-no" title="statement not covered" >    var _this = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var expr = _ref2.expr,</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!this.allRelations) {</span>
<span class="cstat-no" title="statement not covered" >      this.allRelations = findAllRelations(this.expression, this.rootModelClass);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var info = this.createPathInfo({</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.pathInfo[path] = info;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!noSelects) {</span>
<span class="cstat-no" title="statement not covered" >      this.buildSelects({</span>
        builder: builder,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    forEachExpr(expr, modelClass, <span class="fstat-no" title="function not covered" >function (childExpr, relation) {</span></span>
<span class="cstat-no" title="statement not covered" >      var nextPath = _this.joinPath(path, relation.name);</span>
<span class="cstat-no" title="statement not covered" >      var encNextPath = _this.encode(nextPath);</span>
<span class="cstat-no" title="statement not covered" >      var encJoinTablePath = relation.joinTable ? _this.encode(joinTableForPath(nextPath)) : null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var filterQuery = createFilterQuery({</span>
        builder: builder,
        relation: relation,
        expr: childExpr
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      var relatedJoinSelectQuery = createRelatedJoinFromQuery({</span>
        filterQuery: filterQuery,
        relation: relation,
        allRelations: _this.allRelations
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      relation.join(builder, {</span>
...
<span class="cstat-no" title="statement not covered" >      filterQuery.modify(relation.modify);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      _this.doBuild({</span>
        expr: childExpr,
        builder: builder,
        ...
        path: nextPath,
        selectFilter: <span class="fstat-no" title="function not covered" >function selectFilter(col) {</span>
<span class="cstat-no" title="statement not covered" >          return filterQuery.hasSelection(col);</span>
        }
      });
    });
  };
&nbsp;
  RelationJoinBuilder.prototype.createPathInfo = <span class="fstat-no" title="function not covered" >function createPathInfo(_ref3) {</span>
<span class="cstat-no" title="statement not covered" >    var modelClass = _ref3.modelClass,</span>
        path = _ref3.path,
        relation = _ref3.relation,
        parentInfo = _ref3.parentInfo;
&nbsp;
<span class="cstat-no" title="statement not covered" >    var encPath = this.encode(path);</span>
<span class="cstat-no" title="statement not covered" >    var info = void 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (relation &amp;&amp; relation.isOneToOne()) {</span>
<span class="cstat-no" title="statement not covered" >      info = new OneToOnePathInfo();</span>
    } else {
<span class="cstat-no" title="statement not covered" >      info = new PathInfo();</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    info.path = path;</span>
<span class="cstat-no" title="statement not covered" >    info.encPath = encPath;</span>
<span class="cstat-no" title="statement not covered" >    info.parentPath = parentInfo &amp;&amp; parentInfo.path;</span>
<span class="cstat-no" title="statement not covered" >    info.encParentPath = parentInfo &amp;&amp; parentInfo.encPath;</span>
<span class="cstat-no" title="statement not covered" >    info.modelClass = modelClass;</span>
<span class="cstat-no" title="statement not covered" >    info.relation = relation;</span>
<span class="cstat-no" title="statement not covered" >    info.idGetter = this.createIdGetter(modelClass, encPath);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (parentInfo) {</span>
<span class="cstat-no" title="statement not covered" >      parentInfo.children[relation.name] = info;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return info;</span>
  };
&nbsp;
  RelationJoinBuilder.prototype.buildSelects = <span class="fstat-no" title="function not covered" >function buildSelects(_ref4) {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var builder = _ref4.builder,</span>
        selectFilter = _ref4.selectFilter,
        modelClass = _ref4.modelClass,
        relation = _ref4.relation,
        info = _ref4.info;
&nbsp;
<span class="cstat-no" title="statement not covered" >    var selects = [];</span>
<span class="cstat-no" title="statement not covered" >    var idCols = modelClass.getIdColumnArray();</span>
<span class="cstat-no" title="statement not covered" >    var rootTable = this.rootModelClass.tableName;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    columnInfo[modelClass.tableName].columns.forEach(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >      var filterPassed = selectFilter(col);</span>
<span class="cstat-no" title="statement not covered" >      var isIdColumn = idCols.indexOf(col) !== -1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (filterPassed || isIdColumn) {</span>
<span class="cstat-no" title="statement not covered" >        selects.push({</span>
          col: (info.encPath || rootTable) + '.' + col,
          alias: _this2.joinPath(info.encPath, col)
        });
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!filterPassed) {</span>
<span class="cstat-no" title="statement not covered" >          info.omitCols[col] = true;</span>
        }
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (relation &amp;&amp; relation.joinTableExtras) {</span>
<span class="cstat-no" title="statement not covered" >      var joinTable = this.encode(joinTableForPath(info.path));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      relation.joinTableExtras.forEach(<span class="fstat-no" title="function not covered" >function (extra) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (selectFilter(extra.joinTableCol)) {</span>
<span class="cstat-no" title="statement not covered" >          selects.push({</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var tooLongAliases = selects.filter(<span class="fstat-no" title="function not covered" >function (select) {</span></span>
<span class="cstat-no" title="statement not covered" >      return select.alias.length &gt; idLengthLimit;</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (tooLongAliases.length) {</span>
<span class="cstat-no" title="statement not covered" >      throw new _ValidationError2.default({</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    builder.select(selects.filter(<span class="fstat-no" title="function not covered" >function (select) {</span></span>
<span class="cstat-no" title="statement not covered" >      return !builder.hasSelection(select.col, true);</span>
    }).map(<span class="fstat-no" title="function not covered" >function (select) {</span>
<span class="cstat-no" title="statement not covered" >      return select.col + ' as ' + select.alias;</span>
    }));
  };
&nbsp;
  RelationJoinBuilder.prototype.encode = <span class="fstat-no" title="function not covered" >function encode(path) {</span>
<span class="cstat-no" title="statement not covered" >    var _this3 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!this.opt.minimize) {</span>
<span class="cstat-no" title="statement not covered" >      var encPath = this.encodings[path];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!encPath) {</span>
<span class="cstat-no" title="statement not covered" >        var parts = path.split(this.sep);</span>
&nbsp;
        // Don't encode the root.
<span class="cstat-no" title="statement not covered" >        if (!path) {</span>
<span class="cstat-no" title="statement not covered" >          encPath = path;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          encPath = parts.map(<span class="fstat-no" title="function not covered" >function (part) {</span></span>
<span class="cstat-no" title="statement not covered" >            return _this3.opt.aliases[part] || part;</span>
          }).join(this.sep);
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.encodings[path] = encPath;</span>
<span class="cstat-no" title="statement not covered" >        this.decodings[encPath] = path;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return encPath;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      var _encPath = this.encodings[path];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!_encPath) {</span>
        // Don't encode the root.
<span class="cstat-no" title="statement not covered" >        if (!path) {</span>
<span class="cstat-no" title="statement not covered" >          _encPath = path;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          _encPath = this.nextEncodedPath();</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.encodings[path] = _encPath;</span>
<span class="cstat-no" title="statement not covered" >        this.decodings[_encPath] = path;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _encPath;</span>
    }
  };
&nbsp;
  RelationJoinBuilder.prototype.decode = <span class="fstat-no" title="function not covered" >function decode(path) {</span>
<span class="cstat-no" title="statement not covered" >    return this.decodings[path];</span>
  };
&nbsp;
  RelationJoinBuilder.prototype.nextEncodedPath = <span class="fstat-no" title="function not covered" >function nextEncodedPath() {</span>
<span class="cstat-no" title="statement not covered" >    return '_t' + ++this.encIdx;</span>
  };
&nbsp;
  RelationJoinBuilder.prototype.createIdGetter = <span class="fstat-no" title="function not covered" >function createIdGetter(modelClass, path) {</span>
<span class="cstat-no" title="statement not covered" >    var _this4 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var idCols = modelClass.getIdColumnArray().map(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _this4.joinPath(path, col);</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (idCols.length === 1) {</span>
<span class="cstat-no" title="statement not covered" >      return createSingleIdGetter(idCols);</span>
    } else <span class="cstat-no" title="statement not covered" >if (idCols.length === 2) {</span>
<span class="cstat-no" title="statement not covered" >      return createTwoIdGetter(idCols);</span>
    } else <span class="cstat-no" title="statement not covered" >if (idCols.length === 3) {</span>
<span class="cstat-no" title="statement not covered" >      return createThreeIdGetter(idCols);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return createNIdGetter(idCols);</span>
    }
  };
&nbsp;
  RelationJoinBuilder.prototype.joinPath = <span class="fstat-no" title="function not covered" >function joinPath(path, nextPart) {</span>
<span class="cstat-no" title="statement not covered" >    if (path) {</span>
<span class="cstat-no" title="statement not covered" >      return '' + path + this.sep + nextPart;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return nextPart;</span>
    }
  };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return this.opt.separator;</span>
    }
  }]);
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function findAllModels(expr, modelClass) {</span>
<span class="cstat-no" title="statement not covered" >  var models = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  findAllModelsImpl(expr, modelClass, models);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _lodash2.default.uniqBy(models, 'tableName');</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function findAllModelsImpl(expr, modelClass, models) {</span>
<span class="cstat-no" title="statement not covered" >  models.push(modelClass);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  forEachExpr(expr, modelClass, <span class="fstat-no" title="function not covered" >function (childExpr, relation) {</span></span>
<span class="cstat-no" title="statement not covered" >    findAllModelsImpl(childExpr, relation.relatedModelClass, models);</span>
  });
}
&nbsp;
<span class="fstat-no" title="function not covered" >function findAllRelations(expr, modelClass) {</span>
<span class="cstat-no" title="statement not covered" >  var relations = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  findAllRelationsImpl(expr, modelClass, relations);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _lodash2.default.uniqWith(relations, <span class="fstat-no" title="function not covered" >function (lhs, rhs) {</span></span>
<span class="cstat-no" title="statement not covered" >    return lhs === rhs;</span>
  });
}
&nbsp;
<span class="fstat-no" title="function not covered" >function findAllRelationsImpl(expr, modelClass, relations) {</span>
<span class="cstat-no" title="statement not covered" >  forEachExpr(expr, modelClass, <span class="fstat-no" title="function not covered" >function (childExpr, relation) {</span></span>
<span class="cstat-no" title="statement not covered" >    relations.push(relation);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    findAllRelationsImpl(childExpr, relation.relatedModelClass, relations);</span>
  });
}
&nbsp;
<span class="fstat-no" title="function not covered" >function forEachExpr(expr, modelClass, callback) {</span>
<span class="cstat-no" title="statement not covered" >  var relations = modelClass.getRelationArray();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (expr.isAllRecursive() || expr.maxRecursionDepth() &gt; relationRecursionLimit) {</span>
<span class="cstat-no" title="statement not covered" >    throw new _ValidationError2.default({</span>
...
<span class="cstat-no" title="statement not covered" >    var childExpr = expr.childExpression(relation.name);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (childExpr) {</span>
<span class="cstat-no" title="statement not covered" >      callback(childExpr, relation, relation.name);</span>
    }
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function createSingleIdGetter(idCols) {</span>
<span class="cstat-no" title="statement not covered" >  var idCol = idCols[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function (row) {</span></span>
<span class="cstat-no" title="statement not covered" >    var val = row[idCol];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!val) {</span>
<span class="cstat-no" title="statement not covered" >      return null;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return 'id:' + val;</span>
    }
  };
}
&nbsp;
<span class="fstat-no" title="function not covered" >function createTwoIdGetter(idCols) {</span>
<span class="cstat-no" title="statement not covered" >  var idCol1 = idCols[0];</span>
<span class="cstat-no" title="statement not covered" >  var idCol2 = idCols[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function (row) {</span></span>
<span class="cstat-no" title="statement not covered" >    var val1 = row[idCol1];</span>
<span class="cstat-no" title="statement not covered" >    var val2 = row[idCol2];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!val1 || !val2) {</span>
<span class="cstat-no" title="statement not covered" >      return null;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return 'id:' + val1 + ',' + val2;</span>
    }
  };
}
&nbsp;
<span class="fstat-no" title="function not covered" >function createThreeIdGetter(idCols) {</span>
<span class="cstat-no" title="statement not covered" >  var idCol1 = idCols[0];</span>
<span class="cstat-no" title="statement not covered" >  var idCol2 = idCols[1];</span>
<span class="cstat-no" title="statement not covered" >  var idCol3 = idCols[2];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function (row) {</span></span>
<span class="cstat-no" title="statement not covered" >    var val1 = row[idCol1];</span>
<span class="cstat-no" title="statement not covered" >    var val2 = row[idCol2];</span>
<span class="cstat-no" title="statement not covered" >    var val3 = row[idCol3];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!val1 || !val2 || !val3) {</span>
<span class="cstat-no" title="statement not covered" >      return null;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return 'id:' + val1 + ',' + val2 + ',' + val3;</span>
    }
  };
}
&nbsp;
<span class="fstat-no" title="function not covered" >function createNIdGetter(idCols) {</span>
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >function (row) {</span></span>
<span class="cstat-no" title="statement not covered" >    var id = 'id:';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = idCols.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var val = row[idCols[i]];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!val) {</span>
<span class="cstat-no" title="statement not covered" >        return null;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      id += (i &gt; 0 ? ',' : '') + val;</span>
    }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function createFilterQuery(_ref5) {</span>
<span class="cstat-no" title="statement not covered" >  var builder = _ref5.builder,</span>
      expr = _ref5.expr,
      relation = _ref5.relation;
&nbsp;
<span class="cstat-no" title="statement not covered" >  var filterQuery = relation.relatedModelClass.query().childQueryOf(builder);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = expr.args.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var filterName = expr.args[i];</span>
<span class="cstat-no" title="statement not covered" >    var filter = expr.filters[filterName];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof filter !== 'function') {</span>
<span class="cstat-no" title="statement not covered" >      throw new _ValidationError2.default({ eager: 'could not find filter "' + filterName + '" for relation "' + relation.name + '"' });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    filter(filterQuery);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return filterQuery;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function createRelatedJoinFromQuery(_ref6) {</span>
<span class="cstat-no" title="statement not covered" >  var filterQuery = _ref6.filterQuery,</span>
      relation = _ref6.relation,
      allRelations = _ref6.allRelations;
&nbsp;
<span class="cstat-no" title="statement not covered" >  var relatedJoinFromQuery = filterQuery.clone();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var allForeignKeys = findAllForeignKeysForModel({</span>
    modelClass: relation.relatedModelClass,
    allRelations: allRelations
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  return relatedJoinFromQuery.select(allForeignKeys.filter(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >    return !relatedJoinFromQuery.hasSelection(col);</span>
  }));
}
&nbsp;
<span class="fstat-no" title="function not covered" >function findAllForeignKeysForModel(_ref7) {</span>
<span class="cstat-no" title="statement not covered" >  var modelClass = _ref7.modelClass,</span>
      allRelations = _ref7.allRelations;
&nbsp;
<span class="cstat-no" title="statement not covered" >  var foreignKeys = modelClass.getIdColumnArray().slice();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  allRelations.forEach(<span class="fstat-no" title="function not covered" >function (rel) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (rel.relatedModelClass.tableName === modelClass.tableName) {</span>
<span class="cstat-no" title="statement not covered" >      rel.relatedCol.forEach(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >        return foreignKeys.push(col);</span>
      });
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (rel.ownerModelClass.tableName === modelClass.tableName) {</span>
<span class="cstat-no" title="statement not covered" >      rel.ownerCol.forEach(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >        return foreignKeys.push(col);</span>
      });
    }
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _lodash2.default.uniq(foreignKeys);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function createModel(row, pInfo, keyInfoByPath) {</span>
<span class="cstat-no" title="statement not covered" >  var keyInfo = keyInfoByPath[pInfo.encPath];</span>
<span class="cstat-no" title="statement not covered" >  var json = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var k = 0, lk = keyInfo.length; k &lt; lk; ++k) {</span>
<span class="cstat-no" title="statement not covered" >    var kInfo = keyInfo[k];</span>
<span class="cstat-no" title="statement not covered" >    json[kInfo.col] = row[kInfo.key];</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return pInfo.modelClass.fromDatabaseJson(json);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function joinTableForPath(path) {</span>
<span class="cstat-no" title="statement not covered" >  return path + '_join';</span>
}
&nbsp;
var PathInfo = function () {
<span class="fstat-no" title="function not covered" >  function PathInfo() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, PathInfo);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.path = null;</span>
<span class="cstat-no" title="statement not covered" >    this.encPath = null;</span>
<span class="cstat-no" title="statement not covered" >    this.encParentPath = null;</span>
<span class="cstat-no" title="statement not covered" >    this.modelClass = null;</span>
<span class="cstat-no" title="statement not covered" >    this.relation = null;</span>
<span class="cstat-no" title="statement not covered" >    this.omitCols = (0, _create2.default)(null);</span>
<span class="cstat-no" title="statement not covered" >    this.children = (0, _create2.default)(null);</span>
<span class="cstat-no" title="statement not covered" >    this.idGetter = null;</span>
  }
&nbsp;
  PathInfo.prototype.createBranch = <span class="fstat-no" title="function not covered" >function createBranch(parentModel) {</span>
<span class="cstat-no" title="statement not covered" >    var branch = (0, _create2.default)(null);</span>
<span class="cstat-no" title="statement not covered" >    parentModel[this.relation.name] = branch;</span>
<span class="cstat-no" title="statement not covered" >    return branch;</span>
  };
&nbsp;
  PathInfo.prototype.getBranch = <span class="fstat-no" title="function not covered" >function getBranch(parentModel) {</span>
<span class="cstat-no" title="statement not covered" >    return parentModel[this.relation.name];</span>
  };
&nbsp;
  PathInfo.prototype.getModelFromBranch = <span class="fstat-no" title="function not covered" >function getModelFromBranch(branch, id) {</span>
<span class="cstat-no" title="statement not covered" >    return branch[id];</span>
  };
&nbsp;
  PathInfo.prototype.setModelToBranch = <span class="fstat-no" title="function not covered" >function setModelToBranch(branch, id, model) {</span>
<span class="cstat-no" title="statement not covered" >    branch[id] = model;</span>
  };
&nbsp;
  PathInfo.prototype.finalizeBranch = <span class="fstat-no" title="function not covered" >function finalizeBranch(branch, parentModel) {</span>
<span class="cstat-no" title="statement not covered" >    var relModels = _lodash2.default.values(branch);</span>
<span class="cstat-no" title="statement not covered" >    parentModel[this.relation.name] = relModels;</span>
<span class="cstat-no" title="statement not covered" >    return relModels;</span>
  };
&nbsp;
  return PathInfo;
}();
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function OneToOnePathInfo() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, OneToOnePathInfo);</span>
<span class="cstat-no" title="statement not covered" >    return (0, _possibleConstructorReturn3.default)(this, _PathInfo.apply(this, arguments));</span>
  }
&nbsp;
  OneToOnePathInfo.prototype.createBranch = <span class="fstat-no" title="function not covered" >function createBranch(parentModel) {</span>
<span class="cstat-no" title="statement not covered" >    return parentModel;</span>
  };
&nbsp;
  OneToOnePathInfo.prototype.getBranch = <span class="fstat-no" title="function not covered" >function getBranch(parentModel) {</span>
<span class="cstat-no" title="statement not covered" >    return parentModel;</span>
  };
&nbsp;
  OneToOnePathInfo.prototype.getModelFromBranch = <span class="fstat-no" title="function not covered" >function getModelFromBranch(branch, id) {</span>
<span class="cstat-no" title="statement not covered" >    return branch[this.relation.name];</span>
  };
&nbsp;
  OneToOnePathInfo.prototype.setModelToBranch = <span class="fstat-no" title="function not covered" >function setModelToBranch(branch, id, model) {</span>
<span class="cstat-no" title="statement not covered" >    branch[this.relation.name] = model;</span>
  };
&nbsp;
  OneToOnePathInfo.prototype.finalizeBranch = <span class="fstat-no" title="function not covered" >function finalizeBranch(branch, parentModel) {</span>
<span class="cstat-no" title="statement not covered" >    parentModel[this.relation.name] = branch || null;</span>
<span class="cstat-no" title="statement not covered" >    return branch || null;</span>
  };
&nbsp;
