...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/eager/WhereInEagerOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/eager/WhereInEagerOperation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">32.41% <small>(35 / 108)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">31.78% <small>(34 / 107)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/eager/</a> &#187; WhereInEagerOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function WhereInEagerOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, WhereInEagerOperation);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = (0, _possibleConstructorReturn3.default)(this, _EagerOperation.call(this, name, opt));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.relationsToFetch = [];</span>
<span class="cstat-no" title="statement not covered" >    _this.omitProps = [];</span>
<span class="cstat-no" title="statement not covered" >    return _this;</span>
  }
&nbsp;
  WhereInEagerOperation.prototype.batchSize = <span class="fstat-no" title="function not covered" >function batchSize(knex) {</span>
<span class="cstat-no" title="statement not covered" >    if ((0, _knexUtils.isMsSql)(knex)) {</span>
...
<span class="cstat-no" title="statement not covered" >      return 2000;</span>
    } else {
...
&nbsp;
  WhereInEagerOperation.prototype.clone = <span class="fstat-no" title="function not covered" >function clone(props) {</span>
<span class="cstat-no" title="statement not covered" >    var copy = _EagerOperation.prototype.clone.call(this);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    copy.relationsToFetch = this.relationsToFetch.slice();</span>
<span class="cstat-no" title="statement not covered" >    copy.omitProps = this.omitProps.slice();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return copy;</span>
  };
&nbsp;
  WhereInEagerOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    var ret = _EagerOperation.prototype.call.call(this, builder, args);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var modelClass = builder.modelClass();</span>
...
<span class="cstat-no" title="statement not covered" >      var childExpression = this.expression.childExpression(relation.name);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (childExpression) {</span>
<span class="cstat-no" title="statement not covered" >        this.relationsToFetch.push({</span>
          relation: relation,
...
&nbsp;
  WhereInEagerOperation.prototype.onBeforeBuild = <span class="fstat-no" title="function not covered" >function onBeforeBuild(builder) {</span>
<span class="cstat-no" title="statement not covered" >    var addedSelects = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = this.relationsToFetch.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var relation = this.relationsToFetch[i].relation;</span>
<span class="cstat-no" title="statement not covered" >      var _cols = relation.fullOwnerCol();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var c = 0, lc = _cols.length; c &lt; lc; ++c) {</span>
<span class="cstat-no" title="statement not covered" >        var col = _cols[c];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!builder.hasSelection(col) &amp;&amp; !addedSelects[col]) {</span>
<span class="cstat-no" title="statement not covered" >          this.omitProps.push(relation.ownerProp[c]);</span>
<span class="cstat-no" title="statement not covered" >          addedSelects[col] = true;</span>
        }
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var cols = (0, _keys2.default)(addedSelects);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (cols.length) {</span>
<span class="cstat-no" title="statement not covered" >      builder.select(cols);</span>
    }
  };
&nbsp;
  WhereInEagerOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal(builder, result) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var models = Array.isArray(result) ? result : [result];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!models.length || !(models[0] instanceof modelClass)) {</span>
<span class="cstat-no" title="statement not covered" >      return result;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var promises = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.expression.forEachChild(<span class="fstat-no" title="function not covered" >function (child) {</span></span>
<span class="cstat-no" title="statement not covered" >      var relation = modelClass.getRelations()[child.name];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!relation) {</span>
<span class="cstat-no" title="statement not covered" >        throw new _ValidationError2.default({ eager: 'unknown relation "' + child.name + '" in an eager expression' });</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = this.relationsToFetch.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var relation = this.relationsToFetch[i].relation;</span>
<span class="cstat-no" title="statement not covered" >      var childExpression = this.relationsToFetch[i].childExpression;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      promises.push(this.fetchRelation(builder, models, relation, childExpression));</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _bluebird2.default.all(promises).then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      if (!_this2.omitProps.length) {</span>
<span class="cstat-no" title="statement not covered" >        return result;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var _i = 0, _l = result.length; _i &lt; _l; ++_i) {</span>
<span class="cstat-no" title="statement not covered" >        var model = result[_i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        for (var c = 0, lc = _this2.omitProps.length; c &lt; lc; ++c) {</span>
<span class="cstat-no" title="statement not covered" >          modelClass.omitImpl(model, _this2.omitProps[c]);</span>
        }
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return result;</span>
...
&nbsp;
  WhereInEagerOperation.prototype.fetchRelation = <span class="fstat-no" title="function not covered" >function fetchRelation(builder, models, relation, childExpression) {</span>
<span class="cstat-no" title="statement not covered" >    var _this3 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var batchSize = this.batchSize(builder.knex());</span>
<span class="cstat-no" title="statement not covered" >    var modelBatches = (0, _chunk2.default)(models, batchSize);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _bluebird2.default.map(modelBatches, <span class="fstat-no" title="function not covered" >function (batch) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _this3.fetchRelationBatch(builder, batch, relation, childExpression);</span>
    }).then(_flatten2.default);
  };
&nbsp;
  WhereInEagerOperation.prototype.fetchRelationBatch = <span class="fstat-no" title="function not covered" >function fetchRelationBatch(builder, models, relation, childExpression) {</span>
<span class="cstat-no" title="statement not covered" >    var queryBuilder = relation.ownerModelClass.RelatedQueryBuilder.forClass(relation.relatedModelClass).childQueryOf(builder).eager(childExpression);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var findOperation = relation.find(queryBuilder, models);</span>
<span class="cstat-no" title="statement not covered" >    findOperation.alwaysReturnArray = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    queryBuilder.callQueryBuilderOperation(findOperation, []);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = childExpression.args.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var filterName = childExpression.args[i];</span>
<span class="cstat-no" title="statement not covered" >      var filter = childExpression.filters[filterName];</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      filter(queryBuilder);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return queryBuilder;</span>
  };
&nbsp;
