...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/whereInComposite/WhereInCompositeOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/whereInComposite/WhereInCompositeOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/queryBuilder/operations/whereInComposite/</a> &#187; WhereInCompositeOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function WhereInCompositeOperation() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, WhereInCompositeOperation);</span>
<span class="cstat-no" title="statement not covered" >    return (0, _possibleConstructorReturn3.default)(this, _WrappingQueryBuilder.apply(this, arguments));</span>
  }
&nbsp;
  WhereInCompositeOperation.prototype.onBuild = <span class="fstat-no" title="function not covered" >function onBuild(knexBuilder) {</span>
<span class="cstat-no" title="statement not covered" >    this.build(knexBuilder, this.args[0], this.args[1]);</span>
  };
&nbsp;
  WhereInCompositeOperation.prototype.build = <span class="fstat-no" title="function not covered" >function build(knexBuilder, columns, values) {</span>
<span class="cstat-no" title="statement not covered" >    var isCompositeKey = Array.isArray(columns) &amp;&amp; columns.length &gt; 1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (isCompositeKey) {</span>
<span class="cstat-no" title="statement not covered" >      this.buildComposite(knexBuilder, columns, values);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.buildNonComposite(knexBuilder, columns, values);</span>
    }
  };
&nbsp;
  WhereInCompositeOperation.prototype.buildComposite = <span class="fstat-no" title="function not covered" >function buildComposite(knexBuilder, columns, values) {</span>
<span class="cstat-no" title="statement not covered" >    if (Array.isArray(values)) {</span>
<span class="cstat-no" title="statement not covered" >      this.buildCompositeValue(knexBuilder, columns, values);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.buildCompositeSubquery(knexBuilder, columns, values);</span>
    }
  };
&nbsp;
  WhereInCompositeOperation.prototype.buildCompositeValue = <span class="fstat-no" title="function not covered" >function buildCompositeValue(knexBuilder, columns, values) {</span>
<span class="cstat-no" title="statement not covered" >    knexBuilder.whereIn(columns, values);</span>
  };
&nbsp;
  WhereInCompositeOperation.prototype.buildCompositeSubquery = <span class="fstat-no" title="function not covered" >function buildCompositeSubquery(knexBuilder, columns, subquery) {</span>
<span class="cstat-no" title="statement not covered" >    var formatter = knexBuilder.client.formatter();</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      sql += formatter.wrap(columns[i]);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (i !== columns.length - 1) {</span>
<span class="cstat-no" title="statement not covered" >        sql += ',';</span>
      }
    }
<span class="cstat-no" title="statement not covered" >    sql += ')';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    knexBuilder.whereIn(knexBuilder.client.raw(sql), subquery);</span>
  };
&nbsp;
  WhereInCompositeOperation.prototype.buildNonComposite = <span class="fstat-no" title="function not covered" >function buildNonComposite(knexBuilder, columns, values) {</span>
<span class="cstat-no" title="statement not covered" >    var col = typeof columns === 'string' ? columns : columns[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Array.isArray(values)) {</span>
<span class="cstat-no" title="statement not covered" >      values = pickNonNull(values, []);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      values = [values];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    knexBuilder.whereIn(col, values);</span>
  };
&nbsp;
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function pickNonNull(values, output) {</span>
...
<span class="cstat-no" title="statement not covered" >      pickNonNull(val, output);</span>
    } else <span class="cstat-no" title="statement not covered" >if (val !== null &amp;&amp; val !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >      output.push(val);</span>
    }
  }
&nbsp;
