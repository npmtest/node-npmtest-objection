...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/Relation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/Relation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">27.88% <small>(75 / 269)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">10.34% <small>(12 / 116)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">19.51% <small>(8 / 41)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">27.61% <small>(74 / 268)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric">3 statements, 3 functions</span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/</a> &#187; Relation.js</div>
</div>
<div class="body">
...
734
735
736</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="fstat-no" title="function not covered" >  function Relation(relationName, OwnerClass) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, Relation);</span>
&nbsp;
    /**
     * @type {string}
     */
<span class="cstat-no" title="statement not covered" >    this.name = relationName;</span>
&nbsp;
    /**
     * @type {Constructor.&lt;Model&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this.ownerModelClass = OwnerClass;</span>
&nbsp;
    /**
     * @type {Constructor.&lt;Model&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this.relatedModelClass = null;</span>
&nbsp;
    /**
     * @type {Constructor.&lt;Model&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this._joinTableModelClass = null;</span>
&nbsp;
    /**
     * @type {Array.&lt;string&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this.ownerCol = null;</span>
&nbsp;
    /**
     * @type {Array.&lt;string&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this.ownerProp = null;</span>
&nbsp;
    /**
     * @type {Array.&lt;string&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this.relatedCol = null;</span>
&nbsp;
    /**
     * @type {Array.&lt;string&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this.relatedProp = null;</span>
&nbsp;
    /**
     * @type {string}
     */
<span class="cstat-no" title="statement not covered" >    this.joinTable = null;</span>
&nbsp;
    /**
     * @type {Array.&lt;string&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this.joinTableOwnerCol = null;</span>
&nbsp;
    /**
     * @type {Array.&lt;string&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this.joinTableOwnerProp = null;</span>
&nbsp;
    /**
     * @type {Array.&lt;string&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this.joinTableRelatedCol = null;</span>
&nbsp;
    /**
     * @type {Array.&lt;string&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this.joinTableRelatedProp = null;</span>
&nbsp;
    /**
     * @type {Array.&lt;{joinTableCol: string, joinTableProp: string, aliasCol: string, aliasProp: string}&gt;}
     */
<span class="cstat-no" title="statement not covered" >    this.joinTableExtras = [];</span>
&nbsp;
    /**
     * @type {function (QueryBuilder)}
     */
<span class="cstat-no" title="statement not covered" >    this.modify = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    (0, _hiddenData.init)(this);</span>
  }
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Relation.extend = <span class="fstat-no" title="function not covered" >function extend(subclassConstructor) {</span>
...
&nbsp;
&nbsp;
  Relation.prototype.setMapping = <span class="fstat-no" title="function not covered" >function setMapping(mapping) {</span>
    // Avoid require loop and import here.
<span class="cstat-no" title="statement not covered" >    var Model = require(__dirname + '/../model/Model').default;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!(0, _classUtils.isSubclassOf)(this.ownerModelClass, Model)) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('Relation\'s owner is not a subclass of Model');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!mapping.modelClass) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('modelClass is not defined');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.relatedModelClass = this.resolveModel(Model, mapping.modelClass, 'modelClass');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!mapping.relation) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('relation is not defined');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!(0, _classUtils.isSubclassOf)(mapping.relation, Relation)) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('relation is not a subclass of Relation');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!mapping.join || !mapping.join.from || !mapping.join.to) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('join must be an object that maps the columns of the related models together. For example: {from: "SomeTable.id", to: "SomeOtherTable.someModelId"}');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var joinOwner = null;</span>
<span class="cstat-no" title="statement not covered" >    var joinRelated = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var joinFrom = this.parseReference(mapping.join.from);</span>
<span class="cstat-no" title="statement not covered" >    var joinTo = this.parseReference(mapping.join.to);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!joinFrom.table || _lodash2.default.isEmpty(joinFrom.columns)) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('join.from must have format TableName.columnName. For example "SomeTable.id" or in case of composite key ["SomeTable.a", "SomeTable.b"].');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!joinTo.table || _lodash2.default.isEmpty(joinTo.columns)) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('join.to must have format TableName.columnName. For example "SomeTable.id" or in case of composite key ["SomeTable.a", "SomeTable.b"].');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (joinFrom.table === this.ownerModelClass.tableName) {</span>
<span class="cstat-no" title="statement not covered" >      joinOwner = joinFrom;</span>
<span class="cstat-no" title="statement not covered" >      joinRelated = joinTo;</span>
    } else <span class="cstat-no" title="statement not covered" >if (joinTo.table === this.ownerModelClass.tableName) {</span>
<span class="cstat-no" title="statement not covered" >      joinOwner = joinTo;</span>
<span class="cstat-no" title="statement not covered" >      joinRelated = joinFrom;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.throwError('join: either `from` or `to` must point to the owner model table.');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (joinRelated.table !== this.relatedModelClass.tableName) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('join: either `from` or `to` must point to the related model table.');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.ownerCol = joinOwner.columns;</span>
<span class="cstat-no" title="statement not covered" >    this.ownerProp = this.propertyName(this.ownerCol, this.ownerModelClass);</span>
<span class="cstat-no" title="statement not covered" >    this.relatedCol = joinRelated.columns;</span>
<span class="cstat-no" title="statement not covered" >    this.relatedProp = this.propertyName(this.relatedCol, this.relatedModelClass);</span>
<span class="cstat-no" title="statement not covered" >    this.modify = this.parseModify(mapping);</span>
  };
&nbsp;
  /**
   * @return {boolean}
...
&nbsp;
&nbsp;
  Relation.prototype.isOneToOne = <span class="fstat-no" title="function not covered" >function isOneToOne() {</span>
...
&nbsp;
&nbsp;
  Relation.prototype.joinTableModelClass = <span class="fstat-no" title="function not covered" >function joinTableModelClass(knex) {</span>
<span class="cstat-no" title="statement not covered" >    if (knex &amp;&amp; knex !== this._joinTableModelClass.knex()) {</span>
<span class="cstat-no" title="statement not covered" >      return this._joinTableModelClass.bindKnex(knex);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return this._joinTableModelClass;</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Relation.prototype.fullRelatedCol = <span class="fstat-no" title="function not covered" >function fullRelatedCol() {</span>
<span class="cstat-no" title="statement not covered" >    var _this = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.relatedCol.map(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _this.relatedModelClass.tableName + '.' + col;</span>
    });
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Relation.prototype.fullOwnerCol = <span class="fstat-no" title="function not covered" >function fullOwnerCol() {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.ownerCol.map(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _this2.ownerModelClass.tableName + '.' + col;</span>
    });
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Relation.prototype.relatedTableAlias = <span class="fstat-no" title="function not covered" >function relatedTableAlias() {</span>
<span class="cstat-no" title="statement not covered" >    return this.relatedModelClass.tableName + '_rel_' + this.name;</span>
  };
&nbsp;
  /**
   * @returns {Relation}
...
&nbsp;
&nbsp;
  Relation.prototype.clone = <span class="fstat-no" title="function not covered" >function clone() {</span>
<span class="cstat-no" title="statement not covered" >    var relation = new this.constructor(this.name, this.ownerModelClass);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    relation.relatedModelClass = this.relatedModelClass;</span>
<span class="cstat-no" title="statement not covered" >    relation.ownerCol = this.ownerCol;</span>
<span class="cstat-no" title="statement not covered" >    relation.ownerProp = this.ownerProp;</span>
<span class="cstat-no" title="statement not covered" >    relation.relatedCol = this.relatedCol;</span>
<span class="cstat-no" title="statement not covered" >    relation.relatedProp = this.relatedProp;</span>
<span class="cstat-no" title="statement not covered" >    relation.modify = this.modify;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    relation._joinTableModelClass = this._joinTableModelClass;</span>
<span class="cstat-no" title="statement not covered" >    relation.joinTable = this.joinTable;</span>
<span class="cstat-no" title="statement not covered" >    relation.joinTableOwnerCol = this.joinTableOwnerCol;</span>
<span class="cstat-no" title="statement not covered" >    relation.joinTableOwnerProp = this.joinTableOwnerProp;</span>
<span class="cstat-no" title="statement not covered" >    relation.joinTableRelatedCol = this.joinTableRelatedCol;</span>
<span class="cstat-no" title="statement not covered" >    relation.joinTableRelatedProp = this.joinTableRelatedProp;</span>
<span class="cstat-no" title="statement not covered" >    relation.joinTableExtras = this.joinTableExtras;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    (0, _hiddenData.copyHiddenData)(this, relation);</span>
&nbsp;
...
&nbsp;
&nbsp;
  Relation.prototype.bindKnex = <span class="fstat-no" title="function not covered" >function bindKnex(knex) {</span>
<span class="cstat-no" title="statement not covered" >    var bound = this.clone();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    bound.relatedModelClass = this.relatedModelClass.bindKnex(knex);</span>
<span class="cstat-no" title="statement not covered" >    bound.ownerModelClass = this.ownerModelClass.bindKnex(knex);</span>
&nbsp;
...
&nbsp;
&nbsp;
  Relation.prototype.findQuery = <span class="fstat-no" title="function not covered" >function findQuery(builder, opt) {</span>
<span class="cstat-no" title="statement not covered" >    var fullRelatedCol = this.fullRelatedCol();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (opt.isColumnRef) {</span>
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = fullRelatedCol.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        builder.whereRef(fullRelatedCol[i], opt.ownerIds[i]);</span>
      }
    } else <span class="cstat-no" title="statement not covered" >if (containsNonNull(opt.ownerIds)) {</span>
<span class="cstat-no" title="statement not covered" >      builder.whereInComposite(fullRelatedCol, opt.ownerIds);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      builder.resolve([]);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return builder.modify(this.modify);</span>
  };
&nbsp;
  /**
   * @param {QueryBuilder} builder
...
&nbsp;
&nbsp;
  Relation.prototype.join = <span class="fstat-no" title="function not covered" >function join(builder, opt) {</span>
<span class="cstat-no" title="statement not covered" >    opt = opt || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    opt.joinOperation = opt.joinOperation || 'join';</span>
<span class="cstat-no" title="statement not covered" >    opt.relatedTableAlias = opt.relatedTableAlias || this.relatedTableAlias();</span>
<span class="cstat-no" title="statement not covered" >    opt.relatedJoinSelectQuery = opt.relatedJoinSelectQuery || this.relatedModelClass.query().childQueryOf(builder);</span>
<span class="cstat-no" title="statement not covered" >    opt.relatedTable = opt.relatedTable || this.relatedModelClass.tableName;</span>
<span class="cstat-no" title="statement not covered" >    opt.ownerTable = opt.ownerTable || this.ownerModelClass.tableName;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var relatedCol = this.relatedCol.map(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >      return opt.relatedTableAlias + '.' + col;</span>
    });
<span class="cstat-no" title="statement not covered" >    var ownerCol = this.ownerCol.map(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >      return opt.ownerTable + '.' + col;</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    var relatedSelect = opt.relatedJoinSelectQuery.modify(this.modify).as(opt.relatedTableAlias);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (relatedSelect.isSelectAll()) {</span>
      // No need to join a subquery if the query is `select * from "RelatedTable"`.
<span class="cstat-no" title="statement not covered" >      relatedSelect = this.relatedModelClass.tableName + ' as ' + opt.relatedTableAlias;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return builder[opt.joinOperation](relatedSelect, <span class="fstat-no" title="function not covered" >function (join) {</span></span>
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = relatedCol.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        join.on(relatedCol[i], '=', ownerCol[i]);</span>
      }
    });
  };
&nbsp;
...
&nbsp;
&nbsp;
  Relation.prototype.insert = <span class="fstat-skip" title="function not covered" >function insert(builder, owner) {</span>
<span class="cstat-skip" title="statement not covered" >    this.throwError('not implemented');</span>
  };
&nbsp;
  /**
   * @param {QueryBuilder} builder
...
&nbsp;
&nbsp;
  Relation.prototype.update = <span class="fstat-no" title="function not covered" >function update(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    return new _RelationUpdateOperation2.default('update', {</span>
      relation: this,
      owner: owner
    });
  };
...
&nbsp;
&nbsp;
  Relation.prototype.patch = <span class="fstat-no" title="function not covered" >function patch(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    return new _RelationUpdateOperation2.default('patch', {</span>
      relation: this,
      owner: owner,
...
&nbsp;
&nbsp;
  Relation.prototype.find = <span class="fstat-no" title="function not covered" >function find(builder, owners) {</span>
<span class="cstat-no" title="statement not covered" >    return new _RelationFindOperation2.default('find', {</span>
      relation: this,
      owners: owners
    });
  };
...
&nbsp;
&nbsp;
  Relation.prototype.delete = <span class="fstat-no" title="function not covered" >function _delete(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    return new _RelationDeleteOperation2.default('delete', {</span>
      relation: this,
      owner: owner
    });
  };
...
&nbsp;
&nbsp;
  Relation.prototype.relate = <span class="fstat-skip" title="function not covered" >function relate(builder, owner) {</span>
<span class="cstat-skip" title="statement not covered" >    this.throwError('not implemented');</span>
  };
&nbsp;
  /* istanbul ignore next */
...
&nbsp;
&nbsp;
  Relation.prototype.unrelate = <span class="fstat-skip" title="function not covered" >function unrelate(builder, owner) {</span>
<span class="cstat-skip" title="statement not covered" >    this.throwError('not implemented');</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Relation.prototype.propertyName = <span class="fstat-no" title="function not covered" >function propertyName(columns, modelClass) {</span>
<span class="cstat-no" title="statement not covered" >    var _this3 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return columns.map(<span class="fstat-no" title="function not covered" >function (column) {</span></span>
<span class="cstat-no" title="statement not covered" >      var propertyName = modelClass.columnNameToPropertyName(column);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!propertyName) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(modelClass.name + '.$parseDatabaseJson probably transforms the value of the column ' + column + '.' + ' This is a no-no because ' + column + ' is needed in the relation ' + _this3.ownerModelClass.tableName + '.' + _this3.name);</span>
      }
&nbsp;
...
&nbsp;
&nbsp;
  Relation.prototype.parseModify = <span class="fstat-no" title="function not covered" >function parseModify(mapping) {</span>
<span class="cstat-no" title="statement not covered" >    var modify = mapping.modify || mapping.filter;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (_lodash2.default.isFunction(modify)) {</span>
<span class="cstat-no" title="statement not covered" >      return modify;</span>
    } else <span class="cstat-no" title="statement not covered" >if (_lodash2.default.isObject(modify)) {</span>
<span class="cstat-no" title="statement not covered" >      return <span class="fstat-no" title="function not covered" >function (queryBuilder) {</span></span>
<span class="cstat-no" title="statement not covered" >        queryBuilder.where(modify);</span>
      };
    } else {
<span class="cstat-no" title="statement not covered" >      return _lodash2.default.noop;</span>
    }
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  Relation.prototype.parseReference = <span class="fstat-no" title="function not covered" >function parseReference(ref) {</span>
<span class="cstat-no" title="statement not covered" >    if (!_lodash2.default.isArray(ref)) {</span>
<span class="cstat-no" title="statement not covered" >      ref = [ref];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var table = null;</span>
<span class="cstat-no" title="statement not covered" >    var columns = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; ref.length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var refItem = ref[i];</span>
<span class="cstat-no" title="statement not covered" >      var ndx = refItem.lastIndexOf('.');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var tableName = refItem.substr(0, ndx).trim();</span>
<span class="cstat-no" title="statement not covered" >      var columnName = refItem.substr(ndx + 1, refItem.length).trim();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!tableName || table &amp;&amp; table !== tableName || !columnName) {</span>
<span class="cstat-no" title="statement not covered" >        return {</span>
          table: null,
          columns: []
        };
      } else {
<span class="cstat-no" title="statement not covered" >        table = tableName;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      columns.push(columnName);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return {</span>
      table: table,
...
&nbsp;
&nbsp;
  Relation.prototype.mergeModels = <span class="fstat-no" title="function not covered" >function mergeModels(models1, models2) {</span>
<span class="cstat-no" title="statement not covered" >    var modelClass = void 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    models1 = _lodash2.default.compact(models1);</span>
<span class="cstat-no" title="statement not covered" >    models2 = _lodash2.default.compact(models2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (_lodash2.default.isEmpty(models1) &amp;&amp; _lodash2.default.isEmpty(models2)) {</span>
<span class="cstat-no" title="statement not covered" >      return [];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!_lodash2.default.isEmpty(models1)) {</span>
<span class="cstat-no" title="statement not covered" >      modelClass = models1[0].constructor;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      modelClass = models2[0].constructor;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var idProperty = modelClass.getIdPropertyArray();</span>
<span class="cstat-no" title="statement not covered" >    var modelsById = (0, _create2.default)(null);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = models1.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var model = models1[i];</span>
<span class="cstat-no" title="statement not covered" >      var key = model.$propKey(idProperty);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      modelsById[key] = model;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var _i = 0, _l = models2.length; _i &lt; _l; ++_i) {</span>
<span class="cstat-no" title="statement not covered" >      var _model = models2[_i];</span>
<span class="cstat-no" title="statement not covered" >      var _key = _model.$propKey(idProperty);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      modelsById[_key] = _model;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _lodash2.default.sortBy(_lodash2.default.values(modelsById), idProperty);</span>
  };
&nbsp;
  /**
   * @protected
...
&nbsp;
&nbsp;
  Relation.prototype.resolveModel = <span class="fstat-no" title="function not covered" >function resolveModel(Model, modelClass, logPrefix) {</span>
<span class="cstat-no" title="statement not covered" >    var requireModel = <span class="fstat-no" title="function not covered" >function requireModel(path) {</span></span>
<span class="cstat-no" title="statement not covered" >      var ModelClass = void 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      try {</span>
        // babel 6 style of exposing es6 exports to commonjs https://github.com/babel/babel/issues/2683
<span class="cstat-no" title="statement not covered" >        var module = require(path);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        ModelClass = (0, _classUtils.isSubclassOf)(module.default, Model) ? module.default : module;</span>
      } catch (err) {
<span class="cstat-no" title="statement not covered" >        return null;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!(0, _classUtils.isSubclassOf)(ModelClass, Model)) {</span>
<span class="cstat-no" title="statement not covered" >        return null;</span>
      }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (_lodash2.default.isString(modelClass)) {</span>
<span class="cstat-no" title="statement not covered" >      var ModelClass = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (isAbsolutePath(modelClass)) {</span>
<span class="cstat-no" title="statement not covered" >        ModelClass = requireModel(modelClass);</span>
      } else {
        // If the path is not a absolute, try the modelPaths of the owner model class.
<span class="cstat-no" title="statement not covered" >        _lodash2.default.each(this.ownerModelClass.modelPaths, <span class="fstat-no" title="function not covered" >function (modelPath) {</span></span>
<span class="cstat-no" title="statement not covered" >          ModelClass = requireModel(_path2.default.join(modelPath, modelClass));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if ((0, _classUtils.isSubclassOf)(ModelClass, Model)) {</span>
            // Break the loop.
<span class="cstat-no" title="statement not covered" >            return false;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!(0, _classUtils.isSubclassOf)(ModelClass, Model)) {</span>
<span class="cstat-no" title="statement not covered" >        this.throwError(logPrefix + ': ' + modelClass + ' is an invalid file path to a model class');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return ModelClass;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      if (!(0, _classUtils.isSubclassOf)(modelClass, Model)) {</span>
<span class="cstat-no" title="statement not covered" >        this.throwError(logPrefix + ' is not a subclass of Model or a file path to a module that exports one.');</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return modelClass;</span>
    }
...
&nbsp;
&nbsp;
  Relation.prototype.throwError = <span class="fstat-no" title="function not covered" >function throwError(message) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.ownerModelClass &amp;&amp; this.ownerModelClass.name &amp;&amp; this.name) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(this.ownerModelClass.name + '.relationMappings.' + this.name + ': ' + message);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error(this.constructor.name + ': ' + message);</span>
    }
  };
&nbsp;
  return Relation;
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function isAbsolutePath(pth) {</span>
<span class="cstat-no" title="statement not covered" >  return _path2.default.normalize(pth + '/') === _path2.default.normalize(_path2.default.resolve(pth) + '/');</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function containsNonNull(arr) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Array.isArray(val) &amp;&amp; containsNonNull(val)) {</span>
<span class="cstat-no" title="statement not covered" >      return true;</span>
    } else <span class="cstat-no" title="statement not covered" >if (val !== null &amp;&amp; val !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >      return true;</span>
    }
  }
&nbsp;
