...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/ManyToManyRelateOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/ManyToManyRelateOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/</a> &#187; ManyToManyRelateOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ManyToManyRelateOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, ManyToManyRelateOperation);</span>
&nbsp;
...
&nbsp;
  ManyToManyRelateOperation.prototype.call = <span class="fstat-no" title="function not covered" >function call(builder, args) {</span>
<span class="cstat-no" title="statement not covered" >    this.input = args[0];</span>
<span class="cstat-no" title="statement not covered" >    this.ids = (0, _normalizeIds2.default)(args[0], this.relation.relatedProp);</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  };
&nbsp;
  ManyToManyRelateOperation.prototype.queryExecutor = <span class="fstat-no" title="function not covered" >function queryExecutor(builder) {</span>
<span class="cstat-no" title="statement not covered" >    var joinModels = this.relation.createJoinModels(this.owner.$values(this.relation.ownerProp), this.ids);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.relation.joinTableModelClass(builder.knex()).query().childQueryOf(builder).insert(joinModels);</span>
  };
&nbsp;
  ManyToManyRelateOperation.prototype.onAfterInternal = <span class="fstat-no" title="function not covered" >function onAfterInternal() {</span>
