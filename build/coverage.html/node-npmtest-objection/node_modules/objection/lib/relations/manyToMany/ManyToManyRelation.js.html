...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/ManyToManyRelation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/ManyToManyRelation.js</span></h1>
    <h2>
        
        Statements: <span class="metric">35.81% <small>(82 / 229)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">35.53% <small>(81 / 228)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/</a> &#187; ManyToManyRelation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ManyToManyRelation() {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, ManyToManyRelation);</span>
<span class="cstat-no" title="statement not covered" >    return (0, _possibleConstructorReturn3.default)(this, _Relation.apply(this, arguments));</span>
  }
&nbsp;
  ManyToManyRelation.prototype.setMapping = <span class="fstat-no" title="function not covered" >function setMapping(mapping) {</span>
<span class="cstat-no" title="statement not covered" >    var retVal = _Relation.prototype.setMapping.call(this, mapping);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!_lodash2.default.isObject(mapping.join.through)) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('join must have the `through` that describes the join table.');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!mapping.join.through.from || !mapping.join.through.to) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('join.through must be an object that describes the join table. For example: {from: "JoinTable.someId", to: "JoinTable.someOtherId"}');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var joinFrom = this.parseReference(mapping.join.from);</span>
<span class="cstat-no" title="statement not covered" >    var joinTableFrom = this.parseReference(mapping.join.through.from);</span>
<span class="cstat-no" title="statement not covered" >    var joinTableTo = this.parseReference(mapping.join.through.to);</span>
<span class="cstat-no" title="statement not covered" >    var joinTableExtra = mapping.join.through.extra || [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!joinTableFrom.table || _lodash2.default.isEmpty(joinTableFrom.columns)) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('join.through.from must have format JoinTable.columnName. For example "JoinTable.someId" or in case of composite key ["JoinTable.a", "JoinTable.b"].');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!joinTableTo.table || _lodash2.default.isEmpty(joinTableTo.columns)) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('join.through.to must have format JoinTable.columnName. For example "JoinTable.someId" or in case of composite key ["JoinTable.a", "JoinTable.b"].');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (joinTableFrom.table !== joinTableTo.table) {</span>
<span class="cstat-no" title="statement not covered" >      this.throwError('join.through `from` and `to` must point to the same join table.');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.joinTable = joinTableFrom.table;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (joinFrom.table === this.ownerModelClass.tableName) {</span>
<span class="cstat-no" title="statement not covered" >      this.joinTableOwnerCol = joinTableFrom.columns;</span>
<span class="cstat-no" title="statement not covered" >      this.joinTableRelatedCol = joinTableTo.columns;</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this.joinTableRelatedCol = joinTableFrom.columns;</span>
<span class="cstat-no" title="statement not covered" >      this.joinTableOwnerCol = joinTableTo.columns;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (mapping.join.through.modelClass) {</span>
<span class="cstat-no" title="statement not covered" >      this._joinTableModelClass = this.resolveModel(Model, mapping.join.through.modelClass, 'join.through.modelClass');</span>
    } else {
<span class="cstat-no" title="statement not covered" >      this._joinTableModelClass = (0, _inheritModel2.default)(Model);</span>
<span class="cstat-no" title="statement not covered" >      this._joinTableModelClass.tableName = this.joinTable;</span>
...
<span class="cstat-no" title="statement not covered" >      this._joinTableModelClass.idColumn = this.joinTableRelatedCol;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.joinTableOwnerProp = this.propertyName(this.joinTableOwnerCol, this._joinTableModelClass);</span>
<span class="cstat-no" title="statement not covered" >    this.joinTableRelatedProp = this.propertyName(this.joinTableRelatedCol, this._joinTableModelClass);</span>
<span class="cstat-no" title="statement not covered" >    this.joinTableExtras = this.parseExtras(joinTableExtra);</span>
&nbsp;
...
&nbsp;
&nbsp;
  ManyToManyRelation.prototype.fullJoinTableOwnerCol = <span class="fstat-no" title="function not covered" >function fullJoinTableOwnerCol() {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.joinTableOwnerCol.map(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _this2.joinTable + '.' + col;</span>
    });
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  ManyToManyRelation.prototype.fullJoinTableRelatedCol = <span class="fstat-no" title="function not covered" >function fullJoinTableRelatedCol() {</span>
<span class="cstat-no" title="statement not covered" >    var _this3 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.joinTableRelatedCol.map(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _this3.joinTable + '.' + col;</span>
    });
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  ManyToManyRelation.prototype.joinTableAlias = <span class="fstat-no" title="function not covered" >function joinTableAlias() {</span>
<span class="cstat-no" title="statement not covered" >    return this.joinTable + '_rel_' + this.name;</span>
  };
&nbsp;
  /**
...
&nbsp;
&nbsp;
  ManyToManyRelation.prototype.bindKnex = <span class="fstat-no" title="function not covered" >function bindKnex(knex) {</span>
<span class="cstat-no" title="statement not covered" >    var bound = _Relation.prototype.bindKnex.call(this, knex);</span>
<span class="cstat-no" title="statement not covered" >    bound._joinTableModelClass = this._joinTableModelClass.bindKnex(knex);</span>
...
&nbsp;
&nbsp;
  ManyToManyRelation.prototype.findQuery = <span class="fstat-no" title="function not covered" >function findQuery(builder, opt) {</span>
<span class="cstat-no" title="statement not covered" >    var _this4 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    builder.join(this.joinTable, <span class="fstat-no" title="function not covered" >function (join) {</span></span>
<span class="cstat-no" title="statement not covered" >      var fullRelatedCol = _this4.fullRelatedCol();</span>
<span class="cstat-no" title="statement not covered" >      var fullJoinTableRelatedCol = _this4.fullJoinTableRelatedCol();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = fullJoinTableRelatedCol.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        join.on(fullJoinTableRelatedCol[i], fullRelatedCol[i]);</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (opt.isColumnRef) {</span>
<span class="cstat-no" title="statement not covered" >      var fullJoinTableOwnerCol = this.fullJoinTableOwnerCol();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = fullJoinTableOwnerCol.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        builder.whereRef(fullJoinTableOwnerCol[i], opt.ownerIds[i]);</span>
      }
    } else {
<span class="cstat-no" title="statement not covered" >      var hasIds = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var _i = 0, _l = opt.ownerIds.length; _i &lt; _l; ++_i) {</span>
<span class="cstat-no" title="statement not covered" >        var id = opt.ownerIds[_i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (id) {</span>
<span class="cstat-no" title="statement not covered" >          hasIds = true;</span>
<span class="cstat-no" title="statement not covered" >          break;</span>
        }
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (hasIds) {</span>
<span class="cstat-no" title="statement not covered" >        builder.whereInComposite(this.fullJoinTableOwnerCol(), opt.ownerIds);</span>
      } else {
...
&nbsp;
&nbsp;
  ManyToManyRelation.prototype.join = <span class="fstat-no" title="function not covered" >function join(builder, opt) {</span>
...
<span class="cstat-no" title="statement not covered" >    opt.joinTableAlias = opt.joinTableAlias || opt.relatedTableAlias + '_join';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var joinTableAsAlias = this.joinTable + ' as ' + opt.joinTableAlias;</span>
<span class="cstat-no" title="statement not covered" >    var joinTableOwnerCol = this.joinTableOwnerCol.map(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >      return opt.joinTableAlias + '.' + col;</span>
    });
<span class="cstat-no" title="statement not covered" >    var joinTableRelatedCol = this.joinTableRelatedCol.map(<span class="fstat-no" title="function not covered" >function (col) {</span></span>
<span class="cstat-no" title="statement not covered" >      return opt.joinTableAlias + '.' + col;</span>
    });
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var relatedJoinSelect = opt.relatedJoinSelectQuery.modify(this.modify).as(opt.relatedTableAlias);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (relatedJoinSelect.isSelectAll()) {</span>
      // No need to join a subquery if the query is `select * from "RelatedTable"`.
<span class="cstat-no" title="statement not covered" >      relatedJoinSelect = this.relatedModelClass.tableName + ' as ' + opt.relatedTableAlias;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return builder[opt.joinOperation](joinTableAsAlias, <span class="fstat-no" title="function not covered" >function (join) {</span></span>
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = joinTableOwnerCol.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        join.on(joinTableOwnerCol[i], ownerCol[i]);</span>
      }
    })[opt.joinOperation](relatedJoinSelect, <span class="fstat-no" title="function not covered" >function (join) {</span>
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = joinTableRelatedCol.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        join.on(joinTableRelatedCol[i], relatedCol[i]);</span>
      }
    });
  };
&nbsp;
  ManyToManyRelation.prototype.find = <span class="fstat-no" title="function not covered" >function find(builder, owners) {</span>
<span class="cstat-no" title="statement not covered" >    return new _ManyToManyFindOperation2.default('find', {</span>
      relation: this,
      owners: owners
    });
  };
&nbsp;
  ManyToManyRelation.prototype.insert = <span class="fstat-no" title="function not covered" >function insert(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    return new _ManyToManyInsertOperation2.default('insert', {</span>
      relation: this,
      owner: owner
    });
  };
&nbsp;
  ManyToManyRelation.prototype.update = <span class="fstat-no" title="function not covered" >function update(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    if ((0, _knexUtils.isSqlite)(builder.knex())) {</span>
<span class="cstat-no" title="statement not covered" >      return new _ManyToManyUpdateSqliteOperation2.default('update', {</span>
        relation: this,
        owner: owner
      });
    } else {
<span class="cstat-no" title="statement not covered" >      return new _ManyToManyUpdateOperation2.default('update', {</span>
        relation: this,
        owner: owner
      });
    }
...
&nbsp;
  ManyToManyRelation.prototype.patch = <span class="fstat-no" title="function not covered" >function patch(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    if ((0, _knexUtils.isSqlite)(builder.knex())) {</span>
<span class="cstat-no" title="statement not covered" >      return new _ManyToManyUpdateSqliteOperation2.default('patch', {</span>
        relation: this,
        owner: owner,
        modelOptions: { patch: true }
      });
    } else {
<span class="cstat-no" title="statement not covered" >      return new _ManyToManyUpdateOperation2.default('patch', {</span>
        relation: this,
        owner: owner,
        modelOptions: { patch: true }
      });
...
&nbsp;
  ManyToManyRelation.prototype.delete = <span class="fstat-no" title="function not covered" >function _delete(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    if ((0, _knexUtils.isSqlite)(builder.knex())) {</span>
<span class="cstat-no" title="statement not covered" >      return new _ManyToManyDeleteSqliteOperation2.default('delete', {</span>
        relation: this,
        owner: owner
      });
    } else {
<span class="cstat-no" title="statement not covered" >      return new _ManyToManyDeleteOperation2.default('delete', {</span>
        relation: this,
        owner: owner
      });
    }
...
&nbsp;
  ManyToManyRelation.prototype.relate = <span class="fstat-no" title="function not covered" >function relate(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    return new _ManyToManyRelateOperation2.default('relate', {</span>
      relation: this,
      owner: owner
    });
  };
&nbsp;
  ManyToManyRelation.prototype.unrelate = <span class="fstat-no" title="function not covered" >function unrelate(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    if ((0, _knexUtils.isSqlite)(builder.knex())) {</span>
<span class="cstat-no" title="statement not covered" >      return new _ManyToManyUnrelateSqliteOperation2.default('unrelate', {</span>
        relation: this,
        owner: owner
      });
    } else {
<span class="cstat-no" title="statement not covered" >      return new _ManyToManyUnrelateOperation2.default('unrelate', {</span>
        relation: this,
        owner: owner
      });
    }
...
&nbsp;
  ManyToManyRelation.prototype.selectForModify = <span class="fstat-no" title="function not covered" >function selectForModify(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    var ownerId = owner.$values(this.ownerProp);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var idQuery = this.joinTableModelClass(builder.knex()).query().childQueryOf(builder).select(this.fullJoinTableRelatedCol()).whereComposite(this.fullJoinTableOwnerCol(), ownerId);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return builder.whereInComposite(this.fullRelatedCol(), idQuery);</span>
  };
&nbsp;
  ManyToManyRelation.prototype.selectForModifySqlite = <span class="fstat-no" title="function not covered" >function selectForModifySqlite(builder, owner) {</span>
<span class="cstat-no" title="statement not covered" >    var _this5 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var relatedTable = this.relatedModelClass.tableName;</span>
<span class="cstat-no" title="statement not covered" >    var relatedTableAlias = this.relatedTableAlias();</span>
<span class="cstat-no" title="statement not covered" >    var relatedTableAsAlias = relatedTable + ' as ' + relatedTableAlias;</span>
<span class="cstat-no" title="statement not covered" >    var relatedTableAliasRowId = relatedTableAlias + '.' + sqliteBuiltInRowId;</span>
<span class="cstat-no" title="statement not covered" >    var relatedTableRowId = relatedTable + '.' + sqliteBuiltInRowId;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var selectRelatedQuery = this.joinTableModelClass(builder.knex()).query().childQueryOf(builder).select(relatedTableAliasRowId).whereComposite(this.fullJoinTableOwnerCol(), owner.$values(this.ownerProp)).join(relatedTableAsAlias, <span class="fstat-no" title="function not covered" >function (join) {</span></span>
<span class="cstat-no" title="statement not covered" >      var fullJoinTableRelatedCols = _this5.fullJoinTableRelatedCol();</span>
<span class="cstat-no" title="statement not covered" >      var fullRelatedCol = _this5.fullRelatedCol();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = fullJoinTableRelatedCols.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        join.on(fullJoinTableRelatedCols[i], fullRelatedCol[i]);</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return builder.whereInComposite(relatedTableRowId, selectRelatedQuery);</span>
  };
&nbsp;
  ManyToManyRelation.prototype.createJoinModels = <span class="fstat-no" title="function not covered" >function createJoinModels(ownerId, related) {</span>
<span class="cstat-no" title="statement not covered" >    var joinModels = new Array(related.length);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = 0, lr = related.length; i &lt; lr; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      var rel = related[i];</span>
<span class="cstat-no" title="statement not covered" >      var joinModel = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var j = 0, lp = this.joinTableOwnerProp.length; j &lt; lp; ++j) {</span>
<span class="cstat-no" title="statement not covered" >        joinModel[this.joinTableOwnerProp[j]] = ownerId[j];</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var _j = 0, _lp = this.joinTableRelatedProp.length; _j &lt; _lp; ++_j) {</span>
<span class="cstat-no" title="statement not covered" >        joinModel[this.joinTableRelatedProp[_j]] = rel[this.relatedProp[_j]];</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var _j2 = 0, _lp2 = this.joinTableExtras.length; _j2 &lt; _lp2; ++_j2) {</span>
<span class="cstat-no" title="statement not covered" >        var extra = this.joinTableExtras[_j2];</span>
<span class="cstat-no" title="statement not covered" >        var extraValue = rel[extra.aliasProp];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!_lodash2.default.isUndefined(extraValue)) {</span>
<span class="cstat-no" title="statement not covered" >          joinModel[extra.joinTableProp] = extraValue;</span>
        }
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      joinModels[i] = joinModel;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return joinModels;</span>
  };
&nbsp;
  ManyToManyRelation.prototype.omitExtraProps = <span class="fstat-no" title="function not covered" >function omitExtraProps(models) {</span>
<span class="cstat-no" title="statement not covered" >    if (!_lodash2.default.isEmpty(this.joinTableExtras)) {</span>
<span class="cstat-no" title="statement not covered" >      var props = this.joinTableExtras.map(<span class="fstat-no" title="function not covered" >function (extra) {</span></span>
<span class="cstat-no" title="statement not covered" >        return extra.aliasProp;</span>
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var i = 0, l = models.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >        models[i].$omitFromDatabaseJson(props);</span>
      }
    }
  };
&nbsp;
...
&nbsp;
&nbsp;
  ManyToManyRelation.prototype.parseExtras = <span class="fstat-no" title="function not covered" >function parseExtras(extras) {</span>
<span class="cstat-no" title="statement not covered" >    var _this6 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Array.isArray(extras)) {</span>
<span class="cstat-no" title="statement not covered" >      extras = extras.reduce(<span class="fstat-no" title="function not covered" >function (extras, col) {</span></span>
<span class="cstat-no" title="statement not covered" >        extras[col] = col;</span>
<span class="cstat-no" title="statement not covered" >        return extras;</span>
      }, {});
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return (0, _keys2.default)(extras).map(<span class="fstat-no" title="function not covered" >function (key) {</span></span>
<span class="cstat-no" title="statement not covered" >      var val = extras[key];</span>
&nbsp;
