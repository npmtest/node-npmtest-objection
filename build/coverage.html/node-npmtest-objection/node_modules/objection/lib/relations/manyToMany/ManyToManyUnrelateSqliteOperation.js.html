...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/ManyToManyUnrelateSqliteOperation.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/ManyToManyUnrelateSqliteOperation.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/relations/manyToMany/</a> &#187; ManyToManyUnrelateSqliteOperation.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ManyToManyUnrelateSqliteOperation(name, opt) {</span>
<span class="cstat-no" title="statement not covered" >    (0, _classCallCheck3.default)(this, ManyToManyUnrelateSqliteOperation);</span>
&nbsp;
...
&nbsp;
  ManyToManyUnrelateSqliteOperation.prototype.queryExecutor = <span class="fstat-no" title="function not covered" >function queryExecutor(builder) {</span>
<span class="cstat-no" title="statement not covered" >    var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var joinTableAlias = this.relation.joinTableAlias();</span>
<span class="cstat-no" title="statement not covered" >    var joinTableAsAlias = this.relation.joinTable + ' as ' + joinTableAlias;</span>
<span class="cstat-no" title="statement not covered" >    var joinTableAliasRowId = joinTableAlias + '.' + sqliteBuiltInRowId;</span>
<span class="cstat-no" title="statement not covered" >    var joinTableRowId = this.relation.joinTable + '.' + sqliteBuiltInRowId;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var ownerId = this.owner.$values(this.relation.ownerProp);</span>
<span class="cstat-no" title="statement not covered" >    var fullRelatedCol = this.relation.fullRelatedCol();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var selectRelatedQuery = this.relation.relatedModelClass.query().childQueryOf(builder).copyFrom(builder, /where/i).select(joinTableAliasRowId).modify(this.relation.modify).whereComposite(this.relation.fullJoinTableOwnerCol(), ownerId).join(joinTableAsAlias, <span class="fstat-no" title="function not covered" >function (join) {</span></span>
<span class="cstat-no" title="statement not covered" >      var fullJoinTableRelatedCol = _this2.relation.fullJoinTableRelatedCol();</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.relation.joinTableModelClass(builder.knex()).query().childQueryOf(builder).delete().whereIn(joinTableRowId, selectRelatedQuery).runAfter(_lodash2.default.constant({}));</span>
  };
&nbsp;
