...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/transaction.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/transaction.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/</a> &#187; transaction.js</div>
</div>
<div class="body">
 ...
 * @returns {Promise}
 */
<span class="fstat-no" title="function not covered" >function transaction() {</span>
...
<span class="cstat-no" title="statement not covered" >    return _bluebird2.default.reject(new Error('objection.transaction: provide at least one Model class to bind to the transaction or a knex instance'));</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!(0, _classUtils.isSubclassOf)(args[0], _Model2.default) &amp;&amp; _lodash2.default.isFunction(args[0].transaction)) {</span>
<span class="cstat-no" title="statement not covered" >    var knex = _lodash2.default.first(args);</span>
...
<span class="cstat-no" title="statement not covered" >    if (isGenerator(args[0])) {</span>
<span class="cstat-no" title="statement not covered" >      args[0] = _bluebird2.default.coroutine(args[0]);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return knex.transaction.apply(knex, args);</span>
  } else {
    // The last argument should be the callback and all other Model subclasses.
<span class="cstat-no" title="statement not covered" >    var callback = _lodash2.default.last(args);</span>
<span class="cstat-no" title="statement not covered" >    var modelClasses = _lodash2.default.take(args, args.length - 1);</span>
<span class="cstat-no" title="statement not covered" >    var _i = void 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (_i = 0; _i &lt; modelClasses.length; ++_i) {</span>
<span class="cstat-no" title="statement not covered" >      if (!(0, _classUtils.isSubclassOf)(modelClasses[_i], _Model2.default)) {</span>
<span class="cstat-no" title="statement not covered" >        return _bluebird2.default.reject(new Error('objection.transaction: all but the last argument should be Model subclasses'));</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _knex = _lodash2.default.first(modelClasses).knex();</span>
<span class="cstat-no" title="statement not covered" >    for (_i = 0; _i &lt; modelClasses.length; ++_i) {</span>
<span class="cstat-no" title="statement not covered" >      if (modelClasses[_i].knex() !== _knex) {</span>
<span class="cstat-no" title="statement not covered" >        return _bluebird2.default.reject(new Error('objection.transaction: all Model subclasses must be bound to the same database'));</span>
      }
    }
&nbsp;
    // If the function is a generator, wrap it using Promise.coroutine.
<span class="cstat-no" title="statement not covered" >    if (isGenerator(callback)) {</span>
<span class="cstat-no" title="statement not covered" >      callback = _bluebird2.default.coroutine(callback);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _knex.transaction(<span class="fstat-no" title="function not covered" >function (trx) {</span></span>
<span class="cstat-no" title="statement not covered" >      var args = new Array(modelClasses.length + 1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var _i2 = 0; _i2 &lt; modelClasses.length; ++_i2) {</span>
<span class="cstat-no" title="statement not covered" >        args[_i2] = modelClasses[_i2].bindTransaction(trx);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      args[args.length - 1] = trx;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return callback.apply(trx, args);</span>
      });
    });
  }
}
 ...
 * @returns {Promise}
 */
transaction.start = <span class="fstat-no" title="function not covered" >function (modelClassOrKnex) {</span>
<span class="cstat-no" title="statement not covered" >  var knex = modelClassOrKnex;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if ((0, _classUtils.isSubclassOf)(modelClassOrKnex, _Model2.default)) {</span>
<span class="cstat-no" title="statement not covered" >    knex = modelClassOrKnex.knex();</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!knex || !_lodash2.default.isFunction(knex.transaction)) {</span>
<span class="cstat-no" title="statement not covered" >    return _bluebird2.default.reject(new Error('objection.transaction.start: first argument must be a model class or a knex instance'));</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    knex.transaction(<span class="fstat-no" title="function not covered" >function (trx) {</span></span>
<span class="cstat-no" title="statement not covered" >      resolve(trx);</span>
...
<span class="cstat-no" title="statement not covered" >  return fn &amp;&amp; fn.constructor &amp;&amp; fn.constructor.name === 'GeneratorFunction';</span>
}
