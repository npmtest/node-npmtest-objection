...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/utils/decorators/hiddenData.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/utils/decorators/hiddenData.js</span></h1>
    <h2>
        
        Statements: <span class="metric">65% <small>(26 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/utils/decorators/</a> &#187; hiddenData.js</div>
</div>
<div class="body">
...
&nbsp;
    if ((typeof opt === 'undefined' ? 'undefined' : (0, _typeof3.default)(opt)) === 'object') {
      propName = opt.name || <span class="branch-1 cbranch-no" title="branch not covered" >property;</span>
      append = !!opt.append;
    } else {
...
&nbsp;
    if (typeof descriptor.value === 'function') {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (append) {
        descriptor.value = <span class="fstat-no" title="function not covered" >function decorator$hiddenData() {</span>
<span class="cstat-no" title="statement not covered" >          if (arguments.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >            return get(this);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            return appendSet(this, arguments[0], get, set);</span>
          }
        };
      } else {
<span class="cstat-no" title="statement not covered" >        descriptor.value = <span class="fstat-no" title="function not covered" >function decorator$hiddenData() {</span></span>
<span class="cstat-no" title="statement not covered" >          if (arguments.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >            return get(this);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            set(this, arguments[0]);</span>
          }
        };
      }
    }
&nbsp;
    if (typeof descriptor.get === 'function') {
      descriptor.get = <span class="fstat-no" title="function not covered" >function decorator$hiddenDataGetter() {</span>
<span class="cstat-no" title="statement not covered" >        return get(this);</span>
      };
    }
&nbsp;
    if (typeof descriptor.set === 'function') {
      descriptor.set = <span class="fstat-no" title="function not covered" >function decorator$hiddenDataSetter(value) {</span>
<span class="cstat-no" title="statement not covered" >        return set(this, value);</span>
      };
    }
  };
}
&nbsp;
<span class="fstat-no" title="function not covered" >function appendSet(self, value, get, set) {</span>
<span class="cstat-no" title="statement not covered" >  var data = get(self);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(data) &amp;&amp; Array.isArray(value)) {</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0, l = value.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      data.push(value[i]);</span>
    }
  } else {
<span class="cstat-no" title="statement not covered" >    set(self, value);</span>
  }
}
