...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-objection/node_modules/objection/lib/utils/normalizeIds.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-objection/node_modules/objection/lib/utils/normalizeIds.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-objection/node_modules/objection/lib/utils/</a> &#187; normalizeIds.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function normalizeIds(ids, expectedProperties, opt) {</span>
<span class="cstat-no" title="statement not covered" >  opt = opt || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!_lodash2.default.isArray(expectedProperties)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('expected expectedProperties to be an array, got ' + expectedProperties);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (expectedProperties.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('expectedProperties must not be empty');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var isComposite = expectedProperties.length &gt; 1;</span>
<span class="cstat-no" title="statement not covered" >  var ret = void 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (isComposite) {</span>
...
<span class="cstat-no" title="statement not covered" >        ret = new Array(ids.length);</span>
&nbsp;
        // 3.
<span class="cstat-no" title="statement not covered" >        for (var i = 0, l = ids.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >          ret[i] = convertIdArrayToObject(ids[i], expectedProperties);</span>
        }
      } else <span class="cstat-no" title="statement not covered" >if (_lodash2.default.isObject(ids[0])) {</span>
<span class="cstat-no" title="statement not covered" >        ret = new Array(ids.length);</span>
&nbsp;
        // 4.
<span class="cstat-no" title="statement not covered" >        for (var _i = 0, _l = ids.length; _i &lt; _l; ++_i) {</span>
<span class="cstat-no" title="statement not covered" >          ret[_i] = ensureObject(ids[_i], expectedProperties);</span>
        }
      } else {
        // 1.
<span class="cstat-no" title="statement not covered" >        ret = [convertIdArrayToObject(ids, expectedProperties)];</span>
      }
    } else <span class="cstat-no" title="statement not covered" >if (_lodash2.default.isObject(ids)) {</span>
      // 2.
<span class="cstat-no" title="statement not covered" >      ret = [ids];</span>
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error('invalid composite key ' + (0, _stringify2.default)(ids));</span>
    }
  } else {
    ...
    // 4. [{id: 1}, {id: 'foo'}, {id: 4}]
    //
<span class="cstat-no" title="statement not covered" >    if (_lodash2.default.isArray(ids)) {</span>
<span class="cstat-no" title="statement not covered" >      if (_lodash2.default.isObject(ids[0])) {</span>
<span class="cstat-no" title="statement not covered" >        ret = new Array(ids.length);</span>
&nbsp;
        // 4.
<span class="cstat-no" title="statement not covered" >        for (var _i2 = 0, _l2 = ids.length; _i2 &lt; _l2; ++_i2) {</span>
<span class="cstat-no" title="statement not covered" >          ret[_i2] = ensureObject(ids[_i2]);</span>
        }
      } else {
<span class="cstat-no" title="statement not covered" >        ret = new Array(ids.length);</span>
&nbsp;
        // 3.
<span class="cstat-no" title="statement not covered" >        for (var _i3 = 0, _l3 = ids.length; _i3 &lt; _l3; ++_i3) {</span>
<span class="cstat-no" title="statement not covered" >          ret[_i3] = (0, _defineProperty3.default)({}, expectedProperties[0], ids[_i3]);</span>
        }
      }
    } else <span class="cstat-no" title="statement not covered" >if (_lodash2.default.isObject(ids)) {</span>
      // 2.
<span class="cstat-no" title="statement not covered" >      ret = [ids];</span>
      ...
      // 1.
<span class="cstat-no" title="statement not covered" >      ret = [(0, _defineProperty3.default)({}, expectedProperties[0], ids)];</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  checkProperties(ret, expectedProperties);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (opt.arrayOutput) {</span>
<span class="cstat-no" title="statement not covered" >    return normalizedToArray(ret, expectedProperties);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    return ret;</span>
  }
};
&nbsp;
<span class="fstat-no" title="function not covered" >function convertIdArrayToObject(ids, expectedProperties) {</span>
<span class="cstat-no" title="statement not covered" >  if (!Array.isArray(ids)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('invalid composite key ' + (0, _stringify2.default)(ids));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (ids.length != expectedProperties.length) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('composite identifier ' + (0, _stringify2.default)(ids) + ' should have ' + expectedProperties.length + ' values');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return _lodash2.default.zipObject(expectedProperties, ids);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function ensureObject(ids) {</span>
<span class="cstat-no" title="statement not covered" >  if (_lodash2.default.isObject(ids)) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function checkProperties(ret, expectedProperties) {</span>
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = ret.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var obj = ret[i];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var j = 0, lp = expectedProperties.length; j &lt; lp; ++j) {</span>
<span class="cstat-no" title="statement not covered" >      var prop = expectedProperties[j];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (typeof obj[prop] === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('expected id ' + (0, _stringify2.default)(obj) + ' to have property ' + prop);</span>
      }
    }
  }
}
&nbsp;
<span class="fstat-no" title="function not covered" >function normalizedToArray(ret, expectedProperties) {</span>
<span class="cstat-no" title="statement not covered" >  var arr = new Array(ret.length);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var i = 0, l = ret.length; i &lt; l; ++i) {</span>
<span class="cstat-no" title="statement not covered" >    var obj = ret[i];</span>
<span class="cstat-no" title="statement not covered" >    var ids = new Array(expectedProperties.length);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var j = 0, lp = expectedProperties.length; j &lt; lp; ++j) {</span>
<span class="cstat-no" title="statement not covered" >      var prop = expectedProperties[j];</span>
<span class="cstat-no" title="statement not covered" >      ids[j] = obj[prop];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    arr[i] = ids;</span>
  }
&nbsp;
